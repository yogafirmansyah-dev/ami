import { ref, withCtx, unref, createTextVNode, createVNode, createBlock, createCommentVNode, openBlock, Fragment, renderList, toDisplayString, useSSRContext } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderAttr } from "vue/server-renderer";
import { usePage, useForm, router } from "@inertiajs/vue3";
import { _ as _sfc_main$2 } from "./ActionMessage-BKCr4dVw.js";
import { _ as _sfc_main$7 } from "./Modal-BPxfNimL.js";
import { _ as _sfc_main$a } from "./ConfirmationModal-Ba3z0can.js";
import { _ as _sfc_main$b } from "./DangerButton-DFSaKo0t.js";
import { _ as _sfc_main$8 } from "./DialogModal-mwxakEYG.js";
import { _ as _sfc_main$1 } from "./FormSection-CorId1DH.js";
import { _ as _sfc_main$6 } from "./InputError-BCWdSoAI.js";
import { _ as _sfc_main$4 } from "./InputLabel-s7D3-jRa.js";
import { _ as _sfc_main$3 } from "./PrimaryButton-BZZqj18B.js";
import { _ as _sfc_main$9 } from "./SecondaryButton-BWihrucI.js";
import { S as SectionBorder } from "./SectionBorder-9_0CxrVI.js";
import { _ as _sfc_main$5 } from "./TextInput-wJl1wgt1.js";
      ...
      if (__props.userPermissions.canAddTeamMembers) {
        ...
        _push(ssrRenderComponent(_sfc_main$1, { onSubmitted: addTeamMember }, {
          ...
          form: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="col-span-6"${_scopeId}><div class="max-w-xl text-sm text-gray-600 dark:text-gray-400"${_scopeId}> Please provide the email address of the person you would like to add to this team. </div></div><div class="col-span-6 sm:col-span-4"${_scopeId}>`);
              ...
              if (__props.availableRoles.length > 0) {
                ...
                _push2(`<div class="relative z-0 mt-1 border border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer"${_scopeId}><!--[-->`);
                ssrRenderList(__props.availableRoles, (role, i) => {
                  _push2(`<button type="button" class="${ssrRenderClass([{ "border-t border-gray-200 dark:border-gray-700 focus:border-none rounded-t-none": i > 0, "rounded-b-none": i != Object.keys(__props.availableRoles).length - 1 }, "relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-600"])}"${_scopeId}><div class="${ssrRenderClass({ "opacity-50": unref(addTeamMemberForm).role && unref(addTeamMemberForm).role != role.key })}"${_scopeId}><div class="flex items-center"${_scopeId}><div class="${ssrRenderClass([{ "font-semibold": unref(addTeamMemberForm).role == role.key }, "text-sm text-gray-600 dark:text-gray-400"])}"${_scopeId}>${ssrInterpolate(role.name)}</div>`);
                  ...
                  _push2(`</div><div class="mt-2 text-xs text-gray-600 dark:text-gray-400 text-start"${_scopeId}>${ssrInterpolate(role.description)}</div></div></button>`);
                });
                _push2(`<!--]--></div></div>`);
              } else {
                _push2(`<!---->`);
              ...
              return [
                createVNode("div", { class: "col-span-6" }, [
                  createVNode("div", { class: "max-w-xl text-sm text-gray-600 dark:text-gray-400" }, " Please provide the email address of the person you would like to add to this team. ")
                ]),
                ...
                __props.availableRoles.length > 0 ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("div", { class: "relative z-0 mt-1 border border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer" }, [
                    (openBlock(true), createBlock(Fragment, null, renderList(__props.availableRoles, (role, i) => {
                      return openBlock(), createBlock("button", {
                        key: role.key,
                        type: "button",
                        class: ["relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-600", { "border-t border-gray-200 dark:border-gray-700 focus:border-none rounded-t-none": i > 0, "rounded-b-none": i != Object.keys(__props.availableRoles).length - 1 }],
                        ...
                        createVNode("div", {
                          ...
                          createVNode("div", { class: "flex items-center" }, [
                            createVNode("div", {
                              class: ["text-sm text-gray-600 dark:text-gray-400", { "font-semibold": unref(addTeamMemberForm).role == role.key }]
                          ...
                          createVNode("div", { class: "mt-2 text-xs text-gray-600 dark:text-gray-400 text-start" }, toDisplayString(role.description), 1)
                        ], 2)
                      ], 10, ["onClick"]);
                    }), 128))
                  ])
          ...
          content: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(__props.team.team_invitations, (invitation) => {
                _push2(`<div class="flex items-center justify-between"${_scopeId}><div class="text-gray-600 dark:text-gray-400"${_scopeId}>${ssrInterpolate(invitation.email)}</div><div class="flex items-center"${_scopeId}>`);
                ...
                createVNode("div", { class: "space-y-6" }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.team.team_invitations, (invitation) => {
                    return openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "text-gray-600 dark:text-gray-400" }, toDisplayString(invitation.email), 1),
                      createVNode("div", { class: "flex items-center" }, [
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.team.users, (user) => {
                    return openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "flex items-center" }, [
                        ...
                        createVNode("div", { class: "ms-4 dark:text-white" }, toDisplayString(user.name), 1)
                      ]),
                      createVNode("div", { class: "flex items-center" }, [
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (managingRoleFor.value) {
              _push2(`<div${_scopeId}><div class="relative z-0 mt-1 border border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer"${_scopeId}><!--[-->`);
              ssrRenderList(__props.availableRoles, (role, i) => {
                _push2(`<button type="button" class="${ssrRenderClass([{ "border-t border-gray-200 dark:border-gray-700 focus:border-none rounded-t-none": i > 0, "rounded-b-none": i !== Object.keys(__props.availableRoles).length - 1 }, "relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-600"])}"${_scopeId}><div class="${ssrRenderClass({ "opacity-50": unref(updateRoleForm).role && unref(updateRoleForm).role !== role.key })}"${_scopeId}><div class="flex items-center"${_scopeId}><div class="${ssrRenderClass([{ "font-semibold": unref(updateRoleForm).role === role.key }, "text-sm text-gray-600 dark:text-gray-400"])}"${_scopeId}>${ssrInterpolate(role.name)}</div>`);
                if (unref(updateRoleForm).role == role.key) {
                  _push2(`<svg class="ms-2 h-5 w-5 text-green-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"${_scopeId}></path></svg>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div><div class="mt-2 text-xs text-gray-600 dark:text-gray-400"${_scopeId}>${ssrInterpolate(role.description)}</div></div></button>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
              _push2(`<!---->`);
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.availableRoles, (role, i) => {
                    return openBlock(), createBlock("button", {
                      ...
                      createVNode("div", {
                        ...
                        createVNode("div", { class: "flex items-center" }, [
                          createVNode("div", {
                            class: ["text-sm text-gray-600 dark:text-gray-400", { "font-semibold": unref(updateRoleForm).role === role.key }]
                          }, toDisplayString(role.name), 3),
                        ...
                        createVNode("div", { class: "mt-2 text-xs text-gray-600 dark:text-gray-400" }, toDisplayString(role.description), 1)
                      ], 2)
                    ], 10, ["onClick"]);
                  }), 128))
                ])
