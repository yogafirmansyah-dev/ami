import { defineComponent, resolveComponent, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString, withDirectives, createBlock, vModelCheckbox, openBlock, Fragment, renderList, resolveDynamicComponent, createCommentVNode, renderSlot, withModifiers, Transition, ref, computed, useSSRContext } from "vue";
import { c as bgColorStyles, r as radiusSizeMixin, _ as _sfc_main$2, T as TAlert, w as windowSizeCalculator, g as authScreenConf, a as appConf } from "./windowSizeCalculator-ej9CZPp5.js";
...
import { u as useDisplayLanguageStore, a as authTranslates, l as languages } from "./displayLanguage-CeV33Cax.js";
      ...
      if (_push2) {
        ...
        if (_ctx.privacyPolicyFeature) {
          ...
          _push2(ssrRenderComponent(_component_t_input_group, { "label-for": "terms" }, {
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<div class="flex items-center"${_scopeId2}><input id="terms"${ssrIncludeBooleanAttr(Array.isArray(_ctx.form.terms) ? ssrLooseContain(_ctx.form.terms, null) : _ctx.form.terms) ? " checked" : ""} name="terms" type="checkbox"${_scopeId2}>`);
                if (_ctx.locale === "tr") {
                  ...
                  _push3(ssrRenderComponent(_component_i18n_t, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(_ctx.t("and"))}`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_i18n_t, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(_ctx.t("iAgreeToThe"))}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(_ctx.t("iAgreeToThe")), 1)
                        ];
                      }
                    }),
                    _: 1
                ...
                return [
                  createVNode("div", { class: "flex items-center" }, [
                    ...
                    _ctx.locale === "tr" ? (openBlock(), createBlock("div", {
                      key: 0,
                      class: "ml-2"
                    }, [
        ...
        _push2(ssrRenderComponent(_component_t_button, {
          ...
          design: _ctx.activeDesign.register.loginButton[_ctx.appearingMode].design,
          color: _ctx.activeDesign.register.loginButton[_ctx.appearingMode].color,
        ...
        _push2(ssrRenderComponent(_component_t_button, {
          ...
          radius: 3,
          color: _ctx.activeDesign.register.registerButton[_ctx.appearingMode].color,
          design: _ctx.activeDesign.register.registerButton[_ctx.appearingMode].design
        }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(`</div></form></div></div><div class="auth-error"${_scopeId}>`);
        if (_ctx.hasErrors) {
