...
import { m as menuStatus, u as updateMenuStatus } from "./AppLayout-3kkfgqRQ.js";
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative w-full px-2 py-1" }, _attrs))} data-v-40f906d7>`);
      if (__props.link.type === "dropdown" && __props.link.visibleFor !== false) {
        ...
        ], "group flex justify-between items-center px-4 py-3 rounded-2xl cursor-pointer transition-all duration-300 w-full"])}" data-v-40f906d7><div class="flex items-center gap-3 overflow-hidden" data-v-40f906d7><div class="flex justify-center items-center w-6 h-6 shrink-0" data-v-40f906d7>`);
        ...
        _push(`</div><span class="${ssrRenderClass([unref(menuStatus) !== "closed" ? "opacity-100 max-w-[200px]" : "opacity-0 max-w-0", "text-sm font-bold uppercase tracking-wide whitespace-normal leading-tight transition-all duration-300"])}" data-v-40f906d7>${ssrInterpolate(__props.link.label)}</span></div>`);
        if (unref(menuStatus) !== "closed") {
          _push(`<div data-v-40f906d7>`);
          _push(ssrRenderComponent(_component_icon, {
            icon: "chevron-down",
            size: "xs",
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex justify-center items-center w-6 h-6 shrink-0" data-v-40f906d7${_scopeId}>`);
              if (__props.link["icon"]) {
              ...
              _push2(`</div><span class="${ssrRenderClass([unref(menuStatus) !== "closed" ? "opacity-100 max-w-[200px]" : "opacity-0 max-w-0", "text-sm font-bold uppercase tracking-wide whitespace-normal leading-tight transition-all duration-300"])}" data-v-40f906d7${_scopeId}>${ssrInterpolate(__props.link.label)}</span>`);
            } else {
              return [
        ...
        ], "group flex items-center gap-3 px-4 py-3 rounded-2xl cursor-pointer w-full transition-all duration-300"])}" data-v-40f906d7><div class="flex justify-center items-center w-6 h-6 shrink-0" data-v-40f906d7>`);
        if (__props.link["icon"]) {
          _push(ssrRenderComponent(_component_icon, {
            icon: __props.link.icon,
            class: "w-6 h-6 transition-transform group-hover:scale-110 duration-300"
        ...
        _push(`</div><span class="${ssrRenderClass([unref(menuStatus) !== "closed" ? "opacity-100 max-w-[200px]" : "opacity-0 max-w-0", "text-sm font-bold uppercase tracking-wide whitespace-normal leading-tight transition-all duration-300"])}" data-v-40f906d7>${ssrInterpolate(__props.link.label)}</span></a>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.link.links && unref(selectedLink).includes(__props.link.id) && unref(menuStatus) !== "closed") {
        _push(`<div class="flex flex-col py-2 space-y-2 overflow-hidden" data-v-40f906d7><!--[-->`);
        ssrRenderList(__props.link.links, (subItem) => {
          ...
          if (subItem.type === "dropdown" && subItem.visibleFor !== false) {
            ...
            ], "group flex justify-between items-center px-4 py-2.5 rounded-xl cursor-pointer transition-all duration-300 w-full ml-2 border-l-2 border-slate-100 dark:border-slate-800 hover:border-rose-500"])}" data-v-40f906d7><div class="flex items-center gap-3" data-v-40f906d7>`);
            if (subItem["icon"]) {
              _push(ssrRenderComponent(_component_icon, {
                icon: subItem.icon,
            ...
            _push(`<span class="text-xs font-semibold uppercase tracking-wide whitespace-normal leading-tight" data-v-40f906d7>${ssrInterpolate(subItem.label)}</span></div>`);
            _push(ssrRenderComponent(_component_icon, {
              icon: "chevron-down",
              size: "xs",
            ...
            _push(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<div class="flex items-center gap-3" data-v-40f906d7${_scopeId}>`);
                  if (subItem["icon"]) {
                    _push2(ssrRenderComponent(_component_icon, {
                      icon: subItem.icon,
                      class: "w-5 h-5 transition-transform group-hover:scale-110"
                  ...
                  _push2(`<span class="text-xs font-semibold uppercase tracking-wide whitespace-normal leading-tight" data-v-40f906d7${_scopeId}>${ssrInterpolate(subItem.label)}</span></div>`);
                } else {
                  return [
            ...
            _push(`<span class="text-xs font-semibold uppercase tracking-wide whitespace-normal leading-tight" data-v-40f906d7>${ssrInterpolate(subItem.label)}</span></div></a>`);
          } else {
            _push(`<!---->`);
          }
          if (subItem.links && unref(selectedLink).includes(subItem.id) || subItem.links && activeMenus.second === subItem.id) {
            _push(`<div class="flex flex-col space-y-1 mt-1 ml-4 border-l-2 border-slate-200 dark:border-slate-700 pl-2" data-v-40f906d7><!--[-->`);
            ssrRenderList(subItem.links, (thirdItem) => {
                ...
                _push(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_, _push2, _parent2, _scopeId) => {
                    if (_push2) {
                      ...
                      _push2(`<span class="text-[11px] font-medium uppercase tracking-wide whitespace-normal leading-tight" data-v-40f906d7${_scopeId}>${ssrInterpolate(thirdItem.label)}</span>`);
                    } else {
                      return [
              ...
              if (thirdItem.type === "simple-link" && thirdItem.visibleFor !== false) {
                ...
                ], "flex items-center gap-2 px-4 py-2 rounded-lg cursor-pointer w-full transition-all duration-200"])}" data-v-40f906d7>`);
                if (thirdItem["icon"]) {
                  _push(ssrRenderComponent(_component_icon, {
                    icon: thirdItem.icon,
                    class: "w-4 h-4"
                ...
                _push(`<span class="text-[11px] font-medium uppercase tracking-wide whitespace-normal leading-tight" data-v-40f906d7>${ssrInterpolate(thirdItem.label)}</span></a>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<!--]-->`);
...
const MainMenuItem = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-40f906d7"]]);
const _sfc_main = {
  __name: "MainMenu",
  __ssrInlineRender: true,
  setup(__props) {
