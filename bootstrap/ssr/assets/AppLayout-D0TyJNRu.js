...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./MainMenu/Abay/MainMenu.vue": () => import("./MainMenu-Dh005fdN.js"), "./MainMenu/Umay/MainMenu.vue": () => import("./MainMenu-DdNzeFIq.js") }), `./MainMenu/${menuDesign.value}/MainMenu.vue`, 4).then((module) => {
