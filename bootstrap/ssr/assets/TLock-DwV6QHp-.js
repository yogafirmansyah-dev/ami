...
import { c as bgColorStyles, r as radiusSizeMixin, T as TAlert, _ as _sfc_main$2, w as windowSizeCalculator, g as authScreenConf, a as appConf } from "./windowSizeCalculator-ej9CZPp5.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_full_screen_layout, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="${ssrRenderClass(["relative"])}"${_scopeId}><div class="auth-avatar-container"${_scopeId}><div class="auth-avatar"${_scopeId}>`);
        ...
        _push2(`</div></div><div class="${ssrRenderClass([
          _ctx.deviceType !== "phone" && _ctx.radiusStyle
        ])}"${_scopeId}><form${_scopeId}><div class="${ssrRenderClass([
          "auth-lock-form",
          _ctx.calculatedLockStyle,
          _ctx.deviceType !== "phone" && _ctx.radiusStyle
        ])}"${_scopeId}><div class="auth-name"${_scopeId}>${ssrInterpolate(_ctx.$page.props.auth.user.name)}</div>`);
            ...
            if (_push3) {
              _push3(ssrRenderComponent(_component_t_input_text, {
                ...
                icon: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(ssrRenderComponent(_component_t_user_circle_icon, { class: "w-5 h-5" }, null, _parent4, _scopeId3));
                  } else {
                    return [
                      createVNode(_component_t_user_circle_icon, { class: "w-5 h-5" })
                    ];
                  }
                }),
                _: 1
        ...
        _push2(ssrRenderComponent(_component_t_button, {
          ...
          color: _ctx.activeDesign.lock.reLoginButton[_ctx.appearingMode].color,
          design: _ctx.activeDesign.lock.reLoginButton[_ctx.appearingMode].design,
        ...
        _push2(`</div></form></div><div class="auth-error"${_scopeId}>`);
        if (_ctx.hasErrors) {
        ...
        _push2(`</div></div><div class="fixed bottom-0 flex z-50 w-full justify-center sm:justify-end space-x-6 p-6"${_scopeId}>`);
        ...
        return [
          createVNode("div", { class: ["relative"] }, [
            createVNode("div", { class: "auth-avatar-container" }, [
              createVNode("div", { class: "auth-avatar" }, [
            ...
            createVNode("div", {
              ...
              createVNode("form", {
                ...
                createVNode("div", {
                  ...
                  createVNode("div", { class: "auth-name" }, toDisplayString(_ctx.$page.props.auth.user.name), 1),
