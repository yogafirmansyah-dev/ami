        ...
        ssrRenderList(assignments.value, (item) => {
          _push(ssrRenderComponent(unref(Link), {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div${_scopeId}><div class="absolute top-0 left-0 w-full h-1.5 bg-slate-100 dark:bg-slate-800"${_scopeId}><div class="h-full bg-gradient-to-r from-emerald-400 to-emerald-600 transition-all duration-1000 relative" style="${ssrRenderStyle({ width: item.progress + "%" })}"${_scopeId}><div class="absolute right-0 top-0 w-2 h-full bg-white/50 blur-[2px] shadow-[0_0_10px_rgba(255,255,255,0.8)]"${_scopeId}></div></div></div><div class="p-8"${_scopeId}><div class="flex justify-between items-start mb-6"${_scopeId}><span class="${ssrRenderClass(["px-3 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-[0.2em] shadow-sm", getStageColor(item.current_stage)])}"${_scopeId}>${ssrInterpolate(item.current_stage?.replace("_", " ") || "Unknown")}</span><span class="text-[10px] font-black text-slate-400 tracking-widest uppercase"${_scopeId}>${ssrInterpolate(item.period_name)}</span></div><h4 class="text-xl font-black text-slate-800 dark:text-white mb-2 line-clamp-2 group-hover:text-emerald-500 transition-colors leading-tight italic"${_scopeId}>${ssrInterpolate(item.target_name)}</h4><p class="text-xs text-slate-500 dark:text-slate-400 font-medium mb-8 line-clamp-2 leading-relaxed"${_scopeId}>${ssrInterpolate(item.standard_name)}</p><div class="mb-4"${_scopeId}><div class="flex items-center justify-between text-[10px] font-black uppercase tracking-widest text-slate-400 bg-slate-50/50 dark:bg-slate-800/30 border border-slate-100 dark:border-slate-800 p-3 rounded-t-2xl border-b-0"${_scopeId}><span${_scopeId}>Tingkat Pengisian</span><span class="text-indigo-600 dark:text-indigo-400"${_scopeId}>${ssrInterpolate(item.auditee_progress)}%</span></div><div class="w-full bg-slate-100 dark:bg-slate-800 h-1.5 overflow-hidden p-[1px]"${_scopeId}><div class="bg-indigo-500 h-full transition-all duration-1000 shadow-[0_0_8px_rgba(99,102,241,0.4)]" style="${ssrRenderStyle({ width: item.auditee_progress + "%" })}"${_scopeId}></div></div></div><div class="mb-4"${_scopeId}><div class="flex items-center justify-between text-[10px] font-black uppercase tracking-widest text-slate-400 bg-slate-50/50 dark:bg-slate-800/30 border border-slate-100 dark:border-slate-800 p-3 rounded-b-0 border-b-0"${_scopeId}><span${_scopeId}>Kemajuan Penilaian</span><span class="text-emerald-600 dark:text-emerald-400"${_scopeId}>${ssrInterpolate(item.progress)}%</span></div><div class="w-full bg-slate-100 dark:bg-slate-800 h-1.5 overflow-hidden p-[1px] rounded-b-2xl"${_scopeId}><div class="bg-emerald-500 h-full transition-all duration-1000 shadow-[0_0_8px_rgba(16,185,129,0.4)]" style="${ssrRenderStyle({ width: item.progress + "%" })}"${_scopeId}></div></div></div></div></div><div class="px-8 py-5 bg-slate-50/50 dark:bg-slate-800/30 border-t border-slate-100 dark:border-slate-800 flex justify-end"${_scopeId}><span class="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-500 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 group-hover:gap-3 flex items-center gap-2 transition-all"${_scopeId}> Mulai Evaluasi `);
                  ...
                  createVNode("div", null, [
                    ...
                    createVNode("div", { class: "p-8" }, [
                      ...
                      createVNode("div", { class: "mb-4" }, [
                        createVNode("div", { class: "flex items-center justify-between text-[10px] font-black uppercase tracking-widest text-slate-400 bg-slate-50/50 dark:bg-slate-800/30 border border-slate-100 dark:border-slate-800 p-3 rounded-t-2xl border-b-0" }, [
                          createVNode("span", null, "Tingkat Pengisian"),
                          createVNode("span", { class: "text-indigo-600 dark:text-indigo-400" }, toDisplayString(item.auditee_progress) + "%", 1)
                        ]),
                        createVNode("div", { class: "w-full bg-slate-100 dark:bg-slate-800 h-1.5 overflow-hidden p-[1px]" }, [
                          createVNode("div", {
                            class: "bg-indigo-500 h-full transition-all duration-1000 shadow-[0_0_8px_rgba(99,102,241,0.4)]",
                            style: { width: item.auditee_progress + "%" }
                          }, null, 4)
                        ])
                      ]),
                      createVNode("div", { class: "mb-4" }, [
                        createVNode("div", { class: "flex items-center justify-between text-[10px] font-black uppercase tracking-widest text-slate-400 bg-slate-50/50 dark:bg-slate-800/30 border border-slate-100 dark:border-slate-800 p-3 rounded-b-0 border-b-0" }, [
                          createVNode("span", null, "Kemajuan Penilaian"),
                          createVNode("span", { class: "text-emerald-600 dark:text-emerald-400" }, toDisplayString(item.progress) + "%", 1)
                        ]),
                        createVNode("div", { class: "w-full bg-slate-100 dark:bg-slate-800 h-1.5 overflow-hidden p-[1px] rounded-b-2xl" }, [
                          createVNode("div", {
                            class: "bg-emerald-500 h-full transition-all duration-1000 shadow-[0_0_8px_rgba(16,185,129,0.4)]",
                            style: { width: item.progress + "%" }
                          }, null, 4)
                        ])
                      ])
