    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AppLayout, mergeProps({
        ...
        subHeader: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Unit: <span class="font-bold text-rose-600" data-v-05bec8ec${_scopeId}>${ssrInterpolate(__props.assignment.target_name)}</span> | Instrumen: ${ssrInterpolate(__props.assignment.standard.name)}`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-8" data-v-05bec8ec${_scopeId}><div class="bg-white dark:bg-slate-900 p-8 rounded-[1rem] border border-slate-200 dark:border-slate-800 shadow-sm" data-v-05bec8ec${_scopeId}><p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-8" data-v-05bec8ec${_scopeId}>Alur Tahapan Audit Berjalan</p><div class="relative flex justify-between items-center max-w-4xl mx-auto" data-v-05bec8ec${_scopeId}><div class="absolute top-1/2 left-0 w-full h-1 bg-slate-100 dark:bg-slate-800 -translate-y-1/2" data-v-05bec8ec${_scopeId}></div><div class="absolute top-1/2 left-0 h-1 bg-rose-600 -translate-y-1/2 transition-all duration-1000" style="${ssrRenderStyle({ width: currentStageIndex.value / (stages.length - 1) * 100 + "%" })}" data-v-05bec8ec${_scopeId}></div><!--[-->`);
            ssrRenderList(stages, (stage, index) => {
              _push2(`<div class="relative z-10 flex flex-col items-center" data-v-05bec8ec${_scopeId}><div class="${ssrRenderClass([
              ...
              ])}" data-v-05bec8ec${_scopeId}></div><span class="${ssrRenderClass([
              ...
              ])}" data-v-05bec8ec${_scopeId}>${ssrInterpolate(stage.label)}</span></div>`);
            });
            _push2(`<!--]--></div></div><div class="bg-slate-900 rounded-[1rem] p-8 text-white flex flex-col md:flex-row items-center gap-8 shadow-2xl" data-v-05bec8ec${_scopeId}><div class="flex-1" data-v-05bec8ec${_scopeId}><h3 class="text-xl font-black uppercase tracking-tighter italic" data-v-05bec8ec${_scopeId}>Dokumentasi Berita Acara</h3><p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1" data-v-05bec8ec${_scopeId}>Unggah berkas resmi sesuai tahapan yang berlaku</p></div><div class="flex flex-wrap justify-center gap-4" data-v-05bec8ec${_scopeId}><!--[-->`);
            ssrRenderList(__props.groupedDocuments, (doc) => {
              _push2(`<div class="text-center bg-white/5 p-4 rounded-3xl border border-white/10 hover:bg-white/10 transition-all" data-v-05bec8ec${_scopeId}><p class="text-[8px] font-black text-slate-500 uppercase mb-3" data-v-05bec8ec${_scopeId}>${ssrInterpolate(doc.label)}</p>`);
              if (!doc.file) {
                ...
                ])}" data-v-05bec8ec${_scopeId}> Unggah </button>`);
              } else {
                _push2(`<a${ssrRenderAttr("href", _ctx.route("files.official.show", doc.file.id))} target="_blank" class="inline-block px-6 py-2 bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 rounded-xl text-[9px] font-black uppercase hover:bg-emerald-500/30 transition-all italic" data-v-05bec8ec${_scopeId}> Tersedia </a>`);
              }
              _push2(`</div>`);
            });
            _push2(`<!--]--></div></div><div class="bg-white dark:bg-slate-900 rounded-[1rem] border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden" data-v-05bec8ec${_scopeId}><div class="p-8 border-b dark:border-slate-800 flex justify-between items-center bg-slate-50/30" data-v-05bec8ec${_scopeId}><h3 class="font-black text-slate-800 dark:text-white uppercase text-xs tracking-[0.2em] italic" data-v-05bec8ec${_scopeId}> Evaluasi Indikator Standar</h3><div class="relative w-80" data-v-05bec8ec${_scopeId}><input${ssrRenderAttr("value", search.value)} type="text" placeholder="Cari Kode atau Butir..." class="w-full pl-10 pr-4 py-2.5 text-xs bg-white dark:bg-slate-800 border-0 rounded-2xl shadow-inner focus:ring-2 focus:ring-rose-500/20 transition-all" data-v-05bec8ec${_scopeId}><svg class="w-4 h-4 absolute left-3.5 top-3 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-05bec8ec${_scopeId}><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-05bec8ec${_scopeId}></path></svg></div></div><div class="overflow-x-auto" data-v-05bec8ec${_scopeId}><table class="w-full text-left text-xs border-collapse min-w-[1500px]" data-v-05bec8ec${_scopeId}><thead class="bg-slate-50 dark:bg-slate-800/80 text-[10px] font-black uppercase text-slate-500 tracking-widest border-b dark:border-slate-800" data-v-05bec8ec${_scopeId}><tr data-v-05bec8ec${_scopeId}><th class="p-2 w-20" data-v-05bec8ec${_scopeId}>Kode</th><th class="p-2 w-80" data-v-05bec8ec${_scopeId}>Kriteria Indikator</th><th class="p-2 w-80" data-v-05bec8ec${_scopeId}>Bukti yang Diperiksa </th><th class="p-2 text-center w-32" data-v-05bec8ec${_scopeId}>Bukti</th><th class="p-2 text-center w-28" data-v-05bec8ec${_scopeId}>Status Temuan</th><th class="p-2 text-center w-20" data-v-05bec8ec${_scopeId}>Skor</th><th class="p-2 w-64" data-v-05bec8ec${_scopeId}>Catatan &amp; Rekomendasi</th><th class="p-2 text-center w-28" data-v-05bec8ec${_scopeId}>Aksi</th></tr></thead><tbody class="divide-y divide-slate-100 dark:divide-slate-800" data-v-05bec8ec${_scopeId}><!--[-->`);
            ssrRenderList(__props.indicators.data, (item) => {
              _push2(`<tr class="${ssrRenderClass(["align-top transition-colors group", item.finding_type === "KTS" ? "bg-rose-50/10 hover:bg-rose-50/20" : "hover:bg-slate-50/50"])}" data-v-05bec8ec${_scopeId}><td class="p-2 font-mono font-black text-rose-600 tracking-tighter" data-v-05bec8ec${_scopeId}>${ssrInterpolate(item.snapshot_code)}</td><td class="p-2 leading-relaxed" data-v-05bec8ec${_scopeId}><p class="font-bold text-slate-800 dark:text-slate-200 mb-3 text-[11px]" data-v-05bec8ec${_scopeId}>${ssrInterpolate(item.snapshot_requirement)}</p></td><td class="p-2 leading-relaxed" data-v-05bec8ec${_scopeId}><p class="font-bold text-slate-800 dark:text-slate-200 mb-3 text-[11px]" data-v-05bec8ec${_scopeId}>${ssrInterpolate(item.snapshot_evidence_needed)}</p></td><td class="p-2 text-center" data-v-05bec8ec${_scopeId}><div class="flex flex-col gap-2 items-center" data-v-05bec8ec${_scopeId}>`);
              if (item.evidence_path) {
                _push2(`<a${ssrRenderAttr("href", _ctx.route("files.evidence.show", item.id))} target="_blank" class="px-3 py-1.5 bg-blue-50 text-blue-600 rounded-xl font-black text-[9px] border border-blue-100 hover:bg-blue-600 hover:text-white transition-all uppercase shadow-sm" data-v-05bec8ec${_scopeId}>Berkas</a>`);
              } else {
                _push2(`<!---->`);
              }
              if (item.evidence_url) {
                _push2(`<a${ssrRenderAttr("href", item.evidence_url)} target="_blank" class="px-3 py-1.5 bg-purple-50 text-purple-600 rounded-xl font-black text-[9px] border border-purple-100 hover:bg-purple-600 hover:text-white transition-all uppercase shadow-sm" data-v-05bec8ec${_scopeId}>Tautan</a>`);
              } else {
                _push2(`<!---->`);
              }
              if (!item.evidence_path && !item.evidence_url) {
                _push2(`<span class="text-slate-200 font-bold uppercase tracking-widest text-[9px]" data-v-05bec8ec${_scopeId}>Kosong</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></td><td class="p-2 text-center" data-v-05bec8ec${_scopeId}>`);
              if (item.finding_type) {
                _push2(`<span class="${ssrRenderClass(["px-3 py-1 rounded-full text-[9px] font-black border tracking-widest inline-block shadow-sm", getFindingBadge(item.finding_type)])}" data-v-05bec8ec${_scopeId}>${ssrInterpolate(item.finding_type)}</span>`);
              } else {
                _push2(`<span class="text-slate-200 font-bold" data-v-05bec8ec${_scopeId}>-</span>`);
              }
              _push2(`</td><td class="p-2 text-center" data-v-05bec8ec${_scopeId}><div class="${ssrRenderClass(["w-10 h-10 leading-10 mx-auto rounded-2xl font-black text-sm border-2 transition-all shadow-sm", item.score ? "bg-slate-900 text-white border-slate-900" : "bg-white text-slate-100 border-slate-50 dark:bg-slate-800 dark:border-slate-700"])}" data-v-05bec8ec${_scopeId}>${ssrInterpolate(item.score ?? "-")}</div></td><td class="p-2" data-v-05bec8ec${_scopeId}><div class="space-y-4" data-v-05bec8ec${_scopeId}>`);
              if (item.auditor_note) {
                _push2(`<div data-v-05bec8ec${_scopeId}><p class="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1 italic" data-v-05bec8ec${_scopeId}> Catatan:</p><p class="text-[10px] text-slate-600 dark:text-slate-400 font-medium leading-relaxed" data-v-05bec8ec${_scopeId}> &quot;${ssrInterpolate(item.auditor_note)}&quot;</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (item.recommendation) {
                _push2(`<div class="p-3 bg-amber-50 dark:bg-amber-900/10 border-l-4 border-amber-500 rounded-xl" data-v-05bec8ec${_scopeId}><p class="text-[8px] font-black text-amber-600 uppercase tracking-widest mb-1 italic leading-none" data-v-05bec8ec${_scopeId}> Saran Perbaikan:</p><p class="text-[10px] text-amber-800 dark:text-amber-400 font-bold leading-relaxed" data-v-05bec8ec${_scopeId}>${ssrInterpolate(item.recommendation)}</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              _push2(`</div></td><td class="p-2 text-center" data-v-05bec8ec${_scopeId}><div class="flex justify-center gap-2" data-v-05bec8ec${_scopeId}><button class="p-3 bg-rose-600 text-white rounded-2xl shadow-lg shadow-rose-500/20 hover:bg-rose-700 hover:scale-105 active:scale-95 transition-all" data-v-05bec8ec${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-05bec8ec${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" data-v-05bec8ec${_scopeId}></path></svg></button><button class="p-3 bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 rounded-2xl hover:text-rose-600 hover:bg-rose-50 transition-all shadow-sm" data-v-05bec8ec${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-05bec8ec${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" data-v-05bec8ec${_scopeId}></path></svg></button></div></td></tr>`);
            });
            _push2(`<!--]--></tbody></table></div></div></div>`);
            if (showAssessmentModal.value) {
              _push2(`<div class="fixed inset-0 z-[999] flex items-center justify-center p-4" data-v-05bec8ec${_scopeId}><div class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm" data-v-05bec8ec${_scopeId}></div><div class="relative bg-white dark:bg-slate-900 w-full max-w-2xl rounded-[1rem] shadow-2xl overflow-hidden animate-in zoom-in duration-200" data-v-05bec8ec${_scopeId}><form class="flex flex-col max-h-[90vh]" data-v-05bec8ec${_scopeId}><div class="p-8 border-b dark:border-slate-800 bg-slate-50/50 flex justify-between items-center" data-v-05bec8ec${_scopeId}><div data-v-05bec8ec${_scopeId}><h3 class="text-xl font-black uppercase tracking-tighter text-slate-800 dark:text-white leading-none" data-v-05bec8ec${_scopeId}> Evaluasi Auditor</h3><p class="text-[10px] font-bold text-rose-600 font-mono mt-2 uppercase tracking-widest" data-v-05bec8ec${_scopeId}>${ssrInterpolate(activeIndicator.value?.snapshot_code)}</p></div><button type="button" class="text-4xl text-slate-300 hover:text-rose-600" data-v-05bec8ec${_scopeId}>×</button></div><div class="p-10 space-y-8 overflow-y-auto custom-scrollbar" data-v-05bec8ec${_scopeId}><div class="p-2 bg-slate-50 dark:bg-slate-800/80 rounded-[2rem] text-[11px] font-bold text-slate-600 dark:text-slate-300 italic leading-relaxed border border-slate-100 dark:border-slate-700" data-v-05bec8ec${_scopeId}> &quot;${ssrInterpolate(activeIndicator.value?.snapshot_requirement)}&quot; </div><div class="grid grid-cols-2 gap-6" data-v-05bec8ec${_scopeId}><div class="space-y-2" data-v-05bec8ec${_scopeId}><label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]" data-v-05bec8ec${_scopeId}>Status Temuan</label><select class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-800 border-0 rounded-2xl text-sm font-bold dark:text-white shadow-inner focus:ring-2 focus:ring-rose-500/20 outline-none" required data-v-05bec8ec${_scopeId}><option value="" disabled data-v-05bec8ec${ssrIncludeBooleanAttr(Array.isArray(unref(assessmentForm).finding_type) ? ssrLooseContain(unref(assessmentForm).finding_type, "") : ssrLooseEqual(unref(assessmentForm).finding_type, "")) ? " selected" : ""}${_scopeId}>Pilih Status</option><option value="KS" data-v-05bec8ec${ssrIncludeBooleanAttr(Array.isArray(unref(assessmentForm).finding_type) ? ssrLooseContain(unref(assessmentForm).finding_type, "KS") : ssrLooseEqual(unref(assessmentForm).finding_type, "KS")) ? " selected" : ""}${_scopeId}>KS (Kesesuaian)</option><option value="KTS" data-v-05bec8ec${ssrIncludeBooleanAttr(Array.isArray(unref(assessmentForm).finding_type) ? ssrLooseContain(unref(assessmentForm).finding_type, "KTS") : ssrLooseEqual(unref(assessmentForm).finding_type, "KTS")) ? " selected" : ""}${_scopeId}>KTS (Ketidaksesuaian)</option><option value="OB" data-v-05bec8ec${ssrIncludeBooleanAttr(Array.isArray(unref(assessmentForm).finding_type) ? ssrLooseContain(unref(assessmentForm).finding_type, "OB") : ssrLooseEqual(unref(assessmentForm).finding_type, "OB")) ? " selected" : ""}${_scopeId}>OB (Observasi)</option></select></div><div class="space-y-2" data-v-05bec8ec${_scopeId}><label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]" data-v-05bec8ec${_scopeId}>Skor Penilaian</label><select class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-800 border-0 rounded-2xl text-sm font-bold dark:text-white shadow-inner focus:ring-2 focus:ring-rose-500/20 outline-none" required data-v-05bec8ec${_scopeId}><option value="" disabled data-v-05bec8ec${ssrIncludeBooleanAttr(Array.isArray(unref(assessmentForm).score) ? ssrLooseContain(unref(assessmentForm).score, "") : ssrLooseEqual(unref(assessmentForm).score, "")) ? " selected" : ""}${_scopeId}>Pilih Skor (1-4)</option><!--[-->`);
              ssrRenderList(4, (n) => {
                _push2(`<option${ssrRenderAttr("value", n)} data-v-05bec8ec${ssrIncludeBooleanAttr(Array.isArray(unref(assessmentForm).score) ? ssrLooseContain(unref(assessmentForm).score, n) : ssrLooseEqual(unref(assessmentForm).score, n)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(n)}</option>`);
              });
              _push2(`<!--]--></select></div></div><div class="space-y-2" data-v-05bec8ec${_scopeId}><label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]" data-v-05bec8ec${_scopeId}>Deskripsi Temuan Audit</label><textarea rows="3" placeholder="Tuliskan temuan audit secara detail..." class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-800 border-0 rounded-2xl text-sm font-bold dark:text-white shadow-inner outline-none" required data-v-05bec8ec${_scopeId}>${ssrInterpolate(unref(assessmentForm).auditor_note)}</textarea></div><div class="space-y-2" data-v-05bec8ec${_scopeId}><label class="text-[10px] font-black text-amber-500 uppercase tracking-[0.2em]" data-v-05bec8ec${_scopeId}>Rekomendasi Perbaikan</label><textarea rows="3" placeholder="Saran langkah perbaikan untuk unit kerja..." class="w-full px-5 py-3.5 bg-amber-50/50 dark:bg-amber-900/10 border-2 border-amber-100 dark:border-amber-900/20 rounded-2xl text-sm font-bold dark:text-white outline-none" data-v-05bec8ec${_scopeId}>${ssrInterpolate(unref(assessmentForm).recommendation)}</textarea></div><div class="grid grid-cols-2 gap-6 pt-4 border-t dark:border-slate-800" data-v-05bec8ec${_scopeId}><div class="space-y-2" data-v-05bec8ec${_scopeId}><label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]" data-v-05bec8ec${_scopeId}>Link Verifikasi</label><input${ssrRenderAttr("value", unref(assessmentForm).evidence_url)} type="url" placeholder="https://..." class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-800 border-0 rounded-2xl text-sm dark:text-white shadow-inner outline-none" data-v-05bec8ec${_scopeId}></div><div class="space-y-2" data-v-05bec8ec${_scopeId}><label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]" data-v-05bec8ec${_scopeId}>Upload Bukti Baru</label><input type="file" class="w-full text-[10px] text-slate-400 file:mr-4 file:py-2.5 file:px-6 file:rounded-xl file:border-0 file:bg-slate-900 file:text-white file:font-black hover:file:bg-rose-600 transition-all cursor-pointer" data-v-05bec8ec${_scopeId}></div></div></div><div class="p-8 border-t dark:border-slate-800 flex justify-end gap-3 bg-slate-50/30" data-v-05bec8ec${_scopeId}><button type="button" class="px-8 py-3 text-[10px] font-black uppercase text-slate-400 hover:text-slate-600 transition-colors" data-v-05bec8ec${_scopeId}>Batal</button><button type="submit"${ssrIncludeBooleanAttr(unref(assessmentForm).processing) ? " disabled" : ""} class="px-12 py-3 bg-rose-600 text-white rounded-2xl font-black uppercase text-[10px] shadow-xl shadow-rose-500/20 hover:bg-rose-700 hover:translate-y-[-2px] active:translate-y-0 transition-all disabled:opacity-50 tracking-widest" data-v-05bec8ec${_scopeId}>${ssrInterpolate(unref(assessmentForm).processing ? "Menyimpan..." : "Simpan Penilaian")}</button></div></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showHistoryModal.value) {
              _push2(`<div class="fixed inset-0 z-[999] flex items-center justify-center p-4" data-v-05bec8ec${_scopeId}><div class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm transition-opacity" data-v-05bec8ec${_scopeId}></div><div class="relative bg-white dark:bg-slate-900 w-full max-w-lg rounded-[1rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200 flex flex-col max-h-[85vh]" data-v-05bec8ec${_scopeId}><div class="p-8 border-b dark:border-slate-800 flex justify-between items-center bg-slate-50/50" data-v-05bec8ec${_scopeId}><div data-v-05bec8ec${_scopeId}><h3 class="text-xl font-black uppercase text-slate-800 dark:text-white leading-none tracking-tighter" data-v-05bec8ec${_scopeId}> Jejak Audit</h3><p class="text-[10px] font-bold text-rose-600 font-mono mt-2 uppercase tracking-widest italic" data-v-05bec8ec${_scopeId}>${ssrInterpolate(activeIndicatorCode.value)}</p></div><button class="text-slate-400 hover:text-rose-600 text-3xl transition-colors" data-v-05bec8ec${_scopeId}>×</button></div><div class="p-10 overflow-y-auto bg-white dark:bg-slate-900 custom-scrollbar flex-1" data-v-05bec8ec${_scopeId}>`);
              if (loadingHistory.value) {
                _push2(`<div class="text-center py-12" data-v-05bec8ec${_scopeId}><div class="animate-spin inline-block w-10 h-10 border-4 border-rose-500 border-t-transparent rounded-full mb-4" data-v-05bec8ec${_scopeId}></div><p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]" data-v-05bec8ec${_scopeId}>Memuat Histori... </p></div>`);
              } else {
                _push2(`<div class="space-y-10" data-v-05bec8ec${_scopeId}><!--[-->`);
                ssrRenderList(activeHistory.value, (log) => {
                  _push2(`<div class="relative pl-10 border-l-2 border-slate-100 dark:border-slate-800" data-v-05bec8ec${_scopeId}><div class="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-white dark:bg-slate-900 border-4 border-rose-600 shadow-sm shadow-rose-500/30" data-v-05bec8ec${_scopeId}></div><div class="text-[10px] font-black text-rose-600 uppercase tracking-widest mb-1" data-v-05bec8ec${_scopeId}>${ssrInterpolate(new Date(log.created_at).toLocaleString("id-ID", {
                    dateStyle: "medium",
                    timeStyle: "short"
                  }))}</div><div class="text-sm font-black text-slate-800 dark:text-white leading-none mb-1" data-v-05bec8ec${_scopeId}>${ssrInterpolate(log.user ? log.user.name : "Sistem")}</div><div class="text-[10px] font-bold text-slate-400 uppercase tracking-tighter mb-4" data-v-05bec8ec${_scopeId}>${ssrInterpolate(log.user ? log.user.role : "SYSTEM")} (Tahap: ${ssrInterpolate(log.stage)})</div><div class="bg-slate-50 dark:bg-slate-800/50 p-5 rounded-3xl border border-slate-100 dark:border-slate-800" data-v-05bec8ec${_scopeId}><p class="text-[10px] font-black text-slate-700 dark:text-slate-200 mb-3 uppercase tracking-tighter italic border-b dark:border-slate-700 pb-1" data-v-05bec8ec${_scopeId}> Aksi: <span class="text-rose-600" data-v-05bec8ec${_scopeId}>${ssrInterpolate(log.action.replace(/_/g, " "))}</span></p><div class="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed font-medium space-y-1" data-v-05bec8ec${_scopeId}>${log.formatted_changes ?? ""}</div></div></div>`);
                });
                _push2(`<!--]-->`);
                if (!activeHistory.value.length) {
                  _push2(`<div class="text-center py-10" data-v-05bec8ec${_scopeId}><p class="text-[10px] text-slate-300 font-black uppercase tracking-widest italic" data-v-05bec8ec${_scopeId}>Belum ada rekaman aktivitas.</p></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
              }
              _push2(`</div><div class="p-8 bg-slate-50 dark:bg-slate-800/50 border-t dark:border-slate-800 text-right" data-v-05bec8ec${_scopeId}><button class="px-10 py-3 bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl transition-all hover:bg-rose-600 shadow-xl active:scale-95" data-v-05bec8ec${_scopeId}>Tutup Histori</button></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showDocModal.value) {
              _push2(`<div class="fixed inset-0 z-[999] flex items-center justify-center p-4" data-v-05bec8ec${_scopeId}><div class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm" data-v-05bec8ec${_scopeId}></div><div class="relative bg-white dark:bg-slate-900 w-full max-w-md rounded-[1rem] shadow-2xl animate-in zoom-in duration-200 overflow-hidden" data-v-05bec8ec${_scopeId}><div class="p-8 border-b bg-slate-50 dark:bg-slate-800/50 flex justify-between items-center" data-v-05bec8ec${_scopeId}><h3 class="text-xs font-black uppercase text-slate-800 dark:text-white tracking-[0.2em]" data-v-05bec8ec${_scopeId}>Upload Dokumen Resmi</h3><button class="text-3xl text-slate-300 hover:text-rose-600 transition-colors" data-v-05bec8ec${_scopeId}>×</button></div><form class="p-10 space-y-8 text-center" data-v-05bec8ec${_scopeId}><div class="p-2 bg-rose-50 dark:bg-rose-900/10 text-rose-600 rounded-[2rem] text-[10px] font-black uppercase border border-rose-100 dark:border-rose-900 shadow-inner" data-v-05bec8ec${_scopeId}> Jenis Dokumen: <span class="block text-sm mt-1 tracking-tighter italic" data-v-05bec8ec${_scopeId}>${ssrInterpolate(unref(docForm).label)}</span></div>`);
              if (unref(docForm).errors.message) {
                _push2(`<div class="p-3 mb-4 bg-rose-50 text-rose-600 text-[10px] font-bold rounded-xl border border-rose-100 italic" data-v-05bec8ec${_scopeId}>${ssrInterpolate(unref(docForm).errors.message)}</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="relative group" data-v-05bec8ec${_scopeId}><input type="file" required class="w-full text-[10px] text-slate-400 file:mr-4 file:py-3 file:px-8 file:rounded-2xl file:border-0 file:bg-slate-900 file:text-white file:font-black hover:file:bg-rose-600 transition-all cursor-pointer" data-v-05bec8ec${_scopeId}></div>`);
              if (unref(docForm).errors.file) {
                _push2(`<div class="text-[9px] text-rose-500 font-bold mt-1 uppercase italic" data-v-05bec8ec${_scopeId}>${ssrInterpolate(unref(docForm).errors.file)}</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<button type="submit"${ssrIncludeBooleanAttr(unref(docForm).processing) ? " disabled" : ""} class="w-full py-5 bg-rose-600 text-white rounded-[2rem] font-black uppercase text-[10px] tracking-[0.3em] shadow-2xl hover:bg-rose-700 transition-all active:scale-95 disabled:opacity-50" data-v-05bec8ec${_scopeId}>${ssrInterpolate(unref(docForm).processing ? "Sedang Mengunggah..." : "Finalisasi & Simpan")}</button></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const Show = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-05bec8ec"]]);
export {
  Show as default
};
