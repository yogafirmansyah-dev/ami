    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        if (_ctx.$slots.subGreeting) {
          _push2(`<div class="text-sm shadow p-2 bg-white bg-opacity-75 text-center font-semibold"${_scopeId}>`);
        ...
        ], "auth-form"])}"${_scopeId}><form${_scopeId}><div class="mt-2"${_scopeId}>`);
        ...
        _push2(`</div><div class="auth-submit-area flex-col"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_t_button, {
          class: [{ "opacity-25": _ctx.form.processing }, "ml-4"],
          color: _ctx.activeDesign.forgotPassword.sendButton[_ctx.appearingMode].color,
          design: _ctx.activeDesign.forgotPassword.sendButton[_ctx.appearingMode].design,
        ...
        _push2(ssrRenderComponent(_component_t_button, {
          color: _ctx.activeDesign.forgotPassword.backButton[_ctx.appearingMode].color,
          design: _ctx.activeDesign.forgotPassword.backButton[_ctx.appearingMode].design,
        ...
        return [
          createVNode("div", {
            ...
            _ctx.$slots.subGreeting ? (openBlock(), createBlock("div", {
              key: 0,
              class: "text-sm shadow p-2 bg-white bg-opacity-75 text-center font-semibold"
            }, [
            ...
            createVNode("div", {
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "auth-submit-area flex-col" }, [
