    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AppLayout, mergeProps({ title: "Master Fakultas" }, _attrs), {
        ...
        subHeader: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-wider" data-v-33b01e9c${_scopeId}>Manajemen unit kerja tingkat Fakultas / Dekanat</span>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-6" data-v-33b01e9c${_scopeId}><div class="flex flex-col lg:flex-row justify-between items-center gap-6" data-v-33b01e9c${_scopeId}><div class="flex items-stretch gap-3 w-full max-w-2xl" data-v-33b01e9c${_scopeId}><div class="relative flex-1 group" data-v-33b01e9c${_scopeId}><span class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none" data-v-33b01e9c${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-magnifying-glass",
              class: "text-slate-400 text-xs group-focus-within:text-rose-500 transition-colors"
            }, null, _parent2, _scopeId));
            _push2(`</span><input${ssrRenderAttr("value", search.value)} type="text" placeholder="Cari nama fakultas..." class="w-full pl-11 pr-4 py-4 bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder:text-slate-400/50 font-bold text-xs rounded-2xl border-none outline-none focus:outline-none ring-1 ring-slate-200 dark:ring-slate-800 dark:focus:ring-rose-500/50 focus:ring-4 focus:ring-rose-500/50 shadow-sm focus:shadow-md transition-[ring,background-color,box-shadow] duration-300 ease-out focus:bg-slate-50 dark:focus:bg-slate-800/80" data-v-33b01e9c${_scopeId}></div><div class="flex items-center bg-white dark:bg-slate-900 rounded-2xl px-4 ring-1 ring-slate-200 dark:ring-slate-800 shadow-sm hover:ring-rose-500/50 dark:hover:ring-rose-500/50 transition-all duration-300" data-v-33b01e9c${_scopeId}><span class="hidden sm:inline text-[9px] font-black uppercase text-slate-400 px-2 border-r border-slate-200 dark:border-slate-800 mr-2" data-v-33b01e9c${_scopeId}>Tampilkan</span><select class="bg-transparent dark:bg-slate-900 border-none focus:ring-0 text-xs font-black text-slate-900 dark:text-white py-4 pr-8 cursor-pointer hover:text-rose-500 dark:hover:text-rose-500 transition-colors duration-300 outline-none" data-v-33b01e9c${_scopeId}><option${ssrRenderAttr("value", 10)} data-v-33b01e9c${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 10) : ssrLooseEqual(perPage.value, 10)) ? " selected" : ""}${_scopeId}>10</option><option${ssrRenderAttr("value", 25)} data-v-33b01e9c${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 25) : ssrLooseEqual(perPage.value, 25)) ? " selected" : ""}${_scopeId}>25</option><option${ssrRenderAttr("value", 50)} data-v-33b01e9c${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 50) : ssrLooseEqual(perPage.value, 50)) ? " selected" : ""}${_scopeId}>50</option><option${ssrRenderAttr("value", 100)} data-v-33b01e9c${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 100) : ssrLooseEqual(perPage.value, 100)) ? " selected" : ""}${_scopeId}>100</option></select></div></div><div class="flex items-center gap-3" data-v-33b01e9c${_scopeId}></div></div><div class="bg-white/60 dark:bg-slate-900 backdrop-blur-3xl rounded-[2.5rem] border border-white/40 dark:border-white/5 shadow-sm overflow-hidden" data-v-33b01e9c${_scopeId}><div class="overflow-x-auto custom-scrollbar" data-v-33b01e9c${_scopeId}><table class="w-full text-left border-collapse min-w-[800px] lg:min-w-full" data-v-33b01e9c${_scopeId}><thead data-v-33b01e9c${_scopeId}><tr class="bg-slate-50/80 dark:bg-slate-800/20 text-[10px] font-black uppercase text-slate-400 dark:text-slate-500 tracking-[0.2em] sticky top-0 z-20 border-b border-slate-100 dark:border-slate-800/50" data-v-33b01e9c${_scopeId}><th class="p-6 md:p-8 text-center w-24" data-v-33b01e9c${_scopeId}>No</th><th class="p-6 md:p-8 pl-8" data-v-33b01e9c${_scopeId}>Nama Fakultas</th><th class="p-6 md:p-8 text-center" data-v-33b01e9c${_scopeId}>Total Prodi</th><th class="p-6 md:p-8 pr-8 text-center w-24" data-v-33b01e9c${_scopeId}>Aksi</th></tr></thead><tbody class="divide-y divide-slate-50 dark:divide-slate-800/20" data-v-33b01e9c${_scopeId}><!--[-->`);
            ssrRenderList(__props.faculties.data, (item, index) => {
              _push2(`<tr class="group hover:bg-white/50 dark:hover:bg-white/[0.02] transition-colors duration-300" data-v-33b01e9c${_scopeId}><td class="p-6 md:p-8 text-center" data-v-33b01e9c${_scopeId}><span class="font-mono text-sm font-black text-rose-500 bg-rose-50 dark:bg-rose-500/10 px-2 py-1 rounded-md border border-rose-100 dark:border-rose-500/20" data-v-33b01e9c${_scopeId}>${ssrInterpolate(__props.faculties.from + __props.faculties.data.indexOf(item))}</span></td><td class="p-6 md:p-8 pl-8" data-v-33b01e9c${_scopeId}><div class="font-black text-slate-800 dark:text-slate-200 text-sm" data-v-33b01e9c${_scopeId}>${ssrInterpolate(item.name)}</div></td><td class="p-6 md:p-8 text-center" data-v-33b01e9c${_scopeId}><div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 group-hover:bg-indigo-100 dark:group-hover:bg-indigo-500/20 transition-colors" data-v-33b01e9c${_scopeId}><span class="text-xs font-black text-indigo-600 dark:text-indigo-400" data-v-33b01e9c${_scopeId}>${ssrInterpolate(item.prodis_count || 0)}</span><span class="text-[9px] font-bold text-indigo-400 dark:text-indigo-500 uppercase tracking-wider" data-v-33b01e9c${_scopeId}>Prodi</span></div></td><td class="p-6 md:p-8 pr-8" data-v-33b01e9c${_scopeId}><div class="flex justify-center gap-2 opacity-60 group-hover:opacity-100 transition-opacity" data-v-33b01e9c${_scopeId}><button class="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 hover:text-blue-600 rounded-xl transition-all shadow-sm hover:shadow-md hover:border-blue-200 active:scale-95" data-v-33b01e9c${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-pencil",
                class: "text-[10px]"
              }, null, _parent2, _scopeId));
              _push2(`</button><button class="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 hover:text-rose-600 rounded-xl transition-all shadow-sm hover:shadow-md hover:border-rose-200 active:scale-95" data-v-33b01e9c${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
            ...
            if (__props.faculties.data.length === 0) {
              _push2(`<tr data-v-33b01e9c${_scopeId}><td colspan="4" class="p-12 text-center" data-v-33b01e9c${_scopeId}><div class="flex flex-col items-center justify-center opacity-50" data-v-33b01e9c${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-building-columns",
                class: "text-4xl text-slate-300 dark:text-slate-600 mb-4"
              }, null, _parent2, _scopeId));
              _push2(`<p class="text-xs font-black text-slate-400 uppercase tracking-widest italic" data-v-33b01e9c${_scopeId}> Data fakultas tidak ditemukan</p></div></td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tbody></table></div><div class="flex flex-col md:flex-row items-center justify-between gap-4 px-6 md:px-8 py-6 border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-800/20 backdrop-blur-sm" data-v-33b01e9c${_scopeId}><div class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest italic text-center md:text-left" data-v-33b01e9c${_scopeId}> Data ${ssrInterpolate(__props.faculties.from)} - ${ssrInterpolate(__props.faculties.to)} dari total ${ssrInterpolate(__props.faculties.total)}</div><div class="flex flex-wrap justify-center gap-1.5" data-v-33b01e9c${_scopeId}><!--[-->`);
            ...
            if (showModal.value) {
              _push2(`<div class="fixed inset-0 z-50 flex items-center justify-center p-4" data-v-33b01e9c${_scopeId}><div class="fixed inset-0 bg-slate-900/80 backdrop-blur-md transition-opacity" data-v-33b01e9c${_scopeId}></div><div class="relative bg-white dark:bg-slate-900 w-full max-w-md rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 border border-white/10" data-v-33b01e9c${_scopeId}><div class="p-8 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 flex justify-between items-center" data-v-33b01e9c${_scopeId}><div data-v-33b01e9c${_scopeId}><h3 class="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tighter italic" data-v-33b01e9c${_scopeId}>${ssrInterpolate(editMode.value ? "Edit Fakultas" : "Fakultas Baru")}</h3><p class="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mt-1" data-v-33b01e9c${_scopeId}> Manajemen Unit </p></div><button class="w-8 h-8 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 text-slate-400 hover:text-rose-600 transition-colors font-bold text-lg" data-v-33b01e9c${_scopeId}>×</button></div><form class="p-8 space-y-6" data-v-33b01e9c${_scopeId}><div class="space-y-2" data-v-33b01e9c${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-33b01e9c${_scopeId}>Nama Fakultas</label><input${ssrRenderAttr("value", unref(form).name)} type="text" required placeholder="Masukkan nama fakultas (ex: Fakultas Teknik)" class="w-full px-5 py-3.5 bg-white dark:bg-slate-900 border-none rounded-2xl text-xs font-bold text-slate-900 dark:text-white ring-1 ring-slate-200 dark:ring-slate-800 focus:ring-2 focus:ring-rose-500 transition-all shadow-sm" data-v-33b01e9c${_scopeId}>`);
              if (unref(form).errors.name) {
                _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-33b01e9c${_scopeId}>${ssrInterpolate(unref(form).errors.name)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="pt-4" data-v-33b01e9c${_scopeId}><button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="w-full py-4 bg-slate-900 dark:bg-rose-600 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl shadow-xl shadow-slate-900/10 dark:shadow-rose-600/20 transition-all hover:bg-rose-600 dark:hover:bg-rose-500 hover:-translate-y-0.5 active:scale-95 disabled:opacity-50" data-v-33b01e9c${_scopeId}>${ssrInterpolate(unref(form).processing ? "Menyimpan..." : editMode.value ? "Simpan Perubahan" : "Simpan Data")}</button></div></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-33b01e9c"]]);
export {
  Index as default
};
