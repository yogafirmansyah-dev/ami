    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AppLayout, mergeProps({ title: "Pusat Referensi" }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-8" data-v-d33ee411${_scopeId}><div class="flex flex-col md:flex-row justify-between items-end gap-4" data-v-d33ee411${_scopeId}><div class="space-y-1" data-v-d33ee411${_scopeId}><p class="text-[10px] font-black text-rose-600 uppercase tracking-[0.3em] italic" data-v-d33ee411${_scopeId}>Digital Asset Management </p><h2 class="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tighter leading-none" data-v-d33ee411${_scopeId}> Pustaka Dokumen <span class="text-emerald-600 dark:text-emerald-400" data-v-d33ee411${_scopeId}>AMI</span></h2></div><div class="relative w-full md:w-96 group" data-v-d33ee411${_scopeId}><input${ssrRenderAttr("value", search.value)} type="text" placeholder="Cari regulasi atau pedoman..." class="w-full pl-12 pr-4 py-4 text-xs bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 rounded-[1.5rem] shadow-sm focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 transition-all placeholder:font-bold placeholder:uppercase placeholder:tracking-widest" data-v-d33ee411${_scopeId}><svg class="w-5 h-5 absolute left-4 top-3.5 text-slate-400 group-focus-within:text-rose-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d33ee411${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-d33ee411${_scopeId}></path></svg></div></div><div class="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden" data-v-d33ee411${_scopeId}><div class="overflow-x-auto" data-v-d33ee411${_scopeId}><table class="w-full text-left border-collapse" data-v-d33ee411${_scopeId}><thead data-v-d33ee411${_scopeId}><tr class="bg-slate-50/50 dark:bg-slate-800/50 border-b dark:border-slate-800" data-v-d33ee411${_scopeId}><th class="p-8 text-[10px] font-black uppercase text-slate-500 tracking-[0.2em] text-center" data-v-d33ee411${_scopeId}> No </th><th class="p-8 text-[10px] font-black uppercase text-slate-500 tracking-[0.2em]" data-v-d33ee411${_scopeId}>Info Dokumen </th><th class="p-8 text-[10px] font-black uppercase text-slate-500 tracking-[0.2em] text-center" data-v-d33ee411${_scopeId}> Tipe</th><th class="p-8 text-[10px] font-black uppercase text-slate-500 tracking-[0.2em] text-center" data-v-d33ee411${_scopeId}> Format</th><th class="p-8 text-[10px] font-black uppercase text-slate-500 tracking-[0.2em]" data-v-d33ee411${_scopeId}> Metadata</th><th class="p-8 text-[10px] font-black uppercase text-slate-500 tracking-[0.2em] text-right" data-v-d33ee411${_scopeId}> Aksi </th></tr></thead><tbody class="divide-y divide-slate-100 dark:divide-slate-800" data-v-d33ee411${_scopeId}><!--[-->`);
            ssrRenderList(__props.documents.data, (doc) => {
              _push2(`<tr class="group hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-all duration-300" data-v-d33ee411${_scopeId}><td class="p-8 text-[10px] font-black uppercase text-slate-500 tracking-[0.2em] text-center" data-v-d33ee411${_scopeId}><span class="font-mono text-sm font-black text-rose-500 bg-rose-50 dark:bg-rose-500/10 px-2 py-1 rounded-md border border-rose-100 dark:border-rose-500/20" data-v-d33ee411${_scopeId}>${ssrInterpolate(__props.documents.from + __props.documents.data.indexOf(doc))}</span></td><td class="p-8" data-v-d33ee411${_scopeId}><div class="flex items-center gap-5" data-v-d33ee411${_scopeId}><div class="w-12 h-12 rounded-2xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-xl shadow-inner group-hover:scale-110 transition-transform" data-v-d33ee411${_scopeId}>${ssrInterpolate(getFileIcon(doc.extension))}</div><div data-v-d33ee411${_scopeId}><h3 class="font-black text-slate-900 dark:text-white uppercase text-sm tracking-tight leading-none mb-2" data-v-d33ee411${_scopeId}>${ssrInterpolate(doc.name)}</h3><p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest italic" data-v-d33ee411${_scopeId}> ID: #AMI-DOC-${ssrInterpolate(String(doc.id).padStart(4, "0"))}</p></div></div></td><td class="p-8 text-center" data-v-d33ee411${_scopeId}><span class="${ssrRenderClass([
              ...
              ])}" data-v-d33ee411${_scopeId}>${ssrInterpolate(doc.type)}</span></td><td class="p-8 text-center" data-v-d33ee411${_scopeId}><span class="text-[10px] font-black text-slate-800 dark:text-slate-300 uppercase bg-slate-100 dark:bg-slate-800 px-3 py-1 rounded-lg" data-v-d33ee411${_scopeId}> .${ssrInterpolate(doc.extension)}</span></td><td class="p-8" data-v-d33ee411${_scopeId}><div class="space-y-1" data-v-d33ee411${_scopeId}><div class="flex items-center gap-2" data-v-d33ee411${_scopeId}><span class="text-[8px] font-black text-slate-400 uppercase" data-v-d33ee411${_scopeId}>Uploader:</span><span class="text-[10px] font-bold text-slate-700 dark:text-slate-400" data-v-d33ee411${_scopeId}>${ssrInterpolate(doc.uploader.name)}</span></div><div class="flex items-center gap-2" data-v-d33ee411${_scopeId}><span class="text-[8px] font-black text-slate-400 uppercase" data-v-d33ee411${_scopeId}>Tanggal:</span><span class="text-[10px] font-bold text-slate-500" data-v-d33ee411${_scopeId}>${ssrInterpolate(new Date(doc.created_at).toLocaleDateString("id-ID"))}</span></div></div></td><td class="p-8 text-right" data-v-d33ee411${_scopeId}><a${ssrRenderAttr("href", _ctx.route("library.download", doc.id))} target="_blank" class="inline-flex items-center gap-3 px-6 py-3 bg-slate-900 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl shadow-slate-900/20 hover:bg-rose-600 hover:translate-x-1 transition-all active:scale-95" data-v-d33ee411${_scopeId}> Buka Berkas <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d33ee411${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3" data-v-d33ee411${_scopeId}></path></svg></a></td></tr>`);
            });
            _push2(`<!--]-->`);
            if (__props.documents.data.length === 0) {
              _push2(`<tr data-v-d33ee411${_scopeId}><td colspan="5" class="p-12 text-center" data-v-d33ee411${_scopeId}><div class="flex flex-col items-center justify-center py-12 border-2 border-dashed border-slate-200 dark:border-slate-700/50 rounded-[2.5rem]" data-v-d33ee411${_scopeId}><div class="w-20 h-20 bg-slate-50 dark:bg-slate-800 rounded-full flex items-center justify-center mb-6 shadow-sm" data-v-d33ee411${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: search.value ? "fa-solid fa-search" : "fa-solid fa-folder",
                class: "text-3xl text-slate-300 dark:text-slate-600"
              }, null, _parent2, _scopeId));
              _push2(`</div><h4 class="text-sm font-black text-slate-800 dark:text-white uppercase tracking-widest" data-v-d33ee411${_scopeId}>${ssrInterpolate(search.value ? "Tidak Ditemukan" : "Belum Ada Dokumen")}</h4><p class="text-[10px] font-bold text-slate-400 uppercase mt-2 max-w-xs px-4" data-v-d33ee411${_scopeId}>${ssrInterpolate(emptyStateMessage.value)}</p>`);
              if (search.value) {
                _push2(`<button class="mt-6 px-6 py-2 bg-slate-100 dark:bg-slate-800 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors" data-v-d33ee411${_scopeId}> Reset Pencarian </button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></td></tr>`);
            ...
            _push2(`</tbody></table></div><div class="flex flex-col md:flex-row items-center justify-between gap-4 px-6 md:px-8 py-6 border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-800/20 backdrop-blur-sm" data-v-d33ee411${_scopeId}><div class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest italic text-center md:text-left flex items-center gap-2" data-v-d33ee411${_scopeId}><span class="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" data-v-d33ee411${_scopeId}></span> Data ${ssrInterpolate(__props.documents.from)} - ${ssrInterpolate(__props.documents.to)} dari total ${ssrInterpolate(__props.documents.total)}</div><div class="flex flex-wrap justify-center gap-1.5" data-v-d33ee411${_scopeId}><!--[-->`);
            ssrRenderList(__props.documents.links, (link, k) => {
              ...
              if (link.url) {
                ...
                ])}" data-v-d33ee411${_scopeId}>${link.label ?? ""}</span>`);
              }
              _push2(`<!--]-->`);
            });
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d33ee411"]]);
export {
  Index as default
};
