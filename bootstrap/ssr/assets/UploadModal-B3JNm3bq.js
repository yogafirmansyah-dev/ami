...
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500" }, _attrs))} data-v-90866d6d><div class="bg-white/60 dark:bg-slate-900 backdrop-blur-3xl rounded-[2.5rem] border border-white/40 dark:border-white/5 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md" data-v-90866d6d><div class="overflow-x-auto custom-scrollbar" data-v-90866d6d><table class="w-full text-left border-collapse min-w-[1100px] xl:min-w-full" data-v-90866d6d><thead data-v-90866d6d><tr class="bg-slate-50/80 dark:bg-slate-900/80 backdrop-blur-md text-[9px] font-black uppercase text-slate-400 dark:text-slate-500 tracking-[0.2em] sticky top-0 z-20 border-b border-slate-200/50 dark:border-slate-800" data-v-90866d6d><th class="p-6 text-center min-w-20" data-v-90866d6d>No</th><th class="p-6 text-center min-w-24 cursor-pointer hover:text-sky-500 transition-colors group select-none" data-v-90866d6d><div class="flex items-center justify-center gap-1" data-v-90866d6d> Kode <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-90866d6d>`);
      ...
      _push(`</div></div></th><th class="p-6 min-w-[350px] cursor-pointer hover:text-sky-500 transition-colors group select-none" data-v-90866d6d><div class="flex items-center justify-center gap-1" data-v-90866d6d> Indikator &amp; Kriteria <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-90866d6d>`);
      _push(ssrRenderComponent(_component_icon, {
        icon: "fa-solid fa-caret-up",
      ...
      _push(`</div></div></th><th class="p-6 min-w-[250px]" data-v-90866d6d>Bukti yang Diperiksa</th><th class="p-6 text-center w-32" data-v-90866d6d>Bukti</th><th class="p-6 text-center w-40 cursor-pointer hover:text-sky-500 transition-colors group select-none" data-v-90866d6d><div class="flex items-center justify-center gap-1" data-v-90866d6d> Hasil Audit <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-90866d6d>`);
      _push(ssrRenderComponent(_component_icon, {
        icon: "fa-solid fa-caret-up",
      ...
      _push(`</div></div></th><th class="p-6 min-w-[300px]" data-v-90866d6d>Catatan &amp; Rekomendasi</th><th class="p-6 text-center w-40 sticky right-0 bg-slate-50/80 dark:bg-slate-900/90 backdrop-blur-md z-30 shadow-none" data-v-90866d6d> Aksi</th></tr></thead><tbody class="divide-y divide-slate-100/50 dark:divide-slate-800/50" data-v-90866d6d><!--[-->`);
      ssrRenderList(__props.indicators.data, (item, index) => {
        _push(`<tr class="group hover:bg-slate-50/80 dark:hover:bg-slate-800/20 transition-all duration-200 align-top" data-v-90866d6d><td class="p-6 text-center" data-v-90866d6d><span class="${ssrRenderClass([
        ...
        ])}" data-v-90866d6d>${ssrInterpolate(__props.indicators.from + index)}</span></td><td class="p-6 text-center" data-v-90866d6d><span class="text-xs font-black text-slate-700 dark:text-slate-300 font-mono tracking-tighter bg-slate-100 dark:bg-slate-800 px-3 py-1 rounded-lg" data-v-90866d6d>${ssrInterpolate(item.snapshot_code)}</span></td><td class="p-6" data-v-90866d6d><p class="font-bold text-slate-800 dark:text-slate-200 text-sm italic leading-relaxed mb-2" data-v-90866d6d>${ssrInterpolate(item.snapshot_requirement)}</p><div class="flex items-center gap-2" data-v-90866d6d><span class="w-1.5 h-1.5 rounded-full bg-slate-300 dark:bg-slate-600" data-v-90866d6d></span><span class="text-[9px] font-black uppercase text-slate-400 tracking-wider" data-v-90866d6d>Kriteria Standar</span></div></td><td class="p-6" data-v-90866d6d><div class="p-5 bg-slate-50 dark:bg-slate-800/30 rounded-2xl border border-slate-100 dark:border-slate-800/50 group-hover:border-slate-200 dark:group-hover:border-slate-700 transition-colors" data-v-90866d6d><p class="text-xs text-slate-600 dark:text-slate-400 font-medium italic leading-relaxed" data-v-90866d6d>${ssrInterpolate(item.snapshot_evidence_needed)}</p>`);
        if (item.snapshot_template_path) {
          _push(`<div class="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700/50" data-v-90866d6d><a${ssrRenderAttr("href", _ctx.route("admin.indicators.show-assignment-template", item.id))} target="_blank" class="inline-flex items-center gap-2 text-[9px] font-black uppercase text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 transition-colors tracking-wider" data-v-90866d6d>`);
          _push(ssrRenderComponent(_component_icon, {
        ...
        if (!item.evidence_path && !item.evidence_url) {
          _push(`<span class="text-slate-300 dark:text-slate-600 font-black uppercase text-[8px] tracking-[0.2em] py-2" data-v-90866d6d>KOSONG</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></td><td class="p-6 text-center" data-v-90866d6d><div class="flex flex-col items-center gap-3" data-v-90866d6d><div class="${ssrRenderClass(["w-14 h-14 flex items-center justify-center rounded-[1.2rem] font-black text-xl border transition-all duration-300 transform group-hover:scale-110", getScoreColor(item.finding_type, item.score)])}" data-v-90866d6d>${ssrInterpolate(item.score ?? "-")}</div>`);
        if (item.finding_type) {
          _push(`<span class="${ssrRenderClass(["px-3 py-1 rounded-lg text-[9px] font-black border tracking-widest uppercase shadow-sm", getFindingBadge(item.finding_type)])}" data-v-90866d6d>${ssrInterpolate(item.finding_type)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></td><td class="p-6" data-v-90866d6d><div class="space-y-3" data-v-90866d6d>`);
        if (item.auditor_note) {
          _push(`<div class="p-4 bg-amber-50/50 dark:bg-amber-900/10 border-l-[3px] border-amber-400 rounded-r-2xl hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-colors" data-v-90866d6d><p class="text-[8px] font-black text-amber-500 uppercase mb-1.5 tracking-widest flex items-center gap-1.5" data-v-90866d6d> ⚠️ Temuan </p><p class="text-xs text-slate-700 dark:text-slate-300 font-medium italic leading-relaxed" data-v-90866d6d> &quot;${ssrInterpolate(item.auditor_note)}&quot;</p></div>`);
        } else {
          _push(`<!---->`);
        }
        if (item.recommendation) {
          _push(`<div class="p-4 bg-emerald-50/50 dark:bg-emerald-900/10 border-l-[3px] border-emerald-400 rounded-r-2xl hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-colors" data-v-90866d6d><p class="text-[8px] font-black text-emerald-500 uppercase mb-1.5 tracking-widest flex items-center gap-1.5" data-v-90866d6d> 💡 Saran </p><p class="text-xs text-slate-700 dark:text-slate-300 font-medium italic leading-relaxed" data-v-90866d6d>${ssrInterpolate(item.recommendation)}</p></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></td><td class="p-6 text-center align-middle sticky right-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md z-10 group-hover:bg-slate-50/90 dark:group-hover:bg-slate-800/90 transition-colors shadow-[-10px_0_20px_-10px_rgba(0,0,0,0.05)]" data-v-90866d6d><div class="flex flex-row justify-center items-center gap-3 relative z-20" data-v-90866d6d>`);
        if (canUpload.value) {
          _push(`<button class="w-10 h-10 flex items-center justify-center bg-gradient-to-br from-sky-400 to-sky-600 text-white rounded-xl shadow-lg shadow-sky-500/20 hover:shadow-sky-500/40 hover:scale-110 active:scale-95 transition-all" title="Upload Bukti" data-v-90866d6d>`);
          _push(ssrRenderComponent(_component_icon, {
        ...
        if (canScore.value) {
          _push(`<button class="w-10 h-10 flex items-center justify-center bg-gradient-to-br from-slate-800 to-slate-900 dark:from-white dark:to-slate-200 text-white dark:text-slate-900 rounded-xl shadow-lg hover:shadow-xl hover:scale-110 active:scale-95 transition-all" title="Penilaian" data-v-90866d6d>`);
          _push(ssrRenderComponent(_component_icon, {
      ...
      _push(`<!--]--></tbody></table></div><div class="flex flex-col md:flex-row items-center justify-between gap-4 px-6 md:px-8 py-6 border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-800/20 backdrop-blur-sm" data-v-90866d6d><div class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest italic text-center md:text-left flex items-center gap-2" data-v-90866d6d><span class="${ssrRenderClass(["w-2 h-2 rounded-full animate-pulse", __props.role === "auditor" ? "bg-emerald-500" : "bg-sky-500"])}" data-v-90866d6d></span> Data ${ssrInterpolate(__props.indicators.from)} - ${ssrInterpolate(__props.indicators.to)} dari total ${ssrInterpolate(__props.indicators.total)}</div><div class="flex flex-wrap justify-center gap-2" data-v-90866d6d><!--[-->`);
      ssrRenderList(__props.indicators.links, (link, k) => {
        ...
        if (link.url) {
          ...
          ])}" data-v-90866d6d>${link.label ?? ""}</span>`);
        }
        _push(`<!--]-->`);
      });
...
const ScoringView = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-90866d6d"]]);
const _sfc_main$3 = {
