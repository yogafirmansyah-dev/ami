import { ref, watch, resolveComponent, mergeProps, withCtx, unref, createVNode, createBlock, createCommentVNode, withDirectives, vModelText, vModelSelect, openBlock, Fragment, renderList, toDisplayString, withModifiers, Transition, createTextVNode, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AppLayout, mergeProps({ title: "Manajemen User" }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-6" data-v-a954a83d${_scopeId}><div class="flex flex-col lg:flex-row justify-between items-center gap-6" data-v-a954a83d${_scopeId}><div class="flex items-stretch gap-3 w-full max-w-2xl" data-v-a954a83d${_scopeId}><div class="relative flex-1 group" data-v-a954a83d${_scopeId}><span class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none" data-v-a954a83d${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-magnifying-glass",
              class: "text-slate-400 text-xs group-focus-within:text-rose-500 transition-colors"
            }, null, _parent2, _scopeId));
            _push2(`</span><input${ssrRenderAttr("value", search.value)} type="text" placeholder="Cari nama atau email..." class="w-full pl-11 pr-4 py-4 bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder:text-slate-400/50 font-bold text-xs rounded-2xl border-none outline-none focus:outline-none ring-1 ring-slate-200 dark:ring-slate-800 dark:focus:ring-rose-500/50 focus:ring-4 focus:ring-rose-500/50 shadow-sm focus:shadow-md transition-[ring,background-color,box-shadow] duration-300 ease-out focus:bg-slate-50 dark:focus:bg-slate-800/80" data-v-a954a83d${_scopeId}></div><div class="flex items-center bg-white dark:bg-slate-900 rounded-2xl px-4 ring-1 ring-slate-200 dark:ring-slate-800 shadow-sm hover:ring-rose-500/50 dark:hover:ring-rose-500/50 transition-all duration-300" data-v-a954a83d${_scopeId}><span class="hidden sm:inline text-[9px] font-black uppercase text-slate-400 px-2 border-r border-slate-200 dark:border-slate-800 mr-2" data-v-a954a83d${_scopeId}>Tampilkan</span><select class="bg-transparent dark:bg-slate-900 border-none focus:ring-0 text-xs font-black text-slate-900 dark:text-white py-4 pr-8 cursor-pointer hover:text-rose-500 dark:hover:text-rose-500 transition-colors duration-300 outline-none" data-v-a954a83d${_scopeId}><option${ssrRenderAttr("value", 10)} data-v-a954a83d${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 10) : ssrLooseEqual(perPage.value, 10)) ? " selected" : ""}${_scopeId}>10</option><option${ssrRenderAttr("value", 25)} data-v-a954a83d${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 25) : ssrLooseEqual(perPage.value, 25)) ? " selected" : ""}${_scopeId}>25</option><option${ssrRenderAttr("value", 50)} data-v-a954a83d${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 50) : ssrLooseEqual(perPage.value, 50)) ? " selected" : ""}${_scopeId}>50</option><option${ssrRenderAttr("value", 100)} data-v-a954a83d${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 100) : ssrLooseEqual(perPage.value, 100)) ? " selected" : ""}${_scopeId}>100</option></select></div></div><div class="flex items-center gap-3" data-v-a954a83d${_scopeId}></div></div><div class="bg-white/60 dark:bg-slate-900 backdrop-blur-3xl rounded-[2.5rem] border border-white/40 dark:border-white/5 shadow-sm overflow-hidden" data-v-a954a83d${_scopeId}><div class="overflow-x-auto custom-scrollbar" data-v-a954a83d${_scopeId}><table class="w-full text-left border-collapse min-w-[1000px] lg:min-w-full" data-v-a954a83d${_scopeId}><thead data-v-a954a83d${_scopeId}><tr class="bg-slate-50/80 dark:bg-slate-800/20 text-[10px] font-black uppercase text-slate-400 dark:text-slate-500 tracking-[0.2em] sticky top-0 z-20 border-b border-slate-100 dark:border-slate-800/50" data-v-a954a83d${_scopeId}><th class="p-6 md:p-8 pl-8 text-center" data-v-a954a83d${_scopeId}>No</th><th class="p-6 md:p-8 pl-8" data-v-a954a83d${_scopeId}>Pengguna</th><th class="p-6 md:p-8" data-v-a954a83d${_scopeId}>Role</th><th class="p-6 md:p-8" data-v-a954a83d${_scopeId}>Unit Kerja</th><th class="p-6 md:p-8 text-center" data-v-a954a83d${_scopeId}>2FA</th><th class="p-6 md:p-8 text-center" data-v-a954a83d${_scopeId}>Aksi</th></tr></thead><tbody class="divide-y divide-slate-50 dark:divide-slate-800/20" data-v-a954a83d${_scopeId}><!--[-->`);
            ssrRenderList(__props.users.data, (item) => {
              _push2(`<tr class="group hover:bg-white/50 dark:hover:bg-white/[0.02] transition-colors duration-300" data-v-a954a83d${_scopeId}><td class="p-6 md:p-8 text-center" data-v-a954a83d${_scopeId}><span class="font-mono text-sm font-black text-rose-500 bg-rose-50 dark:bg-rose-500/10 px-2 py-1 rounded-md border border-rose-100 dark:border-rose-500/20" data-v-a954a83d${_scopeId}>${ssrInterpolate(__props.users.from + __props.users.data.indexOf(item))}</span></td><td class="p-6 md:p-8 pl-8" data-v-a954a83d${_scopeId}><div class="flex items-center gap-4" data-v-a954a83d${_scopeId}><img${ssrRenderAttr("src", item.profile_photo_url)} class="w-10 h-10 rounded-full border-2 border-white dark:border-slate-700 shadow-sm" data-v-a954a83d${_scopeId}><div data-v-a954a83d${_scopeId}><div class="font-bold text-slate-800 dark:text-slate-200 text-sm mb-0.5" data-v-a954a83d${_scopeId}>${ssrInterpolate(item.name)}</div><div class="text-[10px] font-medium text-slate-400 tracking-tight" data-v-a954a83d${_scopeId}>${ssrInterpolate(item.email)}</div></div></div></td><td class="p-6 md:p-8" data-v-a954a83d${_scopeId}><span class="${ssrRenderClass([
              ...
              ])}" data-v-a954a83d${_scopeId}>${ssrInterpolate(item.role)}</span></td><td class="p-6 md:p-8" data-v-a954a83d${_scopeId}><span class="text-xs font-bold text-slate-600 dark:text-slate-400" data-v-a954a83d${_scopeId}>${ssrInterpolate(getUnitName(item))}</span></td><td class="p-6 md:p-8 text-center" data-v-a954a83d${_scopeId}>`);
              if (item.two_factor_confirmed_at) {
                _push2(`<div class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-emerald-50 dark:bg-emerald-500/10 text-emerald-500 border border-emerald-100 dark:border-emerald-500/20" title="2FA Aktif" data-v-a954a83d${_scopeId}>`);
                _push2(ssrRenderComponent(_component_icon, {
                ...
                _push2(`<div class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-slate-50 dark:bg-slate-800 text-slate-300 border border-slate-100 dark:border-slate-700" data-v-a954a83d${_scopeId}>`);
                _push2(ssrRenderComponent(_component_icon, {
              ...
              _push2(`<button class="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 hover:text-blue-600 rounded-xl transition-all shadow-sm hover:shadow-md hover:border-blue-200 active:scale-95" data-v-a954a83d${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-pencil",
                class: "text-[10px]"
              }, null, _parent2, _scopeId));
              _push2(`</button><button class="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 hover:text-rose-600 rounded-xl transition-all shadow-sm hover:shadow-md hover:border-rose-200 active:scale-95" data-v-a954a83d${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
            ...
            if (__props.users.data.length === 0) {
              _push2(`<tr data-v-a954a83d${_scopeId}><td colspan="5" class="p-12 text-center" data-v-a954a83d${_scopeId}><div class="flex flex-col items-center justify-center opacity-50" data-v-a954a83d${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-users-slash",
                class: "text-4xl text-slate-300 dark:text-slate-600 mb-4"
              }, null, _parent2, _scopeId));
              _push2(`<p class="text-xs font-black text-slate-400 uppercase tracking-widest italic" data-v-a954a83d${_scopeId}> Belum ada pengguna ditemukan</p></div></td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tbody></table></div><div class="flex flex-col md:flex-row items-center justify-between gap-4 px-6 md:px-8 py-6 border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-800/20 backdrop-blur-sm" data-v-a954a83d${_scopeId}><div class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest italic text-center md:text-left" data-v-a954a83d${_scopeId}> Data ${ssrInterpolate(__props.users.from)} - ${ssrInterpolate(__props.users.to)} dari total ${ssrInterpolate(__props.users.total)}</div><div class="flex flex-wrap justify-center gap-1.5" data-v-a954a83d${_scopeId}><!--[-->`);
            ssrRenderList(__props.users.links, (link, k) => {
              ...
              if (link.url) {
                ...
                ])}" data-v-a954a83d${_scopeId}>${link.label ?? ""}</span>`);
              }
              _push2(`<!--]-->`);
            });
            _push2(`<!--]--></div></div></div></div>`);
            if (showModal.value) {
              _push2(`<div class="fixed inset-0 z-50 flex items-center justify-center p-4" data-v-a954a83d${_scopeId}><div class="fixed inset-0 bg-slate-900/80 backdrop-blur-md transition-opacity" data-v-a954a83d${_scopeId}></div><div class="relative bg-white dark:bg-slate-900 w-full max-w-2xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 border border-white/10 flex flex-col max-h-[85vh]" data-v-a954a83d${_scopeId}><div class="p-8 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 flex justify-between items-center shrink-0" data-v-a954a83d${_scopeId}><div data-v-a954a83d${_scopeId}><h3 class="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tighter italic" data-v-a954a83d${_scopeId}>${ssrInterpolate(editMode.value ? "Edit User" : "User Baru")}</h3><p class="text-[10px] font-bold text-rose-500 uppercase tracking-widest mt-1" data-v-a954a83d${_scopeId}> Manajemen Hak Akses </p></div><button class="w-8 h-8 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 text-slate-400 hover:text-rose-600 transition-colors font-bold text-lg" data-v-a954a83d${_scopeId}>×</button></div><form class="p-8 space-y-6 overflow-y-auto custom-scrollbar flex-1" data-v-a954a83d${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-a954a83d${_scopeId}><div class="space-y-2" data-v-a954a83d${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-a954a83d${_scopeId}>Nama Lengkap</label><input${ssrRenderAttr("value", unref(form).name)} type="text" required class="w-full px-5 py-3.5 bg-white dark:bg-slate-900 border-none rounded-2xl text-xs font-bold text-slate-900 dark:text-white ring-1 ring-slate-200 dark:ring-slate-800 focus:ring-2 focus:ring-rose-500 transition-all shadow-sm" data-v-a954a83d${_scopeId}>`);
              if (unref(form).errors.name) {
                _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-a954a83d${_scopeId}>${ssrInterpolate(unref(form).errors.name)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="space-y-2" data-v-a954a83d${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-a954a83d${_scopeId}>Email</label><input${ssrRenderAttr("value", unref(form).email)} type="email" required class="w-full px-5 py-3.5 bg-white dark:bg-slate-900 border-none rounded-2xl text-xs font-bold text-slate-900 dark:text-white ring-1 ring-slate-200 dark:ring-slate-800 focus:ring-2 focus:ring-rose-500 transition-all shadow-sm" data-v-a954a83d${_scopeId}>`);
              if (unref(form).errors.email) {
                _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-a954a83d${_scopeId}>${ssrInterpolate(unref(form).errors.email)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-a954a83d${_scopeId}><div class="space-y-2" data-v-a954a83d${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-a954a83d${_scopeId}>Password</label><input${ssrRenderAttr("value", unref(form).password)} type="password"${ssrIncludeBooleanAttr(!editMode.value) ? " required" : ""} class="w-full px-5 py-3.5 bg-white dark:bg-slate-900 border-none rounded-2xl text-xs font-bold text-slate-900 dark:text-white ring-1 ring-slate-200 dark:ring-slate-800 focus:ring-2 focus:ring-rose-500 transition-all shadow-sm" data-v-a954a83d${_scopeId}>`);
              if (editMode.value) {
                _push2(`<p class="text-[10px] text-slate-400 font-bold italic ml-1" data-v-a954a83d${_scopeId}>* Kosongkan jika tidak ganti</p>`);
              } else {
                _push2(`<!---->`);
              }
              if (unref(form).errors.password) {
                _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-a954a83d${_scopeId}>${ssrInterpolate(unref(form).errors.password)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="space-y-2" data-v-a954a83d${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-a954a83d${_scopeId}>Konfirmasi Password</label><input${ssrRenderAttr("value", unref(form).password_confirmation)} type="password"${ssrIncludeBooleanAttr(!editMode.value) ? " required" : ""} class="w-full px-5 py-3.5 bg-white dark:bg-slate-900 border-none rounded-2xl text-xs font-bold text-slate-900 dark:text-white ring-1 ring-slate-200 dark:ring-slate-800 focus:ring-2 focus:ring-rose-500 transition-all shadow-sm" data-v-a954a83d${_scopeId}></div></div><div class="space-y-2" data-v-a954a83d${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-a954a83d${_scopeId}>Role / Hak Akses</label><select required class="w-full px-5 py-3.5 bg-white dark:bg-slate-900 border-none rounded-2xl text-xs font-bold text-slate-900 dark:text-white ring-1 ring-slate-200 dark:ring-slate-800 focus:ring-2 focus:ring-rose-500 transition-all shadow-sm" data-v-a954a83d${_scopeId}><option value="" disabled data-v-a954a83d${ssrIncludeBooleanAttr(Array.isArray(unref(form).role) ? ssrLooseContain(unref(form).role, "") : ssrLooseEqual(unref(form).role, "")) ? " selected" : ""}${_scopeId}>Pilih Role</option><!--[-->`);
              ssrRenderList(__props.roles, (role) => {
                _push2(`<option${ssrRenderAttr("value", role)} data-v-a954a83d${ssrIncludeBooleanAttr(Array.isArray(unref(form).role) ? ssrLooseContain(unref(form).role, role) : ssrLooseEqual(unref(form).role, role)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(role.toUpperCase())}</option>`);
              });
              _push2(`<!--]--></select>`);
              if (unref(form).errors.role) {
                _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-a954a83d${_scopeId}>${ssrInterpolate(unref(form).errors.role)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
              if (unref(form).role === "auditee") {
                _push2(`<div class="p-6 bg-slate-50 dark:bg-slate-800/50 rounded-3xl border border-slate-200 dark:border-slate-700 space-y-4" data-v-a954a83d${_scopeId}><div class="flex items-center gap-2" data-v-a954a83d${_scopeId}>`);
                _push2(ssrRenderComponent(_component_icon, {
                  icon: "fa-solid fa-building-user",
                  class: "text-rose-500"
                }, null, _parent2, _scopeId));
                _push2(`<span class="text-[10px] font-black text-slate-400 uppercase tracking-widest" data-v-a954a83d${_scopeId}>Penempatan Unit Kerja</span></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-a954a83d${_scopeId}><div class="space-y-2" data-v-a954a83d${_scopeId}><label class="text-[10px] font-bold text-slate-500 uppercase" data-v-a954a83d${_scopeId}>Program Studi</label><select class="w-full px-4 py-2.5 text-xs font-bold border-none ring-1 ring-slate-200 dark:ring-slate-700 rounded-xl bg-white dark:bg-slate-900 outline-none focus:ring-2 focus:ring-rose-500" data-v-a954a83d${_scopeId}><option${ssrRenderAttr("value", null)} data-v-a954a83d${ssrIncludeBooleanAttr(Array.isArray(unref(form).prodi_id) ? ssrLooseContain(unref(form).prodi_id, null) : ssrLooseEqual(unref(form).prodi_id, null)) ? " selected" : ""}${_scopeId}>Tidak Ada</option><!--[-->`);
                ssrRenderList(__props.prodis, (prodi) => {
                  _push2(`<option${ssrRenderAttr("value", prodi.id)} data-v-a954a83d${ssrIncludeBooleanAttr(Array.isArray(unref(form).prodi_id) ? ssrLooseContain(unref(form).prodi_id, prodi.id) : ssrLooseEqual(unref(form).prodi_id, prodi.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(prodi.name)}</option>`);
                });
                _push2(`<!--]--></select>`);
                if (unref(form).errors.prodi_id) {
                  _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-a954a83d${_scopeId}>${ssrInterpolate(unref(form).errors.prodi_id)}</p>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div><div class="space-y-2" data-v-a954a83d${_scopeId}><label class="text-[10px] font-bold text-slate-500 uppercase" data-v-a954a83d${_scopeId}>Fakultas</label><select class="w-full px-4 py-2.5 text-xs font-bold border-none ring-1 ring-slate-200 dark:ring-slate-700 rounded-xl bg-white dark:bg-slate-900 outline-none focus:ring-2 focus:ring-rose-500" data-v-a954a83d${_scopeId}><option${ssrRenderAttr("value", null)} data-v-a954a83d${ssrIncludeBooleanAttr(Array.isArray(unref(form).faculty_id) ? ssrLooseContain(unref(form).faculty_id, null) : ssrLooseEqual(unref(form).faculty_id, null)) ? " selected" : ""}${_scopeId}>Tidak Ada</option><!--[-->`);
                ssrRenderList(__props.faculties, (fac) => {
                  _push2(`<option${ssrRenderAttr("value", fac.id)} data-v-a954a83d${ssrIncludeBooleanAttr(Array.isArray(unref(form).faculty_id) ? ssrLooseContain(unref(form).faculty_id, fac.id) : ssrLooseEqual(unref(form).faculty_id, fac.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(fac.name)}</option>`);
                });
                _push2(`<!--]--></select>`);
                if (unref(form).errors.faculty_id) {
                  _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-a954a83d${_scopeId}>${ssrInterpolate(unref(form).errors.faculty_id)}</p>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div><p class="text-[10px] text-rose-500 font-bold italic leading-tight" data-v-a954a83d${_scopeId}>* Pilih unit yang sesuai dengan cakupan audit pengguna ini.</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="pt-4 border-t border-slate-100 dark:border-slate-800" data-v-a954a83d${_scopeId}><button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="w-full py-4 bg-slate-900 dark:bg-rose-600 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl shadow-xl shadow-slate-900/10 dark:shadow-rose-600/20 transition-all hover:bg-rose-600 dark:hover:bg-rose-500 hover:-translate-y-0.5 active:scale-95 disabled:opacity-50" data-v-a954a83d${_scopeId}>${ssrInterpolate(unref(form).processing ? "Menyimpan..." : editMode.value ? "Simpan Perubahan" : "Buat User Baru")}</button></div></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
                    ...
                    createVNode("table", { class: "w-full text-left border-collapse min-w-[1000px] lg:min-w-full" }, [
                      createVNode("thead", null, [
                        createVNode("tr", { class: "bg-slate-50/80 dark:bg-slate-800/20 text-[10px] font-black uppercase text-slate-400 dark:text-slate-500 tracking-[0.2em] sticky top-0 z-20 border-b border-slate-100 dark:border-slate-800/50" }, [
                          ...
                          createVNode("th", { class: "p-6 md:p-8 pl-8" }, "Pengguna"),
                          createVNode("th", { class: "p-6 md:p-8" }, "Role"),
                          createVNode("th", { class: "p-6 md:p-8" }, "Unit Kerja"),
                          createVNode("th", { class: "p-6 md:p-8 text-center" }, "2FA"),
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a954a83d"]]);
export {
  Index as default
};
