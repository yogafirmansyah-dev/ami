import { ref, watch, resolveComponent, mergeProps, withCtx, unref, createVNode, createBlock, createCommentVNode, withDirectives, vModelText, vModelSelect, createTextVNode, openBlock, Fragment, renderList, toDisplayString, withModifiers, vModelCheckbox, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AppLayout, mergeProps({ title: "Master Periode AMI" }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-6" data-v-18ffd691${_scopeId}><div class="flex flex-col lg:flex-row justify-between items-center gap-6" data-v-18ffd691${_scopeId}><div class="flex items-stretch gap-3 w-full max-w-2xl" data-v-18ffd691${_scopeId}><div class="relative flex-1 group" data-v-18ffd691${_scopeId}><span class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none" data-v-18ffd691${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-magnifying-glass",
              class: "text-slate-400 text-xs group-focus-within:text-rose-500 transition-colors"
            }, null, _parent2, _scopeId));
            _push2(`</span><input${ssrRenderAttr("value", search.value)} type="text" placeholder="Cari periode..." class="w-full pl-11 pr-4 py-4 bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder:text-slate-400/50 font-bold text-xs rounded-2xl border-none outline-none focus:outline-none ring-1 ring-slate-200 dark:ring-slate-800 dark:focus:ring-rose-500/50 focus:ring-4 focus:ring-rose-500/50 shadow-sm focus:shadow-md transition-[ring,background-color,box-shadow] duration-300 ease-out focus:bg-slate-50 dark:focus:bg-slate-800/80" data-v-18ffd691${_scopeId}></div><div class="flex items-center bg-white dark:bg-slate-900 rounded-2xl px-4 ring-1 ring-slate-200 dark:ring-slate-800 shadow-sm hover:ring-rose-500/50 dark:hover:ring-rose-500/50 transition-all duration-300" data-v-18ffd691${_scopeId}><span class="hidden sm:inline text-[9px] font-black uppercase text-slate-400 px-2 border-r border-slate-200 dark:border-slate-800 mr-2" data-v-18ffd691${_scopeId}>Tampilkan</span><select class="bg-transparent dark:bg-slate-900 border-none focus:ring-0 text-xs font-black text-slate-900 dark:text-white py-4 pr-8 cursor-pointer hover:text-rose-500 dark:hover:text-rose-500 transition-colors duration-300 outline-none" data-v-18ffd691${_scopeId}><option${ssrRenderAttr("value", 10)} data-v-18ffd691${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 10) : ssrLooseEqual(perPage.value, 10)) ? " selected" : ""}${_scopeId}>10</option><option${ssrRenderAttr("value", 25)} data-v-18ffd691${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 25) : ssrLooseEqual(perPage.value, 25)) ? " selected" : ""}${_scopeId}>25</option><option${ssrRenderAttr("value", 50)} data-v-18ffd691${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 50) : ssrLooseEqual(perPage.value, 50)) ? " selected" : ""}${_scopeId}>50</option><option${ssrRenderAttr("value", 100)} data-v-18ffd691${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 100) : ssrLooseEqual(perPage.value, 100)) ? " selected" : ""}${_scopeId}>100</option></select></div></div><div class="flex items-center gap-3" data-v-18ffd691${_scopeId}></div></div><div class="bg-white/60 dark:bg-slate-900 backdrop-blur-3xl rounded-[2.5rem] border border-white/40 dark:border-white/5 shadow-sm overflow-hidden" data-v-18ffd691${_scopeId}><div class="overflow-x-auto custom-scrollbar" data-v-18ffd691${_scopeId}><table class="w-full text-left border-collapse min-w-[1000px] lg:min-w-full" data-v-18ffd691${_scopeId}><thead data-v-18ffd691${_scopeId}><tr class="bg-slate-50/80 dark:bg-slate-800/20 text-[10px] font-black uppercase text-slate-400 dark:text-slate-500 tracking-[0.2em] sticky top-0 z-20 border-b border-slate-100 dark:border-slate-800/50" data-v-18ffd691${_scopeId}><th class="p-6 md:p-8 pl-8 text-center" data-v-18ffd691${_scopeId}>No</th><th class="p-6 md:p-8 pl-8 cursor-pointer hover:text-rose-500 transition-colors group select-none" data-v-18ffd691${_scopeId}><div class="flex items-center gap-2" data-v-18ffd691${_scopeId}> Nama Periode <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-18ffd691${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
            ...
            _push2(`</div></div></th><th class="p-6 md:p-8 text-center cursor-pointer hover:text-rose-500 transition-colors group select-none" data-v-18ffd691${_scopeId}><div class="flex items-center justify-center gap-2" data-v-18ffd691${_scopeId}> Fase Aktif <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-18ffd691${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-caret-up",
            ...
            _push2(`</div></div></th><th class="p-6 md:p-8 text-center" data-v-18ffd691${_scopeId}>Timeline Visual</th><th class="p-6 md:p-8 text-center min-w-28" data-v-18ffd691${_scopeId}>Aksi</th></tr></thead><tbody class="divide-y divide-slate-50 dark:divide-slate-800/20" data-v-18ffd691${_scopeId}><!--[-->`);
            ssrRenderList(__props.periods.data, (item) => {
              _push2(`<tr class="group hover:bg-white/50 dark:hover:bg-white/[0.02] transition-colors duration-300" data-v-18ffd691${_scopeId}><td class="p-6 md:p-8 pl-8 text-center" data-v-18ffd691${_scopeId}><span class="font-mono text-sm font-black text-rose-500 bg-rose-50 dark:bg-rose-500/10 px-2 py-1 rounded-md border border-rose-100 dark:border-rose-500/20" data-v-18ffd691${_scopeId}>${ssrInterpolate(__props.periods.from + __props.periods.data.indexOf(item))}</span></td><td class="p-6 md:p-8 pl-8" data-v-18ffd691${_scopeId}><div class="font-black text-slate-800 dark:text-slate-200 uppercase tracking-tight" data-v-18ffd691${_scopeId}>${ssrInterpolate(item.name)}</div>`);
              if (item.is_active) {
                _push2(`<div class="mt-1 flex items-center text-[9px] text-emerald-500 font-black uppercase" data-v-18ffd691${_scopeId}><span class="w-1.5 h-1.5 rounded-full bg-emerald-500 mr-1.5 animate-pulse" data-v-18ffd691${_scopeId}></span> Siklus Aktif </div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</td><td class="p-6 md:p-8 text-center" data-v-18ffd691${_scopeId}><div class="${ssrRenderClass(["px-3 py-1 rounded-lg text-[9px] font-black uppercase inline-block border shadow-sm", getStatusTimeline(item).type === "active" ? "bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 border-emerald-100 dark:border-emerald-500/20" : "bg-slate-50 dark:bg-slate-800 text-slate-400 border-slate-100 dark:border-slate-700"])}" data-v-18ffd691${_scopeId}>${ssrInterpolate(getStatusTimeline(item).label)}</div></td><td class="p-6 md:p-8" data-v-18ffd691${_scopeId}><div class="flex items-center justify-between gap-1 max-w-md mx-auto relative px-2 py-2" data-v-18ffd691${_scopeId}><div class="absolute top-1/2 left-4 right-4 h-0.5 bg-slate-100 dark:bg-slate-800 -translate-y-2" data-v-18ffd691${_scopeId}></div><!--[-->`);
              ssrRenderList([
                ...
                _push2(`<div class="flex-1 flex flex-col items-center group/stage relative z-10 hover:z-50 transition-all" data-v-18ffd691${_scopeId}><div class="${ssrRenderClass(["w-3 h-3 rounded-full mb-1 border-2 transition-all", getStatusTimeline(item).key === stage.key ? "bg-" + stage.color + "-500 border-white scale-150 shadow-md ring-2 ring-" + stage.color + "-200" : "bg-slate-200 border-white dark:bg-slate-700 dark:border-slate-800"])}" data-v-18ffd691${_scopeId}></div><div class="${ssrRenderClass(["text-[8px] font-black", getStatusTimeline(item).key === stage.key ? "text-" + stage.color + "-600" : "text-slate-300"])}" data-v-18ffd691${_scopeId}>${ssrInterpolate(stage.label)}</div><div class="absolute -top-16 scale-0 group-hover/stage:scale-100 transition-all bg-slate-900 text-white text-[9px] py-1.5 px-3 rounded-xl whitespace-nowrap shadow-xl font-bold border border-slate-800 pointer-events-none text-center z-[60]" data-v-18ffd691${_scopeId}><div class="mb-1 text-[8px] uppercase tracking-wider text-slate-400 border-b border-slate-700 pb-1" data-v-18ffd691${_scopeId}>${ssrInterpolate(stage.fullName)}</div> ${ssrInterpolate(formatDate(stage.start))} — ${ssrInterpolate(formatDate(stage.end))} <div class="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-slate-900 rotate-45 border-r border-b border-slate-800" data-v-18ffd691${_scopeId}></div></div></div>`);
              });
              _push2(`<!--]--></div></td><td class="p-6 md:p-8" data-v-18ffd691${_scopeId}><div class="flex justify-center gap-2" data-v-18ffd691${_scopeId}><button class="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 hover:text-blue-600 rounded-xl transition-all shadow-sm hover:shadow-md hover:border-blue-200 active:scale-95" data-v-18ffd691${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-pencil",
                class: "text-[10px]"
              }, null, _parent2, _scopeId));
              _push2(`</button><button class="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 hover:text-rose-600 rounded-xl transition-all shadow-sm hover:shadow-md hover:border-rose-200 active:scale-95" data-v-18ffd691${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
            ...
            if (__props.periods.data.length === 0) {
              _push2(`<tr data-v-18ffd691${_scopeId}><td colspan="4" class="p-12 text-center" data-v-18ffd691${_scopeId}><div class="flex flex-col items-center justify-center opacity-50" data-v-18ffd691${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-clock-rotate-left",
                class: "text-4xl text-slate-300 dark:text-slate-600 mb-4"
              }, null, _parent2, _scopeId));
              _push2(`<p class="text-xs font-black text-slate-400 uppercase tracking-widest italic" data-v-18ffd691${_scopeId}> Data periode tidak ditemukan</p></div></td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tbody></table></div><div class="flex flex-col md:flex-row items-center justify-between gap-4 px-6 md:px-8 py-6 border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-800/20 backdrop-blur-sm" data-v-18ffd691${_scopeId}><div class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest italic text-center md:text-left" data-v-18ffd691${_scopeId}> Data ${ssrInterpolate(__props.periods.from)} - ${ssrInterpolate(__props.periods.to)} dari total ${ssrInterpolate(__props.periods.total)}</div><div class="flex flex-wrap justify-center gap-1.5" data-v-18ffd691${_scopeId}><!--[-->`);
            ssrRenderList(__props.periods.links, (link, k) => {
              ...
              if (link.url) {
                ...
                ])}" data-v-18ffd691${_scopeId}>${link.label ?? ""}</span>`);
              }
              _push2(`<!--]-->`);
            });
            _push2(`<!--]--></div></div></div></div>`);
            if (showModal.value) {
              _push2(`<div class="fixed inset-0 z-50 flex items-center justify-center p-4" data-v-18ffd691${_scopeId}><div class="fixed inset-0 bg-slate-900/80 backdrop-blur-md transition-opacity" data-v-18ffd691${_scopeId}></div><div class="relative bg-white dark:bg-slate-900 w-full max-w-4xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 border border-white/10 flex flex-col max-h-[90vh]" data-v-18ffd691${_scopeId}><div class="p-8 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 flex justify-between items-center shrink-0" data-v-18ffd691${_scopeId}><div data-v-18ffd691${_scopeId}><h3 class="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tighter italic" data-v-18ffd691${_scopeId}>${ssrInterpolate(editMode.value ? "Edit Timeline" : "Siklus Baru")}</h3><p class="text-[10px] font-bold text-rose-500 uppercase tracking-widest mt-1" data-v-18ffd691${_scopeId}> Manajemen Siklus Audit </p></div><button class="w-8 h-8 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 text-slate-400 hover:text-rose-600 transition-colors font-bold text-lg" data-v-18ffd691${_scopeId}>×</button></div><form class="p-8 space-y-8 overflow-y-auto custom-scrollbar flex-1" data-v-18ffd691${_scopeId}><div class="space-y-2" data-v-18ffd691${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-18ffd691${_scopeId}>Nama Periode</label><input${ssrRenderAttr("value", unref(form).name)} type="text" class="w-full px-5 py-3.5 bg-white dark:bg-slate-900 border-none rounded-2xl text-xs font-bold text-slate-900 dark:text-white ring-1 ring-slate-200 dark:ring-slate-800 focus:ring-2 focus:ring-rose-500 transition-all shadow-sm" required data-v-18ffd691${_scopeId}>`);
              if (unref(form).errors.name) {
                _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-18ffd691${_scopeId}>${ssrInterpolate(unref(form).errors.name)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-18ffd691${_scopeId}><!--[-->`);
              ssrRenderList([
                ...
                _push2(`<div class="${ssrRenderClass(["p-6 bg-slate-50 dark:bg-slate-800/50 rounded-3xl border-l-4 shadow-sm text-slate-700 dark:text-slate-200 transition-all hover:translate-x-1", "border-" + stage.color + "-500"])}" data-v-18ffd691${_scopeId}><h4 class="${ssrRenderClass(["text-[10px] font-black uppercase mb-4 tracking-widest", "text-" + stage.color + "-600"])}" data-v-18ffd691${_scopeId}>${ssrInterpolate(stage.label)}</h4><div class="grid grid-cols-2 gap-4" data-v-18ffd691${_scopeId}><div data-v-18ffd691${_scopeId}><label class="text-[9px] font-black text-slate-400 block mb-1 uppercase ml-1" data-v-18ffd691${_scopeId}>Mulai</label><input type="date"${ssrRenderAttr("value", unref(form)[stage.start])} class="w-full px-3 py-2 bg-white dark:bg-slate-900 border-none rounded-xl text-xs font-bold shadow-sm ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-rose-500/50 outline-none" required data-v-18ffd691${_scopeId}>`);
                if (unref(form).errors[stage.start]) {
                  _push2(`<p class="text-[9px] text-rose-500 font-bold mt-1" data-v-18ffd691${_scopeId}>${ssrInterpolate(unref(form).errors[stage.start])}</p>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div><div data-v-18ffd691${_scopeId}><label class="text-[9px] font-black text-slate-400 block mb-1 uppercase ml-1" data-v-18ffd691${_scopeId}>Selesai</label><input type="date"${ssrRenderAttr("value", unref(form)[stage.end])} class="w-full px-3 py-2 bg-white dark:bg-slate-900 border-none rounded-xl text-xs font-bold shadow-sm ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-rose-500/50 outline-none" required data-v-18ffd691${_scopeId}>`);
                if (unref(form).errors[stage.end]) {
                  _push2(`<p class="text-[9px] text-rose-500 font-bold mt-1" data-v-18ffd691${_scopeId}>${ssrInterpolate(unref(form).errors[stage.end])}</p>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div></div>`);
              });
              _push2(`<!--]--><div class="md:col-span-2 p-6 bg-slate-50 dark:bg-slate-800/50 rounded-3xl border-l-4 border-rose-500 shadow-sm text-slate-700 dark:text-slate-200 transition-all hover:translate-x-1" data-v-18ffd691${_scopeId}><h4 class="text-[10px] font-black text-rose-600 uppercase mb-4 tracking-widest" data-v-18ffd691${_scopeId}>5. RTM &amp; Rencana Tindak Lanjut</h4><div class="grid grid-cols-2 md:grid-cols-4 gap-4" data-v-18ffd691${_scopeId}><div class="md:col-span-2" data-v-18ffd691${_scopeId}><label class="text-[9px] font-black text-slate-400 block mb-1 uppercase ml-1" data-v-18ffd691${_scopeId}>Mulai</label><input type="date"${ssrRenderAttr("value", unref(form).rtm_rtl_start)} class="w-full px-3 py-2 bg-white dark:bg-slate-900 border-none rounded-xl text-xs font-bold shadow-sm ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-rose-500/50 outline-none" required data-v-18ffd691${_scopeId}>`);
              if (unref(form).errors.rtm_rtl_start) {
                _push2(`<p class="text-[9px] text-rose-500 font-bold mt-1" data-v-18ffd691${_scopeId}>${ssrInterpolate(unref(form).errors.rtm_rtl_start)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="md:col-span-2" data-v-18ffd691${_scopeId}><label class="text-[9px] font-black text-slate-400 block mb-1 uppercase ml-1" data-v-18ffd691${_scopeId}>Selesai</label><input type="date"${ssrRenderAttr("value", unref(form).rtm_rtl_end)} class="w-full px-3 py-2 bg-white dark:bg-slate-900 border-none rounded-xl text-xs font-bold shadow-sm ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-rose-500/50 outline-none" required data-v-18ffd691${_scopeId}>`);
              if (unref(form).errors.rtm_rtl_end) {
                _push2(`<p class="text-[9px] text-rose-500 font-bold mt-1" data-v-18ffd691${_scopeId}>${ssrInterpolate(unref(form).errors.rtm_rtl_end)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div></div></div><label class="flex items-center gap-4 p-5 bg-rose-50 dark:bg-rose-500/10 rounded-2xl cursor-pointer hover:bg-rose-100 dark:hover:bg-rose-500/20 transition-all border border-rose-100 dark:border-rose-500/20" data-v-18ffd691${_scopeId}><div class="relative flex items-center" data-v-18ffd691${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(form).is_active) ? ssrLooseContain(unref(form).is_active, null) : unref(form).is_active) ? " checked" : ""} class="peer h-5 w-5 cursor-pointer appearance-none rounded-md border border-slate-300 dark:border-slate-600 checked:bg-rose-500 checked:border-rose-500 transition-all" data-v-18ffd691${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-18ffd691"]]);
export {
  Index as default
};
