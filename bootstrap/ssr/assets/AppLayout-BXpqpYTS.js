...
import { a as appConf, _ as __variableDynamicImportRuntimeHelper, b as bgColorStyles, r as radiusSizeMixin, c as badgeConf, t as topBarConf, T as TAlert, w as windowSizeCalculator, f as footerConf } from "./windowSizeCalculator-Ch6zBFfA.js";
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./MainMenu/Abay/MainMenu.vue": () => import("./MainMenu-CbdKVaC5.js"), "./MainMenu/Umay/MainMenu.vue": () => import("./MainMenu-d5XMRC-R.js") }), `./MainMenu/${menuDesign.value}/MainMenu.vue`, 4).then((module) => {
