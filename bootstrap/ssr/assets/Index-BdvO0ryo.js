    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AppLayout, mergeProps({
        ...
        subHeader: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center gap-2 mt-1" data-v-5c99ed01${_scopeId}><span class="text-slate-400 dark:text-slate-500 text-xs font-bold uppercase tracking-wider" data-v-5c99ed01${_scopeId}>Standar:</span><span class="font-black text-rose-600 dark:text-rose-500 text-sm uppercase tracking-tight" data-v-5c99ed01${_scopeId}>${ssrInterpolate(__props.standard.name)}</span><span class="text-slate-300 dark:text-slate-600 mx-1" data-v-5c99ed01${_scopeId}>|</span><span class="${ssrRenderClass([
            ...
            ])}" data-v-5c99ed01${_scopeId}>${ssrInterpolate(__props.standard.target_type === "prodi" ? "Program Studi" : "Fakultas")}</span></div>`);
          } else {
            return [
        ...
        "action-buttons": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex gap-3" data-v-5c99ed01${_scopeId}>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-6" data-v-5c99ed01${_scopeId}><div class="flex flex-col lg:flex-row justify-between items-center gap-6" data-v-5c99ed01${_scopeId}><div class="flex items-stretch gap-3 w-full max-w-2xl" data-v-5c99ed01${_scopeId}><div class="relative flex-1 group" data-v-5c99ed01${_scopeId}><span class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none" data-v-5c99ed01${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-magnifying-glass",
              class: "text-slate-400 text-xs group-focus-within:text-rose-500 transition-colors"
            }, null, _parent2, _scopeId));
            _push2(`</span><input${ssrRenderAttr("value", search.value)} type="text" placeholder="Cari kode atau pernyataan..." class="w-full pl-11 pr-4 py-4 bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder:text-slate-400/50 font-bold text-xs rounded-2xl border-none outline-none focus:outline-none ring-1 ring-slate-200 dark:ring-slate-800 dark:focus:ring-rose-500/50 focus:ring-4 focus:ring-rose-500/50 shadow-sm focus:shadow-md transition-[ring,background-color,box-shadow] duration-300 ease-out focus:bg-slate-50 dark:focus:bg-slate-800/80" data-v-5c99ed01${_scopeId}></div><div class="flex items-center bg-white dark:bg-slate-900 rounded-2xl px-4 ring-1 ring-slate-200 dark:ring-slate-800 shadow-sm hover:ring-rose-500/50 dark:hover:ring-rose-500/50 transition-all duration-300" data-v-5c99ed01${_scopeId}><span class="hidden sm:inline text-[9px] font-black uppercase text-slate-400 px-2 border-r border-slate-200 dark:border-slate-800 mr-2" data-v-5c99ed01${_scopeId}>Tampilkan</span><select class="bg-transparent dark:bg-slate-900 border-none focus:ring-0 text-xs font-black text-slate-900 dark:text-white py-4 pr-8 cursor-pointer hover:text-rose-500 dark:hover:text-rose-500 transition-colors duration-300 outline-none" data-v-5c99ed01${_scopeId}><option${ssrRenderAttr("value", 10)} data-v-5c99ed01${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 10) : ssrLooseEqual(perPage.value, 10)) ? " selected" : ""}${_scopeId}>10</option><option${ssrRenderAttr("value", 25)} data-v-5c99ed01${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 25) : ssrLooseEqual(perPage.value, 25)) ? " selected" : ""}${_scopeId}>25</option><option${ssrRenderAttr("value", 50)} data-v-5c99ed01${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 50) : ssrLooseEqual(perPage.value, 50)) ? " selected" : ""}${_scopeId}>50</option><option${ssrRenderAttr("value", 100)} data-v-5c99ed01${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 100) : ssrLooseEqual(perPage.value, 100)) ? " selected" : ""}${_scopeId}>100</option></select></div></div><div class="flex items-center gap-3" data-v-5c99ed01${_scopeId}></div></div><div class="bg-white/60 dark:bg-slate-900 backdrop-blur-3xl rounded-[2.5rem] border border-white/40 dark:border-white/5 shadow-sm overflow-hidden" data-v-5c99ed01${_scopeId}><div class="overflow-x-auto custom-scrollbar" data-v-5c99ed01${_scopeId}><table class="w-full text-left border-collapse min-w-[1000px] lg:min-w-full" data-v-5c99ed01${_scopeId}><thead data-v-5c99ed01${_scopeId}><tr class="bg-slate-50/80 dark:bg-slate-800/20 text-[10px] font-black uppercase text-slate-400 dark:text-slate-500 tracking-[0.2em] sticky top-0 z-20 border-b border-slate-100 dark:border-slate-800/50" data-v-5c99ed01${_scopeId}><th class="p-6 md:p-8 pl-8 min-w-24" data-v-5c99ed01${_scopeId}>No</th><th class="p-6 md:p-8 pl-8 min-w-24" data-v-5c99ed01${_scopeId}>Kode</th><th class="p-6 md:p-8" data-v-5c99ed01${_scopeId}>Pernyataan Standar / Indikator</th><th class="p-6 md:p-8 text-center min-w-28" data-v-5c99ed01${_scopeId}>Target</th><th class="p-6 md:p-8 min-w-32" data-v-5c99ed01${_scopeId}>Bukti</th><th class="p-6 md:p-8 text-center min-w-24" data-v-5c99ed01${_scopeId}>Template</th><th class="p-6 md:p-8 text-center min-w-24" data-v-5c99ed01${_scopeId}>Wajib</th><th class="p-6 md:p-8 pr-8 text-center min-w-24" data-v-5c99ed01${_scopeId}>Aksi</th></tr></thead><tbody class="divide-y divide-slate-50 dark:divide-slate-800/20" data-v-5c99ed01${_scopeId}><!--[-->`);
            ssrRenderList(__props.indicators.data, (item) => {
              _push2(`<tr class="group hover:bg-white/50 dark:hover:bg-white/[0.02] transition-colors duration-300 align-top" data-v-5c99ed01${_scopeId}><td class="p-6 md:p-8 pl-8" data-v-5c99ed01${_scopeId}><span class="font-mono text-sm font-black text-rose-500 bg-rose-50 dark:bg-rose-500/10 px-2 py-1 rounded-md border border-rose-100 dark:border-rose-500/20" data-v-5c99ed01${_scopeId}>${ssrInterpolate(__props.indicators.from + __props.indicators.data.indexOf(item))}</span></td><td class="p-6 md:p-8 pl-8" data-v-5c99ed01${_scopeId}><span class="font-mono text-[10px] font-black text-rose-500 bg-rose-50 dark:bg-rose-500/10 px-2 py-1 rounded-md border border-rose-100 dark:border-rose-500/20" data-v-5c99ed01${_scopeId}>${ssrInterpolate(item.code)}</span></td><td class="p-6 md:p-8" data-v-5c99ed01${_scopeId}><div class="text-sm font-medium text-slate-700 dark:text-slate-200 leading-relaxed max-w-3xl" data-v-5c99ed01${_scopeId}>${ssrInterpolate(item.requirement)}</div></td><td class="p-6 md:p-8 text-center" data-v-5c99ed01${_scopeId}><span class="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-tight" data-v-5c99ed01${_scopeId}>${ssrInterpolate(item.target || "-")}</span></td><td class="p-6 md:p-8" data-v-5c99ed01${_scopeId}><div class="text-sm font-medium text-slate-700 dark:text-slate-200 leading-relaxed max-w-3xl" data-v-5c99ed01${_scopeId}>${ssrInterpolate(item.evidence_needed || "-")}</div></td><td class="p-6 md:p-8 text-center" data-v-5c99ed01${_scopeId}>`);
              if (item.template_path) {
                _push2(`<a${ssrRenderAttr("href", _ctx.route("admin.indicators.show-template", item.id))} target="_blank" class="inline-flex items-center gap-1 text-[9px] font-black uppercase tracking-wider text-blue-600 hover:text-blue-700 hover:underline" data-v-5c99ed01${_scopeId}>`);
                _push2(ssrRenderComponent(_component_icon, { icon: "fa-solid fa-file-arrow-down" }, null, _parent2, _scopeId));
                _push2(` Template </a>`);
              } else {
                _push2(`<span class="text-slate-300 text-xs" data-v-5c99ed01${_scopeId}>-</span>`);
              }
              _push2(`</td><td class="p-6 md:p-8 text-center" data-v-5c99ed01${_scopeId}><span class="${ssrRenderClass([
              ...
              ])}" data-v-5c99ed01${_scopeId}>${ssrInterpolate(item.is_evidence_required ? "Ya" : "Opsional")}</span></td><td class="p-6 md:p-8 pr-8" data-v-5c99ed01${_scopeId}><div class="flex justify-center gap-2" data-v-5c99ed01${_scopeId}><button class="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 hover:text-blue-600 rounded-xl transition-all shadow-sm hover:shadow-md hover:border-blue-200 active:scale-95" data-v-5c99ed01${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-pencil",
                class: "text-[10px]"
              }, null, _parent2, _scopeId));
              _push2(`</button><button class="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 hover:text-rose-600 rounded-xl transition-all shadow-sm hover:shadow-md hover:border-rose-200 active:scale-95" data-v-5c99ed01${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
            ...
            if (__props.indicators.data.length === 0) {
              _push2(`<tr data-v-5c99ed01${_scopeId}><td colspan="8" class="p-12 text-center" data-v-5c99ed01${_scopeId}><div class="flex flex-col items-center justify-center opacity-50" data-v-5c99ed01${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-clipboard-list",
                class: "text-4xl text-slate-300 dark:text-slate-600 mb-4"
              }, null, _parent2, _scopeId));
              _push2(`<p class="text-xs font-black text-slate-400 uppercase tracking-widest italic" data-v-5c99ed01${_scopeId}> Belum ada indikator mutu</p></div></td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tbody></table></div><div class="flex flex-col md:flex-row items-center justify-between gap-4 px-6 md:px-8 py-6 border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-800/20 backdrop-blur-sm" data-v-5c99ed01${_scopeId}><div class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest italic text-center md:text-left" data-v-5c99ed01${_scopeId}> Menampilkan ${ssrInterpolate(__props.indicators.from)} - ${ssrInterpolate(__props.indicators.to)} dari ${ssrInterpolate(__props.indicators.total)} indikator </div><div class="flex flex-wrap justify-center gap-1.5" data-v-5c99ed01${_scopeId}><!--[-->`);
            ...
            if (showModal.value) {
              _push2(`<div class="fixed inset-0 z-50 flex items-center justify-center p-4" data-v-5c99ed01${_scopeId}><div class="fixed inset-0 bg-slate-900/80 backdrop-blur-md transition-opacity" data-v-5c99ed01${_scopeId}></div><div class="relative bg-white dark:bg-slate-900 w-full max-w-2xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 border border-white/10 flex flex-col max-h-[85vh]" data-v-5c99ed01${_scopeId}><div class="p-8 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 flex justify-between items-center shrink-0" data-v-5c99ed01${_scopeId}><div data-v-5c99ed01${_scopeId}><h3 class="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tighter italic" data-v-5c99ed01${_scopeId}>${ssrInterpolate(editMode.value ? "Edit Indikator" : "Indikator Baru")}</h3><p class="text-[10px] font-bold text-rose-500 uppercase tracking-widest mt-1" data-v-5c99ed01${_scopeId}>${ssrInterpolate(__props.standard.name)}</p></div><button class="w-8 h-8 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 text-slate-400 hover:text-rose-600 transition-colors font-bold text-lg" data-v-5c99ed01${_scopeId}>×</button></div><form class="p-8 space-y-6 overflow-y-auto custom-scrollbar flex-1" data-v-5c99ed01${_scopeId}><div class="space-y-2" data-v-5c99ed01${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-5c99ed01${_scopeId}>Pernyataan Standar / Indikator</label><textarea name="requirement" rows="3" placeholder="Masukkan standar atau indikator mutu" class="w-full px-5 py-3.5 bg-white dark:bg-slate-900 border-none rounded-2xl text-xs font-bold text-slate-900 dark:text-white ring-1 ring-slate-200 dark:ring-slate-800 focus:ring-2 focus:ring-rose-500 transition-all shadow-sm" required data-v-5c99ed01${_scopeId}>${ssrInterpolate(unref(form).requirement)}</textarea>`);
              if (unref(form).errors.requirement) {
                _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-5c99ed01${_scopeId}>${ssrInterpolate(unref(form).errors.requirement)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="space-y-2" data-v-5c99ed01${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-5c99ed01${_scopeId}>Target Kinerja</label><input name="target"${ssrRenderAttr("value", unref(form).target)} type="text" placeholder="Contoh: 100%, Ada, 3 Dokumen" class="w-full px-5 py-3.5 bg-white dark:bg-slate-900 border-none rounded-2xl text-xs font-bold text-slate-900 dark:text-white ring-1 ring-slate-200 dark:ring-slate-800 focus:ring-2 focus:ring-rose-500 transition-all shadow-sm" data-v-5c99ed01${_scopeId}>`);
              if (unref(form).errors.target) {
                _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-5c99ed01${_scopeId}>${ssrInterpolate(unref(form).errors.target)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="space-y-2" data-v-5c99ed01${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-5c99ed01${_scopeId}>Bukti yang Diperiksa</label><textarea name="evidence_needed" rows="2" placeholder="Contoh: Dokumen kurikulum, SK Kaprodi, dll" class="w-full px-5 py-3.5 bg-white dark:bg-slate-900 border-none rounded-2xl text-xs font-bold text-slate-900 dark:text-white ring-1 ring-slate-200 dark:ring-slate-800 focus:ring-2 focus:ring-rose-500 transition-all shadow-sm" data-v-5c99ed01${_scopeId}>${ssrInterpolate(unref(form).evidence_needed)}</textarea>`);
              if (unref(form).errors.evidence_needed) {
                _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-5c99ed01${_scopeId}>${ssrInterpolate(unref(form).errors.evidence_needed)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-5c99ed01${_scopeId}><div class="space-y-2" data-v-5c99ed01${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-5c99ed01${_scopeId}>Wajib Bukti?</label><select name="is_evidence_required" class="w-full px-5 py-3.5 bg-white dark:bg-slate-900 border-none rounded-2xl text-xs font-bold text-slate-900 dark:text-white ring-1 ring-slate-200 dark:ring-slate-800 focus:ring-2 focus:ring-rose-500 transition-all shadow-sm" data-v-5c99ed01${_scopeId}><option${ssrRenderAttr("value", 1)} data-v-5c99ed01${ssrIncludeBooleanAttr(Array.isArray(unref(form).is_evidence_required) ? ssrLooseContain(unref(form).is_evidence_required, 1) : ssrLooseEqual(unref(form).is_evidence_required, 1)) ? " selected" : ""}${_scopeId}>Ya (Wajib Upload)</option><option${ssrRenderAttr("value", 0)} data-v-5c99ed01${ssrIncludeBooleanAttr(Array.isArray(unref(form).is_evidence_required) ? ssrLooseContain(unref(form).is_evidence_required, 0) : ssrLooseEqual(unref(form).is_evidence_required, 0)) ? " selected" : ""}${_scopeId}>Tidak (Opsional)</option></select>`);
              if (unref(form).errors.is_evidence_required) {
                _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-5c99ed01${_scopeId}>${ssrInterpolate(unref(form).errors.is_evidence_required)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="space-y-2" data-v-5c99ed01${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-5c99ed01${_scopeId}>Upload Template (Opsional)</label><input name="template" type="file" accept=".pdf,.docx,.xlsx" class="block w-full text-[10px] text-slate-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-[10px] file:font-black file:uppercase file:tracking-wider file:bg-slate-100 file:text-slate-700 hover:file:bg-slate-200 cursor-pointer border border-slate-200 dark:border-slate-700 rounded-2xl p-1.5" data-v-5c99ed01${_scopeId}>`);
              if (unref(form).errors.template) {
                _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-5c99ed01${_scopeId}>${ssrInterpolate(unref(form).errors.template)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div><div class="pt-4" data-v-5c99ed01${_scopeId}><button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="w-full py-4 bg-slate-900 dark:bg-rose-600 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl shadow-xl shadow-slate-900/10 dark:shadow-rose-600/20 transition-all hover:bg-rose-600 dark:hover:bg-rose-500 hover:-translate-y-0.5 active:scale-95 disabled:opacity-50" data-v-5c99ed01${_scopeId}>${ssrInterpolate(unref(form).processing ? "Menyimpan..." : editMode.value ? "Simpan Perubahan" : "Simpan Indikator")}</button></div></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5c99ed01"]]);
export {
  Index as default
};
