...
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500" }, _attrs))} data-v-5c9a5df5><div class="bg-white/60 dark:bg-slate-900 backdrop-blur-3xl rounded-[2.5rem] border border-white/40 dark:border-white/5 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md" data-v-5c9a5df5><div class="overflow-x-auto custom-scrollbar" data-v-5c9a5df5><table class="w-full text-left border-collapse min-w-[1100px] xl:min-w-full" data-v-5c9a5df5><thead data-v-5c9a5df5><tr class="bg-slate-50/80 dark:bg-slate-900/80 backdrop-blur-md text-[9px] font-black uppercase text-slate-400 dark:text-slate-500 tracking-[0.2em] sticky top-0 z-20 border-b border-slate-200/50 dark:border-slate-800" data-v-5c9a5df5><th class="p-6 text-center min-w-20" data-v-5c9a5df5>No</th><th class="p-6 text-center min-w-24" data-v-5c9a5df5>Kode</th><th class="p-6 min-w-[350px]" data-v-5c9a5df5>Indikator &amp; Kriteria</th><th class="p-6 min-w-[250px]" data-v-5c9a5df5>Bukti yang Diperiksa</th><th class="p-6 text-center w-32" data-v-5c9a5df5>Bukti</th><th class="p-6 text-center w-40" data-v-5c9a5df5>Hasil Audit</th><th class="p-6 min-w-[300px]" data-v-5c9a5df5>Catatan &amp; Rekomendasi</th><th class="p-6 text-center w-40 sticky right-0 bg-slate-50/80 dark:bg-slate-900/90 backdrop-blur-md z-30 shadow-none" data-v-5c9a5df5> Aksi</th></tr></thead><tbody class="divide-y divide-slate-100/50 dark:divide-slate-800/50" data-v-5c9a5df5><!--[-->`);
      ssrRenderList(__props.indicators.data, (item, index) => {
        _push(`<tr class="group hover:bg-slate-50/80 dark:hover:bg-slate-800/20 transition-all duration-200 align-top" data-v-5c9a5df5><td class="p-6 text-center" data-v-5c9a5df5><span class="${ssrRenderClass([
        ...
        ])}" data-v-5c9a5df5>${ssrInterpolate(__props.indicators.from + index)}</span></td><td class="p-6 text-center" data-v-5c9a5df5><span class="text-xs font-black text-slate-700 dark:text-slate-300 font-mono tracking-tighter bg-slate-100 dark:bg-slate-800 px-3 py-1 rounded-lg" data-v-5c9a5df5>${ssrInterpolate(item.snapshot_code)}</span></td><td class="p-6" data-v-5c9a5df5><p class="font-bold text-slate-800 dark:text-slate-200 text-sm italic leading-relaxed mb-2" data-v-5c9a5df5>${ssrInterpolate(item.snapshot_requirement)}</p><div class="flex items-center gap-2" data-v-5c9a5df5><span class="w-1.5 h-1.5 rounded-full bg-slate-300 dark:bg-slate-600" data-v-5c9a5df5></span><span class="text-[9px] font-black uppercase text-slate-400 tracking-wider" data-v-5c9a5df5>Kriteria Standar</span></div></td><td class="p-6" data-v-5c9a5df5><div class="p-5 bg-slate-50 dark:bg-slate-800/30 rounded-2xl border border-slate-100 dark:border-slate-800/50 group-hover:border-slate-200 dark:group-hover:border-slate-700 transition-colors" data-v-5c9a5df5><p class="text-xs text-slate-600 dark:text-slate-400 font-medium italic leading-relaxed" data-v-5c9a5df5>${ssrInterpolate(item.snapshot_evidence_needed)}</p>`);
        if (item.snapshot_template_path) {
          _push(`<div class="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700/50" data-v-5c9a5df5><a${ssrRenderAttr("href", _ctx.route("admin.indicators.show-assignment-template", item.id))} target="_blank" class="inline-flex items-center gap-2 text-[9px] font-black uppercase text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 transition-colors tracking-wider" data-v-5c9a5df5>`);
        ...
        if (!item.evidence_path && !item.evidence_url) {
          _push(`<span class="text-slate-300 dark:text-slate-600 font-black uppercase text-[8px] tracking-[0.2em] py-2" data-v-5c9a5df5>KOSONG</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></td><td class="p-6 text-center" data-v-5c9a5df5><div class="flex flex-col items-center gap-3" data-v-5c9a5df5><div class="${ssrRenderClass(["w-14 h-14 flex items-center justify-center rounded-[1.2rem] font-black text-xl border transition-all duration-300 transform group-hover:scale-110 group-hover:-rotate-3", getScoreColor(item.score)])}" data-v-5c9a5df5>${ssrInterpolate(item.score ?? "-")}</div>`);
        if (item.finding_type) {
          _push(`<span class="${ssrRenderClass(["px-3 py-1 rounded-lg text-[9px] font-black border tracking-widest uppercase shadow-sm", getFindingBadge(item.finding_type)])}" data-v-5c9a5df5>${ssrInterpolate(item.finding_type)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></td><td class="p-6" data-v-5c9a5df5><div class="space-y-3" data-v-5c9a5df5>`);
        if (item.auditor_note) {
          _push(`<div class="p-4 bg-amber-50/50 dark:bg-amber-900/10 border-l-[3px] border-amber-400 rounded-r-2xl hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-colors" data-v-5c9a5df5><p class="text-[8px] font-black text-amber-500 uppercase mb-1.5 tracking-widest flex items-center gap-1.5" data-v-5c9a5df5> ⚠️ Temuan </p><p class="text-xs text-slate-700 dark:text-slate-300 font-medium italic leading-relaxed" data-v-5c9a5df5> &quot;${ssrInterpolate(item.auditor_note)}&quot;</p></div>`);
        } else {
          _push(`<!---->`);
        }
        if (item.recommendation) {
          _push(`<div class="p-4 bg-emerald-50/50 dark:bg-emerald-900/10 border-l-[3px] border-emerald-400 rounded-r-2xl hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-colors" data-v-5c9a5df5><p class="text-[8px] font-black text-emerald-500 uppercase mb-1.5 tracking-widest flex items-center gap-1.5" data-v-5c9a5df5> 💡 Saran </p><p class="text-xs text-slate-700 dark:text-slate-300 font-medium italic leading-relaxed" data-v-5c9a5df5>${ssrInterpolate(item.recommendation)}</p></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></td><td class="p-6 text-center align-middle sticky right-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md z-10 group-hover:bg-slate-50/90 dark:group-hover:bg-slate-800/90 transition-colors shadow-[-10px_0_20px_-10px_rgba(0,0,0,0.05)]" data-v-5c9a5df5><div class="flex flex-row justify-center items-center gap-3 relative z-20" data-v-5c9a5df5>`);
        if (canUpload.value) {
          _push(`<button class="w-10 h-10 flex items-center justify-center bg-gradient-to-br from-sky-400 to-sky-600 text-white rounded-xl shadow-lg shadow-sky-500/20 hover:shadow-sky-500/40 hover:scale-110 active:scale-95 transition-all" title="Upload Bukti" data-v-5c9a5df5>`);
          _push(ssrRenderComponent(_component_icon, {
        ...
        if (canScore.value) {
          _push(`<button class="w-10 h-10 flex items-center justify-center bg-gradient-to-br from-slate-800 to-slate-900 dark:from-white dark:to-slate-200 text-white dark:text-slate-900 rounded-xl shadow-lg hover:shadow-xl hover:scale-110 active:scale-95 transition-all" title="Penilaian" data-v-5c9a5df5>`);
          _push(ssrRenderComponent(_component_icon, {
      ...
      _push(`<!--]--></tbody></table></div><div class="flex flex-col md:flex-row items-center justify-between gap-4 px-6 md:px-8 py-6 border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-800/20 backdrop-blur-sm" data-v-5c9a5df5><div class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest italic text-center md:text-left flex items-center gap-2" data-v-5c9a5df5><span class="${ssrRenderClass(["w-2 h-2 rounded-full animate-pulse", __props.role === "auditor" ? "bg-emerald-500" : "bg-sky-500"])}" data-v-5c9a5df5></span> Data ${ssrInterpolate(__props.indicators.from)} - ${ssrInterpolate(__props.indicators.to)} dari total ${ssrInterpolate(__props.indicators.total)}</div><div class="flex flex-wrap justify-center gap-2" data-v-5c9a5df5><!--[-->`);
      ssrRenderList(__props.indicators.links, (link, k) => {
        _push(ssrRenderComponent(unref(Link), {
          ...
          class: [
            ...
            link.active ? __props.role === "auditor" ? "bg-gradient-to-br from-emerald-600 to-emerald-700 text-white border-transparent shadow-lg shadow-emerald-600/30" : "bg-gradient-to-br from-sky-600 to-sky-700 text-white border-transparent shadow-lg shadow-sky-600/30" : "bg-white dark:bg-slate-900 text-slate-400 dark:text-slate-500 border-slate-200 dark:border-slate-800 hover:border-emerald-500 hover:text-emerald-500",
...
const ScoringView = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-5c9a5df5"]]);
const _sfc_main$3 = {
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_icon = resolveComponent("icon");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white/60 dark:bg-slate-900 backdrop-blur-3xl rounded-[3.5rem] border border-white/40 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-black/50 overflow-hidden animate-in fade-in zoom-in duration-500 hover:shadow-2xl transition-shadow" }, _attrs))} data-v-4fd30b52>`);
      if (localIndicators.value.length > 0) {
        _push(`<div class="overflow-x-auto custom-scrollbar" data-v-4fd30b52><table class="w-full text-left border-collapse min-w-[2000px]" data-v-4fd30b52><thead data-v-4fd30b52><tr class="bg-slate-900 dark:bg-black text-white text-[9px] font-black uppercase tracking-[0.2em]" data-v-4fd30b52><th class="p-8 w-80 border-r border-white/10 italic underline decoration-rose-500 decoration-2 underline-offset-8" data-v-4fd30b52> 1. Finding Detail</th><th class="p-8 w-80 border-r border-white/10 italic" data-v-4fd30b52>2. Root Cause (Auditee)</th><th class="p-8 w-80 border-r border-white/10 italic" data-v-4fd30b52>3. Corrective Action Plan</th><th class="p-8 w-56 border-r border-white/10 text-center italic" data-v-4fd30b52>4. PIC &amp; Deadline</th><th class="p-8 w-64 text-center italic border-r border-white/10" data-v-4fd30b52>5. Auditor Verification</th><th class="p-8 w-40 text-center italic sticky right-0 bg-slate-900 dark:bg-black z-20" data-v-4fd30b52>Action </th></tr></thead><tbody class="divide-y divide-slate-50 dark:divide-slate-800/50" data-v-4fd30b52><!--[-->`);
        ssrRenderList(localIndicators.value, (item) => {
          _push(`<tr class="align-top group hover:bg-slate-50/50 dark:hover:bg-rose-500/[0.01] transition-colors duration-300" data-v-4fd30b52><td class="p-8 border-r border-slate-100 dark:border-slate-800" data-v-4fd30b52><div class="space-y-5" data-v-4fd30b52><div class="flex items-center gap-2" data-v-4fd30b52><span class="px-3 py-1 bg-gradient-to-r from-rose-500 to-rose-600 text-white rounded-lg text-[9px] font-black uppercase shadow-lg shadow-rose-500/20 italic tracking-widest" data-v-4fd30b52>${ssrInterpolate(item.finding_type)}</span><span class="text-[9px] font-black text-slate-300 dark:text-slate-600 font-mono tracking-tighter group-hover:text-rose-500 transition-colors" data-v-4fd30b52>#${ssrInterpolate(item.snapshot_code)}</span></div><div class="relative pl-4 border-l-2 border-slate-200 dark:border-slate-700" data-v-4fd30b52>`);
          _push(ssrRenderComponent(_component_icon, {
            icon: "fa-solid fa-quote-left",
            class: "absolute -top-2 -left-3 text-slate-300 dark:text-slate-600 bg-white dark:bg-slate-900 px-1 text-xs"
          }, null, _parent));
          _push(`<p class="text-xs font-bold text-slate-800 dark:text-slate-200 leading-relaxed italic" data-v-4fd30b52> &quot;${ssrInterpolate(item.auditor_note)}&quot;</p></div><div class="p-4 bg-slate-50 dark:bg-slate-800/40 rounded-2xl border border-slate-100 dark:border-slate-700/50 group-hover:border-slate-200 dark:group-hover:border-slate-600 transition-colors" data-v-4fd30b52><p class="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1 italic flex items-center gap-1" data-v-4fd30b52>`);
          _push(ssrRenderComponent(_component_icon, { icon: "fa-solid fa-circle-check" }, null, _parent));
          _push(` Requirement: </p><p class="text-[10px] text-slate-600 dark:text-slate-400 font-medium leading-relaxed" data-v-4fd30b52>${ssrInterpolate(item.snapshot_requirement)}</p></div></div></td><td class="p-8 border-r border-slate-100 dark:border-slate-800" data-v-4fd30b52>`);
          if (__props.role === "auditee") {
            _push(`<div class="relative group/field h-full" data-v-4fd30b52><textarea rows="8" class="w-full h-full min-h-[180px] bg-slate-50 dark:bg-slate-800/40 border-slate-200 dark:border-slate-700/50 rounded-[1.5rem] text-[11px] font-bold text-slate-700 dark:text-slate-200 focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500/50 shadow-inner placeholder:text-slate-300 dark:placeholder:text-slate-600 transition-all resize-none p-5" placeholder="Analisis penyebab utama masalah..." data-v-4fd30b52>${ssrInterpolate(item.rtl.root_cause)}</textarea><div class="absolute bottom-4 right-4 opacity-0 group-focus-within/field:opacity-100 transition-all duration-500 transform translate-y-2 group-focus-within/field:translate-y-0" data-v-4fd30b52><span class="text-[8px] font-black text-emerald-500 uppercase tracking-widest italic flex items-center gap-1" data-v-4fd30b52>`);
            _push(ssrRenderComponent(_component_icon, { icon: "fa-solid fa-check-double" }, null, _parent));
            _push(` Autosave Ready </span></div></div>`);
          } else {
            _push(`<div class="p-6 rounded-[1.5rem] bg-slate-50/50 dark:bg-slate-800/30 border border-slate-100 dark:border-slate-700 min-h-[150px] relative overflow-hidden" data-v-4fd30b52><div class="absolute top-0 right-0 p-4 opacity-10" data-v-4fd30b52>`);
            _push(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-magnifying-glass-chart",
              class: "text-4xl"
            }, null, _parent));
            _push(`</div><p class="text-xs text-slate-600 dark:text-slate-300 font-medium leading-relaxed italic relative z-10" data-v-4fd30b52>${ssrInterpolate(item.rtl?.root_cause || "Belum dianalisis auditror.")}</p></div>`);
          }
          _push(`</td><td class="p-8 border-r border-slate-100 dark:border-slate-800" data-v-4fd30b52>`);
          if (__props.role === "auditee") {
            _push(`<div class="relative group/field h-full" data-v-4fd30b52><textarea rows="8" class="w-full h-full min-h-[180px] bg-slate-50 dark:bg-slate-800/40 border-slate-200 dark:border-slate-700/50 rounded-[1.5rem] text-[11px] font-bold text-slate-700 dark:text-slate-200 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500/50 shadow-inner placeholder:text-slate-300 dark:placeholder:text-slate-600 transition-all resize-none p-5" placeholder="Langkah perbaikan konkret &amp; sistematis..." data-v-4fd30b52>${ssrInterpolate(item.rtl.action_plan)}</textarea></div>`);
          } else {
            _push(`<div class="p-6 rounded-[1.5rem] bg-slate-50/50 dark:bg-slate-800/30 border border-slate-100 dark:border-slate-700 min-h-[150px] relative overflow-hidden" data-v-4fd30b52><div class="absolute top-0 right-0 p-4 opacity-10" data-v-4fd30b52>`);
            _push(ssrRenderComponent(_component_icon, {
            ...
            _push(`</div><p class="text-xs text-slate-600 dark:text-slate-300 font-medium leading-relaxed italic relative z-10" data-v-4fd30b52>${ssrInterpolate(item.rtl?.action_plan || "Rencana belum didefinisikan.")}</p></div>`);
          }
          _push(`</td><td class="p-8 border-r border-slate-100 dark:border-slate-800" data-v-4fd30b52><div class="space-y-6" data-v-4fd30b52>`);
          if (__props.role === "auditee") {
            _push(`<div class="space-y-4" data-v-4fd30b52><div class="space-y-1.5" data-v-4fd30b52><label class="text-[8px] font-black text-slate-400 uppercase ml-3 italic tracking-widest leading-none" data-v-4fd30b52>PIC Name</label><input${ssrRenderAttr("value", item.rtl.pic)} type="text" class="w-full bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700/50 rounded-xl text-[10px] font-black uppercase shadow-sm focus:ring-2 focus:ring-rose-500/20 text-center py-3" placeholder="NAMA / JABATAN" data-v-4fd30b52></div><div class="space-y-1.5" data-v-4fd30b52><label class="text-[8px] font-black text-slate-400 uppercase ml-3 italic tracking-widest leading-none" data-v-4fd30b52>Due Date</label><input${ssrRenderAttr("value", item.rtl.deadline)} type="date" class="w-full bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700/50 rounded-xl text-[10px] font-black shadow-sm focus:ring-2 focus:ring-rose-500/20 py-3 text-center" data-v-4fd30b52></div></div>`);
          } else {
            _push(`<div class="text-center space-y-4 pt-4" data-v-4fd30b52><div data-v-4fd30b52><p class="text-[7px] font-black text-slate-400 uppercase tracking-widest flex items-center justify-center gap-1" data-v-4fd30b52>`);
            _push(ssrRenderComponent(_component_icon, { icon: "fa-solid fa-user-tag" }, null, _parent));
            _push(` Responsibility </p><p class="text-[10px] font-black text-slate-800 dark:text-white uppercase tracking-tighter mt-1 bg-slate-100 dark:bg-slate-800 py-1 px-3 rounded-lg inline-block" data-v-4fd30b52>${ssrInterpolate(item.rtl?.pic || "-")}</p></div><div class="p-3 bg-rose-50 dark:bg-rose-500/5 rounded-2xl border border-rose-100 dark:border-rose-500/20" data-v-4fd30b52><p class="text-[7px] font-black text-rose-400 uppercase tracking-widest flex items-center justify-center gap-1" data-v-4fd30b52>`);
            _push(ssrRenderComponent(_component_icon, { icon: "fa-regular fa-calendar" }, null, _parent));
            _push(` Deadline </p><p class="text-[10px] font-black text-rose-600 dark:text-rose-400 uppercase mt-1" data-v-4fd30b52>${ssrInterpolate(item.rtl?.deadline || "-")}</p></div></div>`);
          }
          _push(`</div></td><td class="p-8 border-r border-slate-100 dark:border-slate-800 text-center" data-v-4fd30b52>`);
          if (__props.role === "auditor") {
            _push(`<div class="flex flex-col gap-5 items-center" data-v-4fd30b52><select class="w-full bg-slate-900 dark:bg-black text-white border-none rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] py-4 px-6 shadow-xl shadow-slate-900/20 hover:shadow-slate-900/30 cursor-pointer focus:ring-4 focus:ring-rose-500/30 transition-all appearance-none text-center" data-v-4fd30b52><option value="open" data-v-4fd30b52${ssrIncludeBooleanAttr(Array.isArray(item.rtl.status) ? ssrLooseContain(item.rtl.status, "open") : ssrLooseEqual(item.rtl.status, "open")) ? " selected" : ""}>STATUS: OPEN</option><option value="in_progress" data-v-4fd30b52${ssrIncludeBooleanAttr(Array.isArray(item.rtl.status) ? ssrLooseContain(item.rtl.status, "in_progress") : ssrLooseEqual(item.rtl.status, "in_progress")) ? " selected" : ""}>STATUS: IN PROGRESS</option><option value="closed" data-v-4fd30b52${ssrIncludeBooleanAttr(Array.isArray(item.rtl.status) ? ssrLooseContain(item.rtl.status, "closed") : ssrLooseEqual(item.rtl.status, "closed")) ? " selected" : ""}>STATUS: CLOSED</option></select><textarea rows="4" class="w-full bg-white dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-700/50 rounded-2xl text-[10px] font-medium p-4 italic placeholder:text-slate-300 focus:border-rose-500 focus:ring-0 transition-colors" placeholder="Evaluasi rencana..." data-v-4fd30b52>${ssrInterpolate(item.rtl.auditor_feedback)}</textarea></div>`);
          } else {
            _push(`<div class="flex flex-col items-center justify-center min-h-[150px] space-y-5" data-v-4fd30b52><span class="${ssrRenderClass(["px-6 py-2.5 rounded-full text-[9px] font-black uppercase tracking-[0.2em] shadow-sm border transition-all duration-700 group-hover:scale-110 select-none", getStatusBadge(item.rtl?.status)])}" data-v-4fd30b52>${ssrInterpolate(item.rtl?.status || "OPEN")}</span>`);
            if (item.rtl?.auditor_feedback) {
              _push(`<div class="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-800 max-w-[220px]" data-v-4fd30b52><p class="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1 italic" data-v-4fd30b52> Auditor Feed:</p><p class="text-[10px] text-slate-500 dark:text-slate-300 italic leading-relaxed" data-v-4fd30b52>&quot;${ssrInterpolate(item.rtl.auditor_feedback)}&quot;</p></div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
          }
          _push(`</td><td class="p-8 text-center flex flex-col items-center justify-center min-h-[200px] sticky right-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md z-10 shadow-[-10px_0_20px_-10px_rgba(0,0,0,0.05)]" data-v-4fd30b52><div class="relative z-20 w-full" data-v-4fd30b52>`);
          if (__props.role === "auditee") {
            _push(`<button class="w-full py-5 bg-gradient-to-r from-rose-600 to-rose-700 text-white rounded-3xl font-black text-[10px] uppercase tracking-[0.2em] shadow-xl shadow-rose-600/30 hover:shadow-rose-600/50 hover:scale-105 active:scale-95 transition-all flex flex-col items-center gap-2 group/btn" data-v-4fd30b52>`);
            _push(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-paper-plane",
              class: "text-lg group-hover/btn:-translate-y-1 transition-transform"
            }, null, _parent));
            _push(`<span data-v-4fd30b52>Submit</span></button>`);
          } else {
            _push(`<!---->`);
          }
          if (__props.role === "auditor") {
            _push(`<button class="w-full py-5 bg-gradient-to-r from-slate-800 to-slate-900 dark:from-emerald-600 dark:to-emerald-700 text-white rounded-3xl font-black text-[10px] uppercase tracking-[0.2em] shadow-xl shadow-slate-900/30 dark:shadow-emerald-600/30 hover:shadow-2xl hover:scale-105 active:scale-95 transition-all flex flex-col items-center gap-2 group/btn" data-v-4fd30b52>`);
            _push(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-check-to-slot",
              class: "text-lg group-hover/btn:-translate-y-1 transition-transform"
            }, null, _parent));
            _push(`<span data-v-4fd30b52>Verify</span></button>`);
          } else {
            _push(`<!---->`);
          }
          if (__props.role === "admin") {
            _push(`<div class="text-center space-y-3 opacity-30" data-v-4fd30b52>`);
            _push(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-eye",
              class: "text-2xl text-slate-400"
            }, null, _parent));
            _push(`<span class="text-[8px] font-black text-slate-400 uppercase tracking-widest block" data-v-4fd30b52>Monitoring</span></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></td></tr>`);
        ...
        _push(`<div class="flex flex-col items-center justify-center py-20 px-10 text-center space-y-4" data-v-4fd30b52><div class="p-6 bg-slate-50 dark:bg-slate-800 rounded-full mb-2" data-v-4fd30b52>`);
        _push(ssrRenderComponent(_component_icon, {
          icon: "fa-solid fa-clipboard-check",
          class: "text-4xl text-slate-300 dark:text-slate-600"
        }, null, _parent));
        _push(`</div><h3 class="text-lg font-bold text-slate-700 dark:text-white" data-v-4fd30b52>Tidak Ada Temuan</h3><p class="text-sm text-slate-500 dark:text-slate-400 max-w-md" data-v-4fd30b52> Tidak ada temuan (KTS/OB) yang memerlukan Rencana Tindak Lanjut pada saat ini. </p></div>`);
      }
      _push(`</div>`);
    };
  }
...
const MatrixRtlView = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-4fd30b52"]]);
const _sfc_main$1 = {
  __name: "ArchiveView",
  __ssrInlineRender: true,
  props: {
