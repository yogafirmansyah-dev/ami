...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const globalStats = computed(() => {
      ...
      const avgProgress = data.length > 0 ? Math.round(data.reduce((acc, curr) => acc + getAuditeeProgress(curr), 0) / data.length) : 0;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AppLayout, mergeProps({ title: "Portal Auditee" }, _attrs), {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center gap-4" data-v-2668f93f${_scopeId}><div class="relative flex h-3 w-3" data-v-2668f93f${_scopeId}><span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-rose-400 opacity-75" data-v-2668f93f${_scopeId}></span><span class="relative inline-flex rounded-full h-3 w-3 bg-rose-500" data-v-2668f93f${_scopeId}></span></div><h2 class="font-black text-xl text-slate-800 dark:text-white leading-tight uppercase tracking-tighter italic" data-v-2668f93f${_scopeId}> Portal Auditee </h2></div>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-12" data-v-2668f93f${_scopeId}><div class="grid grid-cols-1 md:grid-cols-3 gap-6" data-v-2668f93f${_scopeId}><!--[-->`);
            ssrRenderList(stats.value, (stat, idx) => {
              _push2(`<div class="${ssrRenderClass(["p-8 rounded-[2.5rem] border shadow-sm relative overflow-hidden group transition-all duration-300 hover:-translate-y-1", stat.bg])}" data-v-2668f93f${_scopeId}><div class="flex justify-between items-start relative z-10" data-v-2668f93f${_scopeId}><p class="${ssrRenderClass(["text-[10px] font-black uppercase tracking-[0.2em]", stat.color])}" data-v-2668f93f${_scopeId}>${ssrInterpolate(stat.label)}</p>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: `fa-solid ${stat.icon}`,
                class: ["text-lg opacity-80", stat.color]
              }, null, _parent2, _scopeId));
              _push2(`</div><p class="${ssrRenderClass(["text-4xl font-black mt-4 tracking-tighter italic text-slate-900 dark:text-white", stat.color])}" data-v-2668f93f${_scopeId}>${ssrInterpolate(stat.value)}</p>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: `fa-solid ${stat.icon}`,
            ...
            _push2(`<!--]--></div><div class="flex flex-col lg:flex-row justify-between items-center gap-6" data-v-2668f93f${_scopeId}><div class="flex items-center gap-2 p-1.5 bg-white dark:bg-slate-900/50 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm backdrop-blur-sm" data-v-2668f93f${_scopeId}><!--[-->`);
            ssrRenderList(["all", "on_going", "completed"], (s) => {
              _push2(`<button class="${ssrRenderClass([status.value === s ? "bg-rose-500 text-white shadow-lg shadow-rose-500/30" : "text-slate-400 hover:text-slate-600 hover:bg-slate-50 dark:hover:bg-slate-800", "px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-wider transition-all duration-300"])}" data-v-2668f93f${_scopeId}>${ssrInterpolate(s === "all" ? "Semua Audit" : s === "on_going" ? "Proses Berjalan" : "Selesai")}</button>`);
            });
            _push2(`<!--]--></div><div class="relative w-full lg:w-96 group" data-v-2668f93f${_scopeId}><div class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none" data-v-2668f93f${_scopeId}><svg class="w-4 h-4 text-slate-400 group-focus-within:text-rose-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-2668f93f${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-2668f93f${_scopeId}></path></svg></div><input${ssrRenderAttr("value", search.value)} type="text" class="w-full pl-12 pr-6 py-4 bg-white dark:bg-slate-900 border-none rounded-2xl text-xs font-bold text-slate-700 dark:text-white placeholder:text-slate-400 shadow-sm ring-1 ring-slate-100 dark:ring-slate-800 focus:ring-2 focus:ring-rose-500/20 transition-all" placeholder="Cari Standar Mutu..." data-v-2668f93f${_scopeId}>`);
            if (isSearching.value) {
              _push2(`<div class="absolute inset-y-0 right-0 pr-5 flex items-center" data-v-2668f93f${_scopeId}><div class="w-3 h-3 border-2 border-rose-500 border-t-transparent rounded-full animate-spin" data-v-2668f93f${_scopeId}></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="bg-white dark:bg-slate-900 rounded-[3rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 overflow-hidden" data-v-2668f93f${_scopeId}>`);
            if (__props.assignments.data.length > 0) {
              _push2(`<div class="overflow-x-auto" data-v-2668f93f${_scopeId}><table class="w-full min-w-[1000px]" data-v-2668f93f${_scopeId}><thead data-v-2668f93f${_scopeId}><tr class="border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30" data-v-2668f93f${_scopeId}><th class="px-10 py-8 text-center text-[9px] font-black text-slate-400 uppercase tracking-[0.2em]" data-v-2668f93f${_scopeId}> No</th><th class="px-10 py-8 text-left text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] cursor-pointer hover:text-rose-500 transition-colors group select-none" data-v-2668f93f${_scopeId}><div class="flex items-center justify-between gap-2" data-v-2668f93f${_scopeId}> Standar Mutu &amp; Periode <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-2668f93f${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
              ...
              _push2(`</div></div></th><th class="px-10 py-8 text-left text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] cursor-pointer hover:text-rose-500 transition-colors group select-none" data-v-2668f93f${_scopeId}><div class="flex items-center justify-between gap-2" data-v-2668f93f${_scopeId}> Unit Kerja &amp; Kategori <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-2668f93f${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-caret-up",
              ...
              _push2(`</div></div></th><th class="px-10 py-8 text-left text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] cursor-pointer hover:text-rose-500 transition-colors group select-none" data-v-2668f93f${_scopeId}><div class="flex items-center justify-between gap-2" data-v-2668f93f${_scopeId}> Auditor <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-2668f93f${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-caret-up",
              ...
              _push2(`</div></div></th><th class="px-10 py-8 text-center text-[9px] font-black text-slate-400 uppercase tracking-[0.2em]" data-v-2668f93f${_scopeId}> Status Tahapan</th><th class="px-10 py-8 text-left text-[9px] font-black text-slate-400 uppercase tracking-[0.2em]" data-v-2668f93f${_scopeId}> Kepatuhan Unit</th><th class="px-10 py-8 text-right text-[9px] font-black text-slate-400 uppercase tracking-[0.2em]" data-v-2668f93f${_scopeId}> Aksi</th></tr></thead><tbody class="divide-y divide-slate-50 dark:divide-slate-800" data-v-2668f93f${_scopeId}><!--[-->`);
              ssrRenderList(__props.assignments.data, (item) => {
                _push2(`<tr class="group hover:bg-rose-50/30 dark:hover:bg-rose-900/10 transition-colors duration-300" data-v-2668f93f${_scopeId}><td class="px-10 py-8" data-v-2668f93f${_scopeId}><span class="font-mono text-sm font-black text-rose-500 bg-rose-50 dark:bg-rose-500/10 px-2 py-1 rounded-md border border-rose-100 dark:border-rose-500/20" data-v-2668f93f${_scopeId}>${ssrInterpolate(__props.assignments.from + __props.assignments.data.indexOf(item))}</span></td><td class="px-10 py-8" data-v-2668f93f${_scopeId}><h4 class="text-sm font-black text-slate-800 dark:text-white uppercase tracking-tighter italic mb-2 group-hover:text-rose-600 transition-colors" data-v-2668f93f${_scopeId}>${ssrInterpolate(item.standard?.name)}</h4><span class="inline-flex items-center px-2.5 py-1 rounded-md bg-rose-400 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 text-[8px] font-black text-slate-500 uppercase tracking-widest shadow-sm" data-v-2668f93f${_scopeId}>${ssrInterpolate(item.period?.name)}</span></td><td class="px-10 py-8" data-v-2668f93f${_scopeId}><div class="flex items-center gap-4" data-v-2668f93f${_scopeId}><div class="${ssrRenderClass([
                ...
                ])}" data-v-2668f93f${_scopeId}>${ssrInterpolate(item.assignable?.name?.charAt(0))}</div><div data-v-2668f93f${_scopeId}><div class="font-black text-slate-800 dark:text-slate-200 uppercase text-xs tracking-tight italic leading-none mb-1.5" data-v-2668f93f${_scopeId}>${ssrInterpolate(item.assignable?.name)}</div><div class="flex items-center gap-2" data-v-2668f93f${_scopeId}><span class="${ssrRenderClass([
                ...
                ])}" data-v-2668f93f${_scopeId}>${ssrInterpolate(item.assignable_type.includes("Prodi") ? "Program Studi" : "Fakultas")}</span></div></div></div></td><td class="px-10 py-8" data-v-2668f93f${_scopeId}>`);
                if (item.auditor) {
                  _push2(`<div class="flex items-center gap-4" data-v-2668f93f${_scopeId}><div class="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-[10px] font-black text-slate-600 dark:text-slate-300 border-2 border-white dark:border-slate-700 shadow-lg group-hover:scale-110 transition-transform" data-v-2668f93f${_scopeId}>${ssrInterpolate(item.auditor.name.substring(0, 2).toUpperCase())}</div><div data-v-2668f93f${_scopeId}><p class="text-xs font-bold text-slate-700 dark:text-slate-200" data-v-2668f93f${_scopeId}>${ssrInterpolate(item.auditor.name)}</p><p class="text-[9px] text-slate-400 font-medium" data-v-2668f93f${_scopeId}>Penilai Utama</p></div></div>`);
                } else {
                  _push2(`<span class="text-[9px] font-black italic text-slate-300 uppercase tracking-widest" data-v-2668f93f${_scopeId}>Belum Ditentukan</span>`);
                }
                _push2(`</td><td class="px-10 py-8 text-center" data-v-2668f93f${_scopeId}><span class="${ssrRenderClass(["inline-flex items-center px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest border shadow-sm", getStageBadge(item.current_stage)])}" data-v-2668f93f${_scopeId}>${ssrInterpolate(item.current_stage.replace("_", " "))}</span></td><td class="px-10 py-8" data-v-2668f93f${_scopeId}><div class="max-w-[150px] mx-auto space-y-3" data-v-2668f93f${_scopeId}><div class="space-y-1" data-v-2668f93f${_scopeId}><div class="flex justify-between items-center text-[8px] font-black uppercase text-slate-500" data-v-2668f93f${_scopeId}><span data-v-2668f93f${_scopeId}>Pengisian</span><span class="text-indigo-600 dark:text-indigo-400" data-v-2668f93f${_scopeId}>${ssrInterpolate(getAuditeeProgress(item))}%</span></div><div class="w-full bg-slate-100 dark:bg-slate-800 h-1.5 rounded-full overflow-hidden" data-v-2668f93f${_scopeId}><div class="bg-indigo-500 h-full rounded-full transition-all duration-1000 shadow-[0_0_8px_rgba(99,102,241,0.4)]" style="${ssrRenderStyle({ width: getAuditeeProgress(item) + "%" })}" data-v-2668f93f${_scopeId}></div></div></div><div class="space-y-1" data-v-2668f93f${_scopeId}><div class="flex justify-between items-center text-[8px] font-black uppercase text-slate-500" data-v-2668f93f${_scopeId}><span data-v-2668f93f${_scopeId}>Penilaian</span><span class="text-rose-600 dark:text-rose-400" data-v-2668f93f${_scopeId}>${ssrInterpolate(getAuditorProgress(item))}%</span></div><div class="w-full bg-slate-100 dark:bg-slate-800 h-1.5 rounded-full overflow-hidden" data-v-2668f93f${_scopeId}><div class="bg-rose-500 h-full rounded-full transition-all duration-1000 shadow-[0_0_8px_rgba(244,63,94,0.4)]" style="${ssrRenderStyle({ width: getAuditorProgress(item) + "%" })}" data-v-2668f93f${_scopeId}></div></div></div></div></td><td class="px-10 py-8 text-right" data-v-2668f93f${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-2668f93f${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" data-v-2668f93f${_scopeId2}></path></svg>`);
                    } else {
                      return [
              ...
              _push2(`<div class="py-32 flex flex-col items-center justify-center text-center" data-v-2668f93f${_scopeId}><div class="w-24 h-24 bg-rose-50 dark:bg-rose-900/10 rounded-full flex items-center justify-center mb-6" data-v-2668f93f${_scopeId}><svg class="w-10 h-10 text-rose-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-2668f93f${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" data-v-2668f93f${_scopeId}></path></svg></div><h3 class="text-2xl font-black text-slate-800 dark:text-white italic tracking-tighter mb-2" data-v-2668f93f${_scopeId}>Belum Ada Agenda </h3><p class="text-slate-400 text-sm max-w-sm leading-relaxed" data-v-2668f93f${_scopeId}>Saat ini unit kerja Anda belum memiliki jadwal audit yang aktif atau arsip tersimpan.</p></div>`);
            }
            if (__props.assignments.data.length > 0) {
              _push2(`<div class="px-10 py-8 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50/30 dark:bg-slate-800/20" data-v-2668f93f${_scopeId}><p class="text-[10px] font-black text-slate-400 uppercase tracking-widest" data-v-2668f93f${_scopeId}> Menampilkan <span class="text-slate-900 dark:text-white" data-v-2668f93f${_scopeId}>${ssrInterpolate(__props.assignments.from)}-${ssrInterpolate(__props.assignments.to)}</span> dari ${ssrInterpolate(__props.assignments.total)}</p><div class="flex gap-2" data-v-2668f93f${_scopeId}><!--[-->`);
              ssrRenderList(__props.assignments.links, (link, k) => {
                ...
                if (link.url) {
                  ...
                  ])}" data-v-2668f93f${_scopeId}>${link.label ?? ""}</span>`);
                }
                _push2(`<!--]-->`);
              });
              _push2(`<!--]--></div></div>`);
                      ...
                      createVNode("tbody", { class: "divide-y divide-slate-50 dark:divide-slate-800" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(__props.assignments.data, (item) => {
                          return openBlock(), createBlock("tr", {
                            ...
                            createVNode("td", { class: "px-10 py-8" }, [
                              createVNode("div", { class: "max-w-[150px] mx-auto space-y-3" }, [
                                createVNode("div", { class: "space-y-1" }, [
                                  ...
                                  createVNode("div", { class: "w-full bg-slate-100 dark:bg-slate-800 h-1.5 rounded-full overflow-hidden" }, [
                                    createVNode("div", {
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2668f93f"]]);
export {
  Index as default
};
