import { computed, ref, watch, reactive, resolveComponent, mergeProps, withCtx, createVNode, resolveDynamicComponent, unref, createBlock, openBlock, Fragment, renderList, createCommentVNode, Teleport, Transition, createTextVNode, toDisplayString, withDirectives, vModelText, vModelSelect, withModifiers, useSSRContext } from "vue";
...
import { S as ScoringView, A as ArchiveView, M as MatrixRtlView, a as StatisticsView, _ as _sfc_main$1 } from "./UploadModal-B3JNm3bq.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AppLayout, mergeProps({
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col lg:flex-row justify-between items-start lg:items-center w-full gap-4 transition-all duration-300" data-v-14758c92${_scopeId}><div class="space-y-1 group cursor-default" data-v-14758c92${_scopeId}><h2 class="text-xl sm:text-2xl md:text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tighter italic leading-none transition-all group-hover:tracking-tight" data-v-14758c92${_scopeId}>${ssrInterpolate(__props.assignment.target_name)}</h2><div class="flex items-center gap-2" data-v-14758c92${_scopeId}><span class="relative flex h-2 w-2" data-v-14758c92${_scopeId}><span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" data-v-14758c92${_scopeId}></span><span class="relative inline-flex rounded-full h-2 w-2 bg-emerald-300" data-v-14758c92${_scopeId}></span></span><p class="text-[10px] font-bold text-slate-300 uppercase tracking-[0.3em] italic group-hover:text-emerald-300 transition-colors" data-v-14758c92${_scopeId}> Mesin Kerja Auditor</p></div></div><div class="flex items-center gap-1.5 p-1.5 rounded-2xl border border-slate-200/60 dark:border-slate-700/60 bg-white/50 dark:bg-slate-900/50 backdrop-blur-3xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] transition-all hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.1)] w-full lg:w-auto" data-v-14758c92${_scopeId}>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-6" data-v-14758c92${_scopeId}><div class="bg-white dark:bg-slate-900 rounded-[1.5rem] md:rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden" data-v-14758c92${_scopeId}><div class="overflow-x-auto no-scrollbar pt-6 pb-6 px-4 md:px-8" data-v-14758c92${_scopeId}><div class="flex items-center justify-between min-w-[600px] md:min-w-0 px-2 gap-0" data-v-14758c92${_scopeId}><!--[-->`);
            ssrRenderList(__props.stageStats, (s, index) => {
              _push2(`<div class="flex items-center flex-1 last:flex-none relative" data-v-14758c92${_scopeId}><div class="flex flex-col items-center gap-2 relative group/step" data-v-14758c92${_scopeId}>`);
              ssrRenderTeleport(_push2, (_push3) => {
                if (activeIndex.value !== null && activeIndex.value === index) {
                  ...
                  })}" class="z-[10000] pointer-events-none" data-v-14758c92${_scopeId}><div class="bg-slate-900/95 dark:bg-emerald-600/95 backdrop-blur-md text-white text-[10px] font-black uppercase tracking-widest px-3 py-2 rounded-xl border border-white/10 relative" data-v-14758c92${_scopeId}> Tahap: ${ssrInterpolate(s.label)} <div class="absolute top-full left-1/2 -translate-x-1/2 border-[6px] border-transparent border-t-slate-900/95 dark:border-t-emerald-600/95" data-v-14758c92${_scopeId}></div></div></div>`);
                } else {
                  _push3(`<!---->`);
                }
              }, "body", false, _parent2);
              ...
              ])}" data-v-14758c92${_scopeId}>`);
              if (index < currentStageIndex.value) {
                _push2(`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-14758c92${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" data-v-14758c92${_scopeId}></path></svg>`);
              } else {
                _push2(`<span class="text-xs italic" data-v-14758c92${_scopeId}>${ssrInterpolate(index + 1)}</span>`);
              }
              ...
              ])}" data-v-14758c92${_scopeId}>${ssrInterpolate(s.label)}</span></div>`);
              if (index < __props.stageStats.length - 1) {
                _push2(`<div class="flex-1 h-[2px] mx-2 bg-slate-100 dark:bg-slate-800 relative md:-mt-6" data-v-14758c92${_scopeId}><div class="${ssrRenderClass([
                ...
                ])}" data-v-14758c92${_scopeId}></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            });
            _push2(`<!--]--></div></div></div><div class="grid grid-cols-1 lg:grid-cols-12 gap-8" data-v-14758c92${_scopeId}><div class="lg:col-span-5 bg-gradient-to-br from-emerald-50 to-white dark:from-slate-900 dark:to-slate-900 p-8 rounded-[2.5rem] border border-emerald-100 dark:border-emerald-300/20 shadow-xl shadow-emerald-100/50 dark:shadow-none flex flex-col justify-between gap-8 group relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-emerald-200/50 dark:hover:shadow-emerald-300/10" data-v-14758c92${_scopeId}><div class="absolute top-0 right-0 w-64 h-64 bg-emerald-300/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" data-v-14758c92${_scopeId}></div><div class="relative z-10 flex items-start gap-6" data-v-14758c92${_scopeId}><div class="w-16 h-16 rounded-[1.2rem] bg-white dark:bg-emerald-300/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center font-black text-xl italic shadow-sm border border-emerald-50 dark:border-emerald-300/20 flex-shrink-0 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300" data-v-14758c92${_scopeId}>${ssrInterpolate(__props.assignment.standard?.name?.charAt(0))}</div><div class="min-w-0 flex-1" data-v-14758c92${_scopeId}><div class="flex items-center gap-2 mb-2" data-v-14758c92${_scopeId}><span class="px-2.5 py-1 rounded-lg bg-emerald-100 dark:bg-emerald-300/20 text-[10px] font-black uppercase tracking-widest text-emerald-600 dark:text-emerald-300" data-v-14758c92${_scopeId}> Standar Instrumen </span></div><h4 class="text-xl font-black text-slate-800 dark:text-slate-100 uppercase italic tracking-tight leading-tight group-hover:text-emerald-700 dark:group-hover:text-emerald-400 transition-colors" data-v-14758c92${_scopeId}>${ssrInterpolate(__props.assignment.standard?.name)}</h4></div></div><div class="relative z-10 grid grid-cols-3 gap-4 border-t border-emerald-100 dark:border-emerald-300/20 pt-6" data-v-14758c92${_scopeId}><div data-v-14758c92${_scopeId}><p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1" data-v-14758c92${_scopeId}>Unit Audit </p><p class="text-sm font-bold text-slate-700 dark:text-slate-200 truncate"${ssrRenderAttr("title", __props.assignment.target_name)} data-v-14758c92${_scopeId}>${ssrInterpolate(__props.assignment.target_name?.split(" ")[0])}</p></div><div class="text-center border-x border-emerald-50 dark:border-emerald-300/10" data-v-14758c92${_scopeId}><p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1" data-v-14758c92${_scopeId}> Indikator </p><p class="text-xl font-black text-emerald-600 dark:text-emerald-400 italic leading-none" data-v-14758c92${_scopeId}>${ssrInterpolate(__props.indicators.total)}</p></div><div class="text-right" data-v-14758c92${_scopeId}><p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1" data-v-14758c92${_scopeId}>Periode </p><div class="flex items-center justify-end gap-1" data-v-14758c92${_scopeId}><p class="text-sm font-bold text-slate-800 dark:text-white leading-none" data-v-14758c92${_scopeId}>${ssrInterpolate(__props.assignment.period?.name)}</p></div></div></div></div><div class="lg:col-span-7 bg-gradient-to-br from-slate-50 to-white dark:from-slate-800 dark:to-slate-900 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-700 shadow-xl relative overflow-hidden group transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl" data-v-14758c92${_scopeId}><div class="absolute bottom-0 left-0 w-64 h-64 bg-slate-300/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 pointer-events-none" data-v-14758c92${_scopeId}></div><div class="relative z-10 mb-6 flex items-center justify-between" data-v-14758c92${_scopeId}><div class="flex items-center gap-3" data-v-14758c92${_scopeId}><div class="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-300" data-v-14758c92${_scopeId}><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-14758c92${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 19a2 2 0 01-2-2V7a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1M5 19h14a2 2 0 002-2v-5a2 2 0 00-2-2H9a2 2 0 00-2 2v5a2 2 0 01-2 2z" data-v-14758c92${_scopeId}></path></svg></div><div data-v-14758c92${_scopeId}><h3 class="text-lg font-black uppercase italic tracking-tight text-slate-800 dark:text-white" data-v-14758c92${_scopeId}> Arsip Resmi </h3><p class="text-[10px] text-slate-400 font-bold uppercase tracking-wider" data-v-14758c92${_scopeId}>Berita Acara &amp; Laporan</p></div></div><span class="text-[10px] font-bold text-emerald-600 uppercase tracking-widest" data-v-14758c92${_scopeId}>${ssrInterpolate(__props.groupedDocuments.filter((d) => d.files && d.files.length || d.file).length)} File Avail </span></div><div class="relative z-10 flex gap-4 overflow-x-auto no-scrollbar pb-2" data-v-14758c92${_scopeId}><!--[-->`);
            ssrRenderList(__props.groupedDocuments, (doc) => {
              _push2(`<div class="min-w-[140px] flex-1 bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-100 dark:border-slate-700 flex flex-col gap-3 transition-all hover:border-emerald-300 hover:shadow-lg group/doc" data-v-14758c92${_scopeId}><div class="flex items-start justify-between" data-v-14758c92${_scopeId}><svg class="w-6 h-6 text-slate-300 group-hover/doc:text-emerald-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-14758c92${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-14758c92${_scopeId}></path></svg>`);
              if (doc.files && doc.files.length || doc.file) {
                _push2(`<div class="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]" data-v-14758c92${_scopeId}></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div data-v-14758c92${_scopeId}><p class="text-[10px] font-black text-slate-400 uppercase tracking-wider mb-2 line-clamp-1"${ssrRenderAttr("title", doc.label)} data-v-14758c92${_scopeId}>${ssrInterpolate(doc.label)}</p><div class="flex flex-col gap-2" data-v-14758c92${_scopeId}>`);
              if (!(doc.files?.length || doc.file) && canUploadBA(doc.type)) {
                _push2(`<!--[--><button class="px-3 py-1.5 bg-slate-900 text-white rounded-lg text-[9px] font-bold uppercase hover:bg-emerald-600 transition-colors w-full" data-v-14758c92${_scopeId}> Unggah </button><button type="button" class="px-3 py-1.5 bg-slate-100 dark:bg-slate-800 text-slate-500 hover:text-emerald-600 dark:hover:text-emerald-400 rounded-lg text-[9px] font-bold uppercase hover:bg-emerald-50 dark:hover:bg-emerald-900/30 transition-colors w-full text-center border border-slate-200 dark:border-slate-700 hover:border-emerald-200 dark:hover:border-emerald-800" data-v-14758c92${_scopeId}> Unduh Template </button><!--]-->`);
              } else if (doc.files && doc.files.length > 0) {
                _push2(`<a${ssrRenderAttr("href", _ctx.route("files.official.show", doc.files[0].id))} target="_blank" class="text-[10px] font-bold text-emerald-600 hover:underline flex items-center gap-1" data-v-14758c92${_scopeId}> Unduh PDF ↗ </a>`);
              } else if (doc.file) {
                _push2(`<a${ssrRenderAttr("href", _ctx.route("files.official.show", doc.file.id))} target="_blank" class="text-[10px] font-bold text-emerald-600 hover:underline flex items-center gap-1" data-v-14758c92${_scopeId}> Unduh PDF ↗ </a>`);
              } else {
                _push2(`<span class="text-[9px] italic text-slate-300" data-v-14758c92${_scopeId}>Menunggu</span>`);
              }
              _push2(`</div></div></div>`);
            });
            _push2(`<!--]--></div></div></div><div class="max-w-7xl mx-auto flex flex-col sm:flex-row gap-3 items-stretch justify-end mb-2" data-v-14758c92${_scopeId}><a${ssrRenderAttr("href", _ctx.route("shared.export.docx", __props.assignment.id))} class="group flex-1 sm:flex-none px-6 py-3.5 rounded-2xl text-[10px] font-black uppercase tracking-wider text-blue-600 hover:text-white dark:text-blue-400 transition-all bg-white hover:bg-blue-600 dark:bg-slate-900 dark:hover:bg-blue-500 active:scale-95 border border-slate-200/60 dark:border-slate-800 shadow-sm hover:shadow-md hover:shadow-blue-500/20 flex items-center justify-center" data-v-14758c92${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-file-word",
              class: "mr-2 opacity-70 transition-transform group-hover:scale-110 group-hover:opacity-100"
            }, null, _parent2, _scopeId));
            _push2(` Daftar Tilik </a><a${ssrRenderAttr("href", _ctx.route("shared.export.docx.finding", __props.assignment.id))} class="group flex-1 sm:flex-none px-6 py-3.5 rounded-2xl text-[10px] font-black uppercase tracking-wider text-amber-600 hover:text-white dark:text-amber-400 transition-all bg-white hover:bg-amber-600 dark:bg-slate-900 dark:hover:bg-amber-500 active:scale-95 border border-slate-200/60 dark:border-slate-800 shadow-sm hover:shadow-md hover:shadow-amber-500/20 flex items-center justify-center" data-v-14758c92${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-file-signature",
              class: "mr-2 opacity-70 transition-transform group-hover:scale-110 group-hover:opacity-100"
            }, null, _parent2, _scopeId));
            _push2(` Form Temuan </a></div><div class="max-w-7xl mx-auto flex flex-row gap-3 items-stretch" data-v-14758c92${_scopeId}><div class="relative flex-1 group/search" data-v-14758c92${_scopeId}><div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-transform group-focus-within/search:scale-110 group-focus-within/search:rotate-12" data-v-14758c92${_scopeId}>`);
            if (!isSearching.value) {
              _push2(`<svg class="w-4 h-4 text-slate-400 group-focus-within/search:text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-14758c92${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-14758c92${_scopeId}></path></svg>`);
            } else {
              _push2(`<div class="w-3 h-3 border-2 border-emerald-500 border-t-transparent rounded-full animate-spin" data-v-14758c92${_scopeId}></div>`);
            }
            _push2(`</div><input${ssrRenderAttr("value", search.value)} type="text" placeholder="Cari kriteria atau butir indikator..." class="w-full pl-11 pr-4 py-4 bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder:text-slate-400/50 font-bold text-xs rounded-2xl border-none outline-none focus:outline-none ring-1 ring-slate-200 dark:ring-slate-800 dark:focus:ring-emerald-500/50 focus:ring-4 focus:ring-emerald-500/10 shadow-sm focus:shadow-md transition-all duration-300" data-v-14758c92${_scopeId}></div><div class="flex items-center bg-white dark:bg-slate-900 rounded-2xl px-3 ring-1 ring-slate-200 dark:ring-slate-800 shadow-sm hover:ring-emerald-300/50 transition-all duration-300" data-v-14758c92${_scopeId}><span class="hidden sm:inline text-[9px] font-black uppercase text-slate-400 px-2 border-r dark:border-slate-800 mr-2" data-v-14758c92${_scopeId}>Tampilkan</span><select class="bg-transparent dark:bg-slate-900 border-none focus:ring-0 text-xs font-black text-slate-900 dark:text-white py-4 pr-8 cursor-pointer hover:text-emerald-600 transition-colors" data-v-14758c92${_scopeId}><option${ssrRenderAttr("value", 10)} data-v-14758c92${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 10) : ssrLooseEqual(perPage.value, 10)) ? " selected" : ""}${_scopeId}>10</option><option${ssrRenderAttr("value", 25)} data-v-14758c92${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 25) : ssrLooseEqual(perPage.value, 25)) ? " selected" : ""}${_scopeId}>25</option><option${ssrRenderAttr("value", 50)} data-v-14758c92${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 50) : ssrLooseEqual(perPage.value, 50)) ? " selected" : ""}${_scopeId}>50</option></select></div></div><div class="relative min-h-[400px]" data-v-14758c92${_scopeId}>`);
            ...
            if (showAssessmentModal.value) {
              _push2(`<div class="fixed inset-0 z-[999] flex items-center justify-center p-6" data-v-14758c92${_scopeId}><div class="fixed inset-0 bg-slate-900/80 backdrop-blur-xl transition-opacity" data-v-14758c92${_scopeId}></div><div class="relative bg-white dark:bg-slate-900 w-full max-w-2xl rounded-[4rem] shadow-2xl overflow-hidden border border-white/10 animate-in zoom-in duration-300" data-v-14758c92${_scopeId}><form class="flex flex-col max-h-[90vh]" data-v-14758c92${_scopeId}><div class="p-12 border-b dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/20 flex justify-between items-center" data-v-14758c92${_scopeId}><div data-v-14758c92${_scopeId}><h3 class="text-3xl font-black uppercase tracking-tighter italic text-slate-900 dark:text-white leading-none" data-v-14758c92${_scopeId}> Evaluasi</h3><p class="text-[10px] font-bold text-emerald-600 font-mono mt-3 uppercase tracking-widest italic" data-v-14758c92${_scopeId}>${ssrInterpolate(activeIndicator.value?.snapshot_code)}</p></div><button type="button" class="text-4xl text-slate-300 hover:text-emerald-600 transition-colors" data-v-14758c92${_scopeId}>×</button></div><div class="p-12 space-y-8 overflow-y-auto custom-scrollbar flex-1" data-v-14758c92${_scopeId}><p class="text-sm font-bold text-slate-600 dark:text-slate-300 italic leading-relaxed bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] shadow-inner border border-slate-50 dark:border-slate-700" data-v-14758c92${_scopeId}> &quot;${ssrInterpolate(activeIndicator.value?.snapshot_requirement)}&quot; </p><div class="grid grid-cols-2 gap-8" data-v-14758c92${_scopeId}><div class="space-y-3" data-v-14758c92${_scopeId}><label class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1" data-v-14758c92${_scopeId}>Kategori Temuan</label><select class="w-full px-6 py-4 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl text-xs font-bold shadow-inner focus:ring-2 focus:ring-emerald-500/20" required data-v-14758c92${_scopeId}><option value="" disabled data-v-14758c92${ssrIncludeBooleanAttr(Array.isArray(unref(assessmentForm).finding_type) ? ssrLooseContain(unref(assessmentForm).finding_type, "") : ssrLooseEqual(unref(assessmentForm).finding_type, "")) ? " selected" : ""}${_scopeId}>Pilih Status</option><option value="KS" data-v-14758c92${ssrIncludeBooleanAttr(Array.isArray(unref(assessmentForm).finding_type) ? ssrLooseContain(unref(assessmentForm).finding_type, "KS") : ssrLooseEqual(unref(assessmentForm).finding_type, "KS")) ? " selected" : ""}${_scopeId}>Kesesuaian (KS)</option><option value="KTS" data-v-14758c92${ssrIncludeBooleanAttr(Array.isArray(unref(assessmentForm).finding_type) ? ssrLooseContain(unref(assessmentForm).finding_type, "KTS") : ssrLooseEqual(unref(assessmentForm).finding_type, "KTS")) ? " selected" : ""}${_scopeId}>Ketidaksesuaian (KTS)</option><option value="OB" data-v-14758c92${ssrIncludeBooleanAttr(Array.isArray(unref(assessmentForm).finding_type) ? ssrLooseContain(unref(assessmentForm).finding_type, "OB") : ssrLooseEqual(unref(assessmentForm).finding_type, "OB")) ? " selected" : ""}${_scopeId}>Observasi (OB)</option></select></div><div class="space-y-3" data-v-14758c92${_scopeId}><label class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1" data-v-14758c92${_scopeId}>Skor Penilaian (1-4)</label><select class="w-full px-6 py-4 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl text-xs font-bold shadow-inner focus:ring-2 focus:ring-emerald-500/20" required data-v-14758c92${_scopeId}><option value="" disabled data-v-14758c92${ssrIncludeBooleanAttr(Array.isArray(unref(assessmentForm).score) ? ssrLooseContain(unref(assessmentForm).score, "") : ssrLooseEqual(unref(assessmentForm).score, "")) ? " selected" : ""}${_scopeId}>Beri Nilai</option><!--[-->`);
              ssrRenderList(4, (n) => {
                _push2(`<option${ssrRenderAttr("value", n)} data-v-14758c92${ssrIncludeBooleanAttr(Array.isArray(unref(assessmentForm).score) ? ssrLooseContain(unref(assessmentForm).score, n) : ssrLooseEqual(unref(assessmentForm).score, n)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(n)}</option>`);
              });
              _push2(`<!--]--></select></div></div><div class="space-y-3" data-v-14758c92${_scopeId}><label class="text-[10px] font-black text-amber-500 uppercase tracking-widest ml-1 italic" data-v-14758c92${_scopeId}>Narasi Deskripsi Temuan</label><textarea rows="4" class="w-full px-6 py-5 bg-amber-50/20 dark:bg-amber-900/10 border-2 border-amber-100 dark:border-amber-900/20 rounded-[2rem] text-xs font-bold shadow-sm focus:ring-2 focus:ring-amber-500/20" placeholder="Jelaskan temuan secara faktual..." required data-v-14758c92${_scopeId}>${ssrInterpolate(unref(assessmentForm).auditor_note)}</textarea></div><div class="space-y-3" data-v-14758c92${_scopeId}><label class="text-[10px] font-black text-emerald-500 uppercase tracking-widest ml-1 italic" data-v-14758c92${_scopeId}>Saran Rekomendasi Strategis</label><textarea rows="4" class="w-full px-6 py-5 bg-emerald-50/20 dark:bg-emerald-900/10 border-2 border-emerald-100 dark:border-emerald-900/20 rounded-[2rem] text-xs font-bold shadow-sm focus:ring-2 focus:ring-emerald-500/20" placeholder="Apa yang harus unit lakukan untuk memperbaiki ini?" data-v-14758c92${_scopeId}>${ssrInterpolate(unref(assessmentForm).recommendation)}</textarea></div></div><div class="p-12 border-t dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/20 flex justify-end gap-6" data-v-14758c92${_scopeId}><button type="button" class="px-10 py-3 text-[10px] font-black uppercase text-slate-400 hover:text-slate-600 transition-colors" data-v-14758c92${_scopeId}>Batal</button><button type="submit"${ssrIncludeBooleanAttr(unref(assessmentForm).processing) ? " disabled" : ""} class="px-16 py-4 bg-slate-900 dark:bg-emerald-600 text-white rounded-[2.5rem] font-black uppercase text-[10px] tracking-[0.2em] shadow-2xl hover:-translate-y-1 transition-all active:scale-95 disabled:opacity-50" data-v-14758c92${_scopeId}>${ssrInterpolate(unref(assessmentForm).processing ? "SINKRONISASI..." : "SIMPAN EVALUASI")}</button></div></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(``);
            if (showDocModal.value) {
              _push2(`<div class="fixed inset-0 z-[999] flex items-center justify-center p-6" data-v-14758c92${_scopeId}><div class="fixed inset-0 bg-slate-900/70 backdrop-blur-md" data-v-14758c92${_scopeId}></div><div class="relative bg-white dark:bg-slate-900 w-full max-w-md rounded-[3.5rem] shadow-2xl overflow-hidden border border-white/10 animate-in zoom-in duration-300" data-v-14758c92${_scopeId}><div class="p-12 border-b dark:border-slate-800 text-center bg-slate-50/50 dark:bg-slate-800/20" data-v-14758c92${_scopeId}><h3 class="text-xl font-black uppercase tracking-widest text-slate-900 dark:text-white leading-none" data-v-14758c92${_scopeId}> Arsip Resmi</h3><p class="text-[9px] font-bold text-emerald-500 uppercase mt-4 italic tracking-tighter" data-v-14758c92${_scopeId}>${ssrInterpolate(unref(docForm).label)}</p></div><form class="p-12 space-y-10" data-v-14758c92${_scopeId}><input type="file" required class="w-full text-[10px] text-slate-400 file:mr-4 file:py-3 file:px-8 file:rounded-2xl file:border-0 file:bg-slate-900 file:text-white file:font-black hover:file:bg-emerald-600 transition-all cursor-pointer shadow-inner" data-v-14758c92${_scopeId}><button type="submit"${ssrIncludeBooleanAttr(unref(docForm).processing) ? " disabled" : ""} class="w-full py-6 bg-emerald-600 text-white rounded-[2rem] font-black uppercase text-[10px] tracking-[0.3em] shadow-2xl hover:bg-emerald-700 transition-all active:scale-95" data-v-14758c92${_scopeId}>${ssrInterpolate(unref(docForm).processing ? "SINKRONISASI..." : "UNGGAH DOKUMEN")}</button></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(``);
            if (showHistoryModal.value) {
              _push2(`<div class="fixed inset-0 z-[999] flex items-center justify-center p-6" data-v-14758c92${_scopeId}><div class="fixed inset-0 bg-slate-900/80 backdrop-blur-xl transition-opacity" data-v-14758c92${_scopeId}></div><div class="relative bg-white dark:bg-slate-900 w-full max-w-2xl rounded-[4rem] shadow-2xl overflow-hidden animate-in zoom-in duration-300 flex flex-col max-h-[85vh]" data-v-14758c92${_scopeId}><div class="p-12 border-b dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/30" data-v-14758c92${_scopeId}><div data-v-14758c92${_scopeId}><h3 class="text-3xl font-black uppercase text-slate-900 dark:text-white italic tracking-tighter" data-v-14758c92${_scopeId}> Audit Trail</h3><p class="text-[10px] font-bold text-emerald-600 font-mono mt-2 uppercase tracking-widest italic leading-none" data-v-14758c92${_scopeId}>${ssrInterpolate(activeIndicatorCode.value)}</p></div><button class="text-4xl text-slate-300 hover:text-emerald-600 transition-colors" data-v-14758c92${_scopeId}>×</button></div><div class="p-12 overflow-y-auto custom-scrollbar flex-1 bg-white dark:bg-slate-900" data-v-14758c92${_scopeId}>`);
              if (isLoadingHistory.value) {
                _push2(`<div class="py-24 text-center" data-v-14758c92${_scopeId}><div class="inline-block w-10 h-10 border-4 border-emerald-500 border-t-transparent rounded-full animate-spin" data-v-14758c92${_scopeId}></div><p class="text-[10px] font-black text-slate-400 mt-6 uppercase tracking-[0.3em]" data-v-14758c92${_scopeId}> Mengambil Log... </p></div>`);
              } else {
                _push2(`<div class="space-y-12" data-v-14758c92${_scopeId}><!--[-->`);
                ssrRenderList(activeHistory.value, (log) => {
                  _push2(`<div class="relative pl-10 border-l-2 border-slate-100 dark:border-slate-800" data-v-14758c92${_scopeId}><div class="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-white dark:bg-slate-900 border-4 border-emerald-600 shadow-xl" data-v-14758c92${_scopeId}></div><div class="flex justify-between items-start mb-2" data-v-14758c92${_scopeId}><p class="text-[10px] font-black text-emerald-600 uppercase tracking-widest" data-v-14758c92${_scopeId}>${ssrInterpolate(log.created_at)}</p><span class="px-3 py-1 bg-slate-100 dark:bg-slate-800 rounded-lg text-[8px] font-black uppercase tracking-widest" data-v-14758c92${_scopeId}>${ssrInterpolate(log.user?.role)}</span></div><p class="text-sm font-black text-slate-900 dark:text-white tracking-tighter" data-v-14758c92${_scopeId}>${ssrInterpolate(log.user?.name)}</p><div class="mt-4 p-6 bg-slate-50 dark:bg-slate-800 rounded-[2.5rem] border border-slate-50 dark:border-slate-700 shadow-inner" data-v-14758c92${_scopeId}><p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-3 italic" data-v-14758c92${_scopeId}> Action: <span class="text-emerald-600" data-v-14758c92${_scopeId}>${ssrInterpolate(log.action)}</span></p><div class="text-[11px] text-slate-500 dark:text-slate-400 font-medium italic leading-relaxed" data-v-14758c92${_scopeId}>${log.formatted_changes ?? ""}</div></div></div>`);
                });
                _push2(`<!--]--></div>`);
              }
              _push2(`</div></div></div>`);
            ...
            return [
              createVNode("div", { class: "space-y-6" }, [
                        ...
                        return openBlock(), createBlock("div", {
                          ...
                          createVNode("div", null, [
                            ...
                            createVNode("div", { class: "flex flex-col gap-2" }, [
                              !(doc.files?.length || doc.file) && canUploadBA(doc.type) ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                                createVNode("button", {
                              ...
                              ], 64)) : doc.files && doc.files.length > 0 ? (openBlock(), createBlock("a", {
                                key: 1,
                ...
                createVNode("div", { class: "max-w-7xl mx-auto flex flex-col sm:flex-row gap-3 items-stretch justify-end mb-2" }, [
                  createVNode("a", {
                    href: _ctx.route("shared.export.docx", __props.assignment.id),
                    ...
                    createTextVNode(" Daftar Tilik ")
                  ], 8, ["href"]),
                  createVNode("a", {
                    href: _ctx.route("shared.export.docx.finding", __props.assignment.id),
                  ...
                  createVNode(Transition, {
                    ...
                    default: withCtx(() => [
                      (openBlock(), createBlock(resolveDynamicComponent(activeView.value), {
                        ...
                        onVerifyRtl: handleVerifyRtl,
                        onOpenUpload: openUpload
                      }, null, 40, ["assignment", "indicators", "groupedDocuments", "filters"]))
                    ]),
                    _: 1
                  })
                ])
...
const Show = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-14758c92"]]);
export {
  Show as default
};
