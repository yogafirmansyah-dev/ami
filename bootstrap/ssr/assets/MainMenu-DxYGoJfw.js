...
import { m as menuStatus, u as updateMenuStatus } from "./AppLayout-C9UC9tJn.js";
import { M as MainMenuLinks } from "./mainMenuLinks-Cpju2swJ.js";
import { m as mainMenuConf, a as appConf } from "./windowSizeCalculator-ej9CZPp5.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-8f72db9e><div class="${ssrRenderClass([[
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="${ssrRenderClass([unref(menuStatus) === "closed" && "ml-1", "logo-inside-container"])}" data-v-8f72db9e${_scopeId}><img${ssrRenderAttr("src", [
            ...
            ])} class="${ssrRenderClass(unref(mainMenuConf).umay.logoClasses)}" data-v-8f72db9e${_scopeId}><div id="logo-title" class="${ssrRenderClass([
              unref(menuStatus) !== "closed" ? "umay-main-menu-title-show" : "umay-main-menu-title-hide",
              unref(mainMenuConf).umay.appNameClasses
            ])}" data-v-8f72db9e${_scopeId}>${(unref(mainMenuConf).appName ? unref(mainMenuConf).appName : unref(appConf).appName) ?? ""}</div></div>`);
          } else {
            return [
              createVNode("div", {
      ...
      _push(`</div><nav id="links-wrapper" data-v-8f72db9e><!--[-->`);
      ...
      _push(`<!--]--></nav><div id="footer" data-v-8f72db9e>`);
      if (unref(mainMenuFooterLinks).length > 0 && unref(menuStatus) !== "closed") {
        ...
        ssrRenderList(unref(mainMenuFooterLinks), (link) => {
          ...
          if (link.linkType === "route") {
            _push(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  ...
                  _push2(`<span data-v-8f72db9e${_scopeId}>${ssrInterpolate(link.label ? link.label : link.label)}</span>`);
                } else {
                  return [
            ...
            _push(`<a id="footer-link" class="${ssrRenderClass(unref(mainMenuFooterLinks).length > 2 ? "justify-start" : "justify-center")}"${ssrRenderAttr("href", link.link)} target="_blank" data-v-8f72db9e>`);
            if (link.icon) {
              _push(ssrRenderComponent(_component_icon, {
                icon: link.icon
              }, null, _parent));
            ...
            _push(`<span data-v-8f72db9e>${ssrInterpolate(link.label ? link.label : link.label)}</span></a>`);
          }
          _push(`<!--]-->`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<div id="footer-trigger" data-v-8f72db9e><svg xmlns="http://www.w3.org/2000/svg" class="umay-main-menu-trigger-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-8f72db9e><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5l7 7-7 7M5 5l7 7-7 7" data-v-8f72db9e></path></svg></div>`);
      }
      _push(`</div></aside>`);
    };
  }
...
const MainMenu = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8f72db9e"]]);
export {
  MainMenu as default
};
