    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AppLayout, mergeProps({ title: "Penugasan Audit Saya" }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-8" data-v-992abdde${_scopeId}><div class="grid grid-cols-1 md:grid-cols-3 gap-6" data-v-992abdde${_scopeId}><!--[-->`);
            ssrRenderList(stats.value, (stat, idx) => {
              _push2(`<div class="${ssrRenderClass(["p-8 rounded-[2.5rem] border shadow-sm relative overflow-hidden group transition-all duration-300 hover:-translate-y-1", stat.bg])}" data-v-992abdde${_scopeId}><div class="flex justify-between items-start relative z-10" data-v-992abdde${_scopeId}><p class="${ssrRenderClass(["text-[10px] font-black uppercase tracking-[0.2em]", stat.color.split(" ")[0]])}" data-v-992abdde${_scopeId}>${ssrInterpolate(stat.label)}</p>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: `fa-solid ${stat.icon}`,
                class: ["text-lg opacity-80", stat.color.split(" ")[0]]
              }, null, _parent2, _scopeId));
              _push2(`</div><p class="${ssrRenderClass(["text-4xl font-black mt-4 tracking-tighter italic text-slate-900 dark:text-white", stat.color.split(" ")[0]])}" data-v-992abdde${_scopeId}>${ssrInterpolate(stat.value)}</p>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: `fa-solid ${stat.icon}`,
            ...
            _push2(`<!--]--></div><div class="flex flex-col lg:flex-row justify-between items-center gap-6" data-v-992abdde${_scopeId}><div class="relative w-full lg:w-96 group" data-v-992abdde${_scopeId}><span class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none" data-v-992abdde${_scopeId}>`);
            if (!isSearching.value) {
              ...
              _push2(`<div class="h-4 w-4 border-2 border-emerald-500 border-t-transparent rounded-full animate-spin" data-v-992abdde${_scopeId}></div>`);
            }
            _push2(`</span><input${ssrRenderAttr("value", search.value)} type="text" placeholder="Cari Unit atau Periode..." class="w-full pl-12 pr-6 py-4 border-none ring-1 ring-slate-200 dark:ring-slate-800 rounded-[2rem] bg-white dark:bg-slate-900 focus:ring-2 focus:ring-emerald-500/20 outline-none transition-all shadow-sm text-xs font-bold text-slate-700 dark:text-slate-200" data-v-992abdde${_scopeId}></div><div class="flex items-center gap-1 bg-white dark:bg-slate-900 p-1.5 rounded-[1.5rem] border border-slate-100 dark:border-slate-800 shadow-sm" data-v-992abdde${_scopeId}><!--[-->`);
            ssrRenderList(["all", "on_going", "completed"], (s) => {
              ...
              ])}" data-v-992abdde${_scopeId}>${ssrInterpolate(s.replace("_", " "))}</button>`);
            });
            _push2(`<!--]--></div></div><div class="bg-white/60 dark:bg-slate-900 backdrop-blur-3xl rounded-[2.5rem] border border-white/40 dark:border-white/5 shadow-sm overflow-hidden" data-v-992abdde${_scopeId}><div class="overflow-x-auto custom-scrollbar" data-v-992abdde${_scopeId}><table class="w-full text-left border-collapse min-w-[1000px] lg:min-w-full" data-v-992abdde${_scopeId}><thead data-v-992abdde${_scopeId}><tr class="bg-slate-50/80 dark:bg-slate-800/20 text-[10px] font-black uppercase text-slate-400 dark:text-slate-500 tracking-[0.2em] sticky top-0 z-20 border-b border-slate-100 dark:border-slate-800/50" data-v-992abdde${_scopeId}><th class="p-6 md:p-8" data-v-992abdde${_scopeId}>No</th><th class="p-6 md:p-8" data-v-992abdde${_scopeId}>Unit Audit</th><th class="p-6 md:p-8 cursor-pointer hover:text-emerald-500 transition-colors group select-none" data-v-992abdde${_scopeId}><div class="flex items-center gap-2" data-v-992abdde${_scopeId}> Referensi <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-992abdde${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
            ...
            _push2(`</div></div></th><th class="p-6 md:p-8 text-center cursor-pointer hover:text-emerald-500 transition-colors group select-none" data-v-992abdde${_scopeId}><div class="flex items-center justify-center gap-2" data-v-992abdde${_scopeId}> Tahapan <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-992abdde${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-caret-up",
            ...
            _push2(`</div></div></th><th class="p-6 md:p-8" data-v-992abdde${_scopeId}>Progres</th><th class="p-6 md:p-8 text-right" data-v-992abdde${_scopeId}>Aksi</th></tr></thead>`);
            if (__props.assignments.data.length > 0) {
              _push2(`<tbody class="divide-y divide-slate-50 dark:divide-slate-800/20" data-v-992abdde${_scopeId}><!--[-->`);
              ssrRenderList(__props.assignments.data, (item) => {
                _push2(`<tr class="group hover:bg-white/50 dark:hover:bg-white/[0.02] transition-colors duration-300" data-v-992abdde${_scopeId}><td class="p-6 md:p-8" data-v-992abdde${_scopeId}><span class="font-mono text-sm font-black text-rose-500 bg-rose-50 dark:bg-rose-500/10 px-2 py-1 rounded-md border border-rose-100 dark:border-rose-500/20" data-v-992abdde${_scopeId}>${ssrInterpolate(__props.assignments.from + __props.assignments.data.indexOf(item))}</span></td><td class="p-6 md:p-8" data-v-992abdde${_scopeId}><div class="flex items-center gap-5" data-v-992abdde${_scopeId}><div class="w-12 h-12 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 flex items-center justify-center font-black text-slate-400 group-hover:bg-emerald-500 group-hover:text-white group-hover:rotate-6 transition-all duration-500 shadow-inner group-hover:shadow-emerald-500/30" data-v-992abdde${_scopeId}>${ssrInterpolate(item.assignable?.name?.charAt(0))}</div><div data-v-992abdde${_scopeId}><div class="font-black text-slate-900 dark:text-white uppercase tracking-tighter italic text-sm leading-none mb-1.5" data-v-992abdde${_scopeId}>${ssrInterpolate(item.assignable?.name)}</div><div class="${ssrRenderClass(["inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md border text-[8px] font-black uppercase tracking-widest", getCategoryStyle(item.assignable_type)])}" data-v-992abdde${_scopeId}>`);
                _push2(ssrRenderComponent(_component_icon, {
                  icon: item.assignable_type.includes("Prodi") ? "fa-solid fa-graduation-cap" : "fa-solid fa-building",
                  class: "text-[9px]"
                }, null, _parent2, _scopeId));
                _push2(` ${ssrInterpolate(item.assignable_type.includes("Prodi") ? "Program Studi" : "Fakultas / Unit")}</div></div></div></td><td class="p-6 md:p-8" data-v-992abdde${_scopeId}><div class="text-[11px] font-bold text-slate-700 dark:text-slate-300 leading-snug" data-v-992abdde${_scopeId}>${ssrInterpolate(item.standard?.name)}</div><div class="text-[9px] font-black text-emerald-500 uppercase tracking-tighter mt-1.5 flex items-center gap-1.5 opacity-80" data-v-992abdde${_scopeId}>`);
                _push2(ssrRenderComponent(_component_icon, { icon: "fa-regular fa-clock" }, null, _parent2, _scopeId));
                _push2(` ${ssrInterpolate(item.period?.name)}</div></td><td class="p-6 md:p-8 text-center" data-v-992abdde${_scopeId}><span class="${ssrRenderClass(["px-3 py-1.5 rounded-lg text-[9px] font-black uppercase border tracking-widest inline-block whitespace-nowrap shadow-sm transition-all", getStageConfig(item.current_stage).color])}" data-v-992abdde${_scopeId}>${ssrInterpolate(getStageConfig(item.current_stage).label)}</span></td><td class="p-6 md:p-8" data-v-992abdde${_scopeId}><div class="max-w-[140px] mx-auto space-y-3" data-v-992abdde${_scopeId}><div class="space-y-1" data-v-992abdde${_scopeId}><div class="flex justify-between items-center text-[8px] font-black uppercase text-slate-500" data-v-992abdde${_scopeId}><span data-v-992abdde${_scopeId}>Pengisian</span><span class="text-indigo-600 dark:text-indigo-400" data-v-992abdde${_scopeId}>${ssrInterpolate(getAuditeeProgress(item))}%</span></div><div class="w-full bg-slate-100 dark:bg-slate-800 h-1.5 rounded-full overflow-hidden p-[1px]" data-v-992abdde${_scopeId}><div class="bg-indigo-500 h-full rounded-full transition-all duration-1000 shadow-[0_0_8px_rgba(99,102,241,0.4)]" style="${ssrRenderStyle({ width: getAuditeeProgress(item) + "%" })}" data-v-992abdde${_scopeId}></div></div></div><div class="space-y-1" data-v-992abdde${_scopeId}><div class="flex justify-between items-center text-[8px] font-black uppercase text-slate-500" data-v-992abdde${_scopeId}><span data-v-992abdde${_scopeId}>Penilaian</span><span class="text-emerald-600 dark:text-emerald-400" data-v-992abdde${_scopeId}>${ssrInterpolate(getAuditorProgress(item))}%</span></div><div class="w-full bg-slate-100 dark:bg-slate-800 h-1.5 rounded-full overflow-hidden p-[1px]" data-v-992abdde${_scopeId}><div class="bg-emerald-500 h-full rounded-full transition-all duration-1000 shadow-[0_0_8px_rgba(16,185,129,0.4)]" style="${ssrRenderStyle({ width: getAuditorProgress(item) + "%" })}" data-v-992abdde${_scopeId}></div></div></div></div></td><td class="p-6 md:p-8 text-right" data-v-992abdde${_scopeId}>`);
              ...
              _push2(`<tbody data-v-992abdde${_scopeId}><tr data-v-992abdde${_scopeId}><td colspan="6" class="p-12 text-center" data-v-992abdde${_scopeId}><div class="flex flex-col items-center justify-center py-12" data-v-992abdde${_scopeId}><div class="w-24 h-24 bg-slate-50 dark:bg-slate-800 rounded-full flex items-center justify-center mb-6 shadow-sm" data-v-992abdde${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-clipboard-check",
                class: "text-4xl text-slate-300 dark:text-slate-600"
              }, null, _parent2, _scopeId));
              _push2(`</div><h4 class="text-sm font-black text-slate-800 dark:text-white uppercase tracking-widest mb-2" data-v-992abdde${_scopeId}> Belum Ada Penugasan </h4><p class="text-xs font-bold text-slate-400 max-w-xs mx-auto" data-v-992abdde${_scopeId}> Saat ini belum ada data penugasan audit yang tersedia untuk Anda. </p></div></td></tr></tbody>`);
            }
            _push2(`</table></div><div class="flex flex-col md:flex-row items-center justify-between gap-4 px-6 md:px-8 py-6 border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-800/20 backdrop-blur-sm" data-v-992abdde${_scopeId}><div class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest italic text-center md:text-left flex items-center gap-2" data-v-992abdde${_scopeId}><span class="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" data-v-992abdde${_scopeId}></span> Data ${ssrInterpolate(__props.assignments.from)} - ${ssrInterpolate(__props.assignments.to)} dari total ${ssrInterpolate(__props.assignments.total)}</div><div class="flex flex-wrap justify-center gap-1.5" data-v-992abdde${_scopeId}><!--[-->`);
            ssrRenderList(__props.assignments.links, (link, k) => {
              ...
              if (link.url) {
                ...
                ])}" data-v-992abdde${_scopeId}>${link.label ?? ""}</span>`);
              }
              _push2(`<!--]-->`);
            });
                              ...
                              createVNode("div", { class: "max-w-[140px] mx-auto space-y-3" }, [
                                ...
                                createVNode("div", { class: "space-y-1" }, [
                                  createVNode("div", { class: "flex justify-between items-center text-[8px] font-black uppercase text-slate-500" }, [
                                    ...
                                    createVNode("span", { class: "text-emerald-600 dark:text-emerald-400" }, toDisplayString(getAuditorProgress(item)) + "%", 1)
                                  ]),
                                  createVNode("div", { class: "w-full bg-slate-100 dark:bg-slate-800 h-1.5 rounded-full overflow-hidden p-[1px]" }, [
                                    createVNode("div", {
                                      class: "bg-emerald-500 h-full rounded-full transition-all duration-1000 shadow-[0_0_8px_rgba(16,185,129,0.4)]",
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-992abdde"]]);
export {
  Index as default
};
