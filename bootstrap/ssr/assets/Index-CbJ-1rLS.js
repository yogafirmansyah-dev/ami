        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.stageBreakdown) {
              _push2(`<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-10" data-v-94cc89b6${_scopeId}><!--[-->`);
              ssrRenderList(__props.stageBreakdown, (stat) => {
                _push2(`<div class="bg-white dark:bg-slate-900 backdrop-blur-3xl p-5 rounded-[2rem] border border-white/40 dark:border-white/5 shadow-[0_8px_30px_rgba(0,0,0,0.04)] dark:shadow-none transition-all hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] hover:-translate-y-1 group relative overflow-hidden" data-v-94cc89b6${_scopeId}><p class="text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em] leading-none mb-3 group-hover:text-rose-500 transition-colors" data-v-94cc89b6${_scopeId}>${ssrInterpolate(stat.label)}</p><div class="flex items-end justify-between relative z-10" data-v-94cc89b6${_scopeId}><p class="text-3xl font-black text-slate-800 dark:text-slate-100 tracking-tighter italic" data-v-94cc89b6${_scopeId}>${ssrInterpolate(stat.total)}</p><div class="w-1.5 h-1.5 rounded-full bg-rose-500 shadow-[0_0_10px_rgba(244,63,94,0.5)] animate-pulse mb-1.5" data-v-94cc89b6${_scopeId}></div></div></div>`);
              });
              _push2(`<!--]--></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="space-y-6" data-v-94cc89b6${_scopeId}><div class="flex flex-col lg:flex-row justify-between items-center gap-6" data-v-94cc89b6${_scopeId}><div class="flex items-stretch gap-3 w-full max-w-2xl" data-v-94cc89b6${_scopeId}><div class="relative flex-1 group" data-v-94cc89b6${_scopeId}><span class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none" data-v-94cc89b6${_scopeId}>`);
            if (!isSearching.value) {
              _push2(`<svg class="h-4 w-4 text-slate-400 group-focus-within:text-rose-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-94cc89b6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-94cc89b6${_scopeId}></path></svg>`);
            } else {
              _push2(`<div class="h-4 w-4 border-2 border-rose-500 border-t-transparent rounded-full animate-spin" data-v-94cc89b6${_scopeId}></div>`);
            }
            _push2(`</span><input${ssrRenderAttr("value", search.value)} type="text" placeholder="Cari unit, auditor, atau standar..." class="w-full pl-11 pr-10 py-4 bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder:text-slate-400/50 font-bold text-xs rounded-2xl border-none outline-none focus:outline-none ring-1 ring-slate-200 dark:ring-slate-800 dark:focus:ring-rose-500/50 focus:ring-4 focus:ring-rose-500/50 shadow-sm focus:shadow-md transition-[ring,background-color,box-shadow] duration-300 ease-out focus:bg-slate-50 dark:focus:bg-slate-800/80" data-v-94cc89b6${_scopeId}>`);
            if (search.value) {
              _push2(`<button class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-rose-500 transition-colors" data-v-94cc89b6${_scopeId}>`);
            ...
            _push2(`</div><div class="flex items-center bg-white dark:bg-slate-900 rounded-2xl px-4 ring-1 ring-slate-200 dark:ring-slate-800 shadow-sm hover:ring-rose-500/50 dark:hover:ring-rose-500/50 transition-all duration-300" data-v-94cc89b6${_scopeId}><span class="hidden sm:inline text-[9px] font-black uppercase text-slate-400 px-2 border-r border-slate-200 dark:border-slate-800 mr-2" data-v-94cc89b6${_scopeId}>Tampilkan</span><select class="bg-transparent dark:bg-slate-900 border-none focus:ring-0 text-xs font-black text-slate-900 dark:text-white py-4 pr-8 cursor-pointer hover:text-rose-500 dark:hover:text-rose-500 transition-colors duration-300 outline-none" data-v-94cc89b6${_scopeId}><option${ssrRenderAttr("value", 10)} data-v-94cc89b6${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 10) : ssrLooseEqual(perPage.value, 10)) ? " selected" : ""}${_scopeId}>10</option><option${ssrRenderAttr("value", 25)} data-v-94cc89b6${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 25) : ssrLooseEqual(perPage.value, 25)) ? " selected" : ""}${_scopeId}>25</option><option${ssrRenderAttr("value", 50)} data-v-94cc89b6${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 50) : ssrLooseEqual(perPage.value, 50)) ? " selected" : ""}${_scopeId}>50</option><option${ssrRenderAttr("value", 100)} data-v-94cc89b6${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 100) : ssrLooseEqual(perPage.value, 100)) ? " selected" : ""}${_scopeId}>100</option></select></div></div><button class="group w-full lg:w-auto inline-flex items-center justify-center px-8 py-3.5 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-950 dark:from-rose-600 dark:via-rose-500 dark:to-rose-600 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl shadow-xl shadow-slate-900/20 dark:shadow-rose-600/30 transition-all hover:shadow-2xl hover:shadow-slate-900/30 dark:hover:shadow-rose-600/40 hover:-translate-y-0.5 active:scale-95 border-t border-white/10" data-v-94cc89b6${_scopeId}><span class="mr-2 text-rose-400 dark:text-white group-hover:rotate-90 transition-transform duration-300 text-sm leading-none" data-v-94cc89b6${_scopeId}>+</span> Inisialisasi AMI Baru </button></div><div class="bg-white/60 dark:bg-slate-900 backdrop-blur-3xl rounded-[2.5rem] border border-white/40 dark:border-white/5 shadow-sm overflow-hidden" data-v-94cc89b6${_scopeId}><div class="overflow-x-auto custom-scrollbar" data-v-94cc89b6${_scopeId}><table class="w-full text-left border-collapse min-w-[1000px] lg:min-w-full" data-v-94cc89b6${_scopeId}><thead data-v-94cc89b6${_scopeId}><tr class="bg-slate-50/80 dark:bg-slate-800/20 text-[10px] font-black uppercase text-slate-400 dark:text-slate-500 tracking-[0.2em] sticky top-0 z-20 border-b border-slate-100 dark:border-slate-800/50" data-v-94cc89b6${_scopeId}><th class="p-6 md:p-8" data-v-94cc89b6${_scopeId}> No </th><th class="p-6 md:p-8 pl-8 cursor-pointer hover:text-rose-500 transition-colors group select-none" data-v-94cc89b6${_scopeId}><div class="flex items-center gap-2" data-v-94cc89b6${_scopeId}> Unit Kerja &amp; Kategori <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-94cc89b6${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
            ...
            _push2(`</div></div></th><th class="p-6 md:p-8 text-center cursor-pointer hover:text-rose-500 transition-colors group select-none" data-v-94cc89b6${_scopeId}><div class="flex items-center justify-center gap-2" data-v-94cc89b6${_scopeId}> Metadata AMI <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-94cc89b6${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-caret-up",
            ...
            _push2(`</div></div></th><th class="p-6 md:p-8 text-center cursor-pointer hover:text-rose-500 transition-colors group select-none" data-v-94cc89b6${_scopeId}><div class="flex items-center justify-center gap-2" data-v-94cc89b6${_scopeId}> Auditor <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-94cc89b6${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-caret-up",
            ...
            _push2(`</div></div></th><th class="p-6 md:p-8 text-center" data-v-94cc89b6${_scopeId}> Progres Saat Ini </th><th class="p-6 md:p-8 pr-8 text-right" data-v-94cc89b6${_scopeId}>Aksi</th></tr></thead>`);
            if (isSearching.value) {
              _push2(`<tbody class="divide-y divide-slate-50 dark:divide-slate-800/20" data-v-94cc89b6${_scopeId}><!--[-->`);
              ssrRenderList(5, (i) => {
                _push2(`<tr class="animate-pulse bg-white/30 dark:bg-slate-900/10" data-v-94cc89b6${_scopeId}><td class="p-6 md:p-8" data-v-94cc89b6${_scopeId}><div class="h-6 w-8 bg-slate-200 dark:bg-slate-700/50 rounded-md" data-v-94cc89b6${_scopeId}></div></td><td class="p-6 md:p-8 pl-8" data-v-94cc89b6${_scopeId}><div class="flex items-center gap-4" data-v-94cc89b6${_scopeId}><div class="w-12 h-12 bg-slate-200 dark:bg-slate-700/50 rounded-xl" data-v-94cc89b6${_scopeId}></div><div class="space-y-2" data-v-94cc89b6${_scopeId}><div class="h-4 w-32 bg-slate-200 dark:bg-slate-700/50 rounded" data-v-94cc89b6${_scopeId}></div><div class="h-3 w-16 bg-slate-200 dark:bg-slate-700/50 rounded" data-v-94cc89b6${_scopeId}></div></div></div></td><td class="p-6 md:p-8" data-v-94cc89b6${_scopeId}><div class="h-4 w-24 mx-auto bg-slate-200 dark:bg-slate-700/50 rounded" data-v-94cc89b6${_scopeId}></div></td><td class="p-6 md:p-8 flex justify-center items-center" data-v-94cc89b6${_scopeId}><div class="h-8 w-24 bg-slate-200 dark:bg-slate-700/50 rounded-lg" data-v-94cc89b6${_scopeId}></div></td><td class="p-6 md:p-8" data-v-94cc89b6${_scopeId}><div class="h-4 w-32 mx-auto bg-slate-200 dark:bg-slate-700/50 rounded" data-v-94cc89b6${_scopeId}></div></td><td class="p-6 md:p-8" data-v-94cc89b6${_scopeId}><div class="h-8 w-16 ml-auto bg-slate-200 dark:bg-slate-700/50 rounded-lg" data-v-94cc89b6${_scopeId}></div></td></tr>`);
              });
              _push2(`<!--]--></tbody>`);
            } else if (__props.assignments.data.length === 0) {
              _push2(`<tbody class="divide-y divide-slate-50 dark:divide-slate-800/20" data-v-94cc89b6${_scopeId}><tr data-v-94cc89b6${_scopeId}><td colspan="6" class="p-16 text-center" data-v-94cc89b6${_scopeId}><div class="flex flex-col items-center justify-center text-slate-400 dark:text-slate-500" data-v-94cc89b6${_scopeId}><div class="w-24 h-24 mb-6 rounded-full bg-slate-50 dark:bg-slate-800/50 flex items-center justify-center border border-slate-100 dark:border-slate-800 shadow-inner" data-v-94cc89b6${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-folder-open",
                class: "text-4xl text-slate-300 dark:text-slate-600"
              }, null, _parent2, _scopeId));
              _push2(`</div><h3 class="text-lg font-black text-slate-700 dark:text-slate-300 mb-2 uppercase tracking-widest" data-v-94cc89b6${_scopeId}> Belum Ada Penugasan</h3><p class="text-xs max-w-sm text-center leading-relaxed font-bold" data-v-94cc89b6${_scopeId}> Data penugasan belum dibuat atau pencarian Anda tidak cocok dengan data manapun. </p>`);
              if (search.value) {
                _push2(`<button class="mt-8 px-6 py-3 bg-rose-50 text-rose-600 dark:bg-rose-500/10 dark:text-rose-400 text-xs font-black tracking-widest uppercase rounded-xl transition hover:bg-rose-100 dark:hover:bg-rose-500/20 active:scale-95 shadow-sm" data-v-94cc89b6${_scopeId}> Bersihkan Pencarian </button>`);
              } else {
                _push2(`<button class="mt-8 px-6 py-3 bg-slate-900 text-white dark:bg-rose-600 text-xs font-black uppercase tracking-widest rounded-xl transition shadow-lg active:scale-95 hover:shadow-xl hover:bg-slate-800 dark:hover:bg-rose-500" data-v-94cc89b6${_scopeId}> Buat Penugasan Baru </button>`);
              }
              _push2(`</div></td></tr></tbody>`);
            } else {
              _push2(`<tbody class="divide-y divide-slate-50 dark:divide-slate-800/20" data-v-94cc89b6${_scopeId}><!--[-->`);
              ssrRenderList(__props.assignments.data, (item) => {
                _push2(`<tr class="group hover:bg-white/50 dark:hover:bg-white/[0.02] transition-colors duration-300" data-v-94cc89b6${_scopeId}><td class="p-6 md:p-8" data-v-94cc89b6${_scopeId}><span class="font-mono text-sm font-black text-rose-500 bg-rose-50 dark:bg-rose-500/10 px-2 py-1 rounded-md border border-rose-100 dark:border-rose-500/20" data-v-94cc89b6${_scopeId}>${ssrInterpolate(__props.assignments.from + __props.assignments.data.indexOf(item))}</span></td><td class="p-6 md:p-8 pl-8" data-v-94cc89b6${_scopeId}><div class="flex items-center gap-4" data-v-94cc89b6${_scopeId}><div class="${ssrRenderClass([
                ...
                ])}" data-v-94cc89b6${_scopeId}>${ssrInterpolate(item.assignable?.name?.charAt(0))}</div><div data-v-94cc89b6${_scopeId}><div class="font-black text-slate-800 dark:text-slate-200 uppercase text-xs tracking-tight italic leading-none mb-1.5" data-v-94cc89b6${_scopeId}>${ssrInterpolate(item.assignable?.name)}</div><div class="flex items-center gap-2" data-v-94cc89b6${_scopeId}><span class="${ssrRenderClass([
                ...
                ])}" data-v-94cc89b6${_scopeId}>${ssrInterpolate(item.assignable_type.includes("Prodi") ? "Program Studi" : "Fakultas")}</span></div></div></div></td><td class="p-6 md:p-8" data-v-94cc89b6${_scopeId}><div class="text-[11px] font-bold text-slate-600 dark:text-slate-300 leading-snug" data-v-94cc89b6${_scopeId}>${ssrInterpolate(item.standard?.name)}</div><div class="text-[9px] font-black text-slate-400 dark:text-slate-600 mt-1.5 uppercase tracking-tighter italic flex items-center gap-1" data-v-94cc89b6${_scopeId}>`);
                _push2(ssrRenderComponent(_component_icon, {
                  icon: "fa-regular fa-calendar",
                  class: "text-[8px]"
                }, null, _parent2, _scopeId));
                _push2(` ${ssrInterpolate(item.period?.name)}</div></td><td class="p-6 md:p-8 text-slate-600 dark:text-slate-400 font-bold text-[10px]" data-v-94cc89b6${_scopeId}>`);
                if (item.auditor) {
                  _push2(`<div class="flex items-center gap-2.5" data-v-94cc89b6${_scopeId}><div class="w-8 h-8 rounded-lg bg-slate-900 dark:bg-slate-800 text-white flex items-center justify-center font-black text-[9px] shadow-lg shadow-slate-900/10 uppercase italic border border-white/10" data-v-94cc89b6${_scopeId}>${ssrInterpolate(item.auditor.name.substring(0, 2))}</div><span class="tracking-tight" data-v-94cc89b6${_scopeId}>${ssrInterpolate(item.auditor.name)}</span></div>`);
                } else {
                  _push2(`<div class="inline-flex items-center gap-1 text-[9px] font-black text-amber-500 bg-amber-50 dark:bg-amber-500/10 px-2 py-1 rounded-md border border-amber-200 dark:border-amber-500/20 uppercase tracking-widest animate-pulse" data-v-94cc89b6${_scopeId}>`);
                  _push2(ssrRenderComponent(_component_icon, {
                ...
                _push2(`</td><td class="p-6 md:p-8" data-v-94cc89b6${_scopeId}><div class="max-w-[140px] mx-auto space-y-2" data-v-94cc89b6${_scopeId}><div class="flex justify-between items-center text-[8px] font-black uppercase" data-v-94cc89b6${_scopeId}><span class="${ssrRenderClass(["px-2.5 py-1 rounded-md border border-transparent italic shadow-sm transition-all", getStageConfig(item.current_stage).color])}" data-v-94cc89b6${_scopeId}>${ssrInterpolate(getStageConfig(item.current_stage).label)}</span><span class="text-slate-700 dark:text-slate-300 italic tracking-tighter font-black" data-v-94cc89b6${_scopeId}>${ssrInterpolate(getProgress(item))}%</span></div><div class="w-full bg-slate-100 dark:bg-slate-800 h-1 rounded-full overflow-hidden p-[1px]" data-v-94cc89b6${_scopeId}><div class="bg-slate-900 dark:bg-rose-600 h-full rounded-full transition-all duration-1000 shadow-[0_0_8px_rgba(244,63,94,0.4)]" style="${ssrRenderStyle({ width: getProgress(item) + "%" })}" data-v-94cc89b6${_scopeId}></div></div></div></td><td class="p-6 md:p-8 pr-8 text-right" data-v-94cc89b6${_scopeId}><div class="flex justify-end items-center gap-2" data-v-94cc89b6${_scopeId}>`);
                ...
                _push2(`<button title="Hapus Penugasan" class="w-8 h-8 flex items-center justify-center text-slate-300 dark:text-slate-700 hover:text-rose-600 dark:hover:text-rose-500 transition-all hover:bg-rose-50 dark:hover:bg-rose-900/20 rounded-xl active:scale-95" data-v-94cc89b6${_scopeId}>`);
                _push2(ssrRenderComponent(_component_icon, {
            ...
            _push2(`</table></div><div class="flex flex-col md:flex-row items-center justify-between gap-4 px-6 md:px-8 py-6 border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-800/20 backdrop-blur-sm" data-v-94cc89b6${_scopeId}><div class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest italic text-center md:text-left" data-v-94cc89b6${_scopeId}> Data ${ssrInterpolate(__props.assignments.from)} - ${ssrInterpolate(__props.assignments.to)} dari total ${ssrInterpolate(__props.assignments.total)}</div><div class="flex flex-wrap justify-center gap-1.5" data-v-94cc89b6${_scopeId}><!--[-->`);
            ssrRenderList(__props.assignments.links, (link, k) => {
              ...
              if (link.url) {
                ...
                ])}" data-v-94cc89b6${_scopeId}>${link.label ?? ""}</span>`);
              }
              _push2(`<!--]-->`);
            });
            ...
            _push2(ssrRenderComponent(TModal, {
              ...
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-center p-4" data-v-94cc89b6${_scopeId2}><div class="w-20 h-20 rounded-full bg-rose-50 dark:bg-rose-500/10 text-rose-500 mx-auto flex items-center justify-center mb-6 shadow-inner" data-v-94cc89b6${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_icon, {
                    icon: "fa-solid fa-trash-can",
                    class: "text-3xl animate-bounce"
                  }, null, _parent3, _scopeId2));
                  _push3(`</div><h3 class="text-2xl font-black text-slate-900 dark:text-white mb-3 tracking-tighter italic" data-v-94cc89b6${_scopeId2}> Konfirmasi Hapus</h3><p class="text-xs font-bold text-slate-500 dark:text-slate-400 mb-8 max-w-xs mx-auto" data-v-94cc89b6${_scopeId2}> Menghapus penugasan akan menghapus seluruh data snapshot indikator di dalamnya secara permanen. Apakah Anda yakin? </p><div class="flex justify-center gap-3" data-v-94cc89b6${_scopeId2}><button class="px-6 py-3 text-[10px] font-black uppercase tracking-widest text-slate-500 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-slate-700 rounded-xl transition active:scale-95" data-v-94cc89b6${_scopeId2}> Batal </button><button class="px-6 py-3 text-[10px] font-black uppercase tracking-widest text-white bg-rose-500 hover:bg-rose-600 rounded-xl transition shadow-lg shadow-rose-500/30 active:scale-95" data-v-94cc89b6${_scopeId2}> Ya, Hapus </button></div></div>`);
                } else {
                  return [
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-94cc89b6"]]);
export {
  Index as default
};
