import { ref, watch, resolveComponent, mergeProps, withCtx, unref, createVNode, createBlock, createCommentVNode, withDirectives, openBlock, vModelText, vModelSelect, createTextVNode, toDisplayString, Fragment, renderList, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AppLayout, mergeProps({ title: "Audit Trail" }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-6" data-v-4caab520${_scopeId}><div class="flex flex-col lg:flex-row justify-between items-center gap-6" data-v-4caab520${_scopeId}><div class="flex items-stretch gap-3 w-full max-w-2xl" data-v-4caab520${_scopeId}><div class="relative flex-1 group" data-v-4caab520${_scopeId}><span class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none" data-v-4caab520${_scopeId}>`);
            if (!isSearching.value) {
              ...
              _push2(`<div class="h-4 w-4 border-2 border-rose-500 border-t-transparent rounded-full animate-spin" data-v-4caab520${_scopeId}></div>`);
            }
            _push2(`</span><input${ssrRenderAttr("value", search.value)} type="text" placeholder="Cari aktor, aksi, atau entitas..." class="w-full pl-11 pr-10 py-4 bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder:text-slate-400/50 font-bold text-xs rounded-2xl border-none outline-none focus:outline-none ring-1 ring-slate-200 dark:ring-slate-800 dark:focus:ring-rose-500/50 focus:ring-4 focus:ring-rose-500/50 shadow-sm focus:shadow-md transition-[ring,background-color,box-shadow] duration-300 ease-out focus:bg-slate-50 dark:focus:bg-slate-800/80" data-v-4caab520${_scopeId}>`);
            if (search.value) {
              _push2(`<button class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-rose-500 transition-colors" data-v-4caab520${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
            ...
            _push2(`</div><div class="flex items-center bg-white dark:bg-slate-900 rounded-2xl px-4 ring-1 ring-slate-200 dark:ring-slate-800 shadow-sm hover:ring-rose-500/50 dark:hover:ring-rose-500/50 transition-all duration-300" data-v-4caab520${_scopeId}><span class="hidden sm:inline text-[9px] font-black uppercase text-slate-400 px-2 border-r border-slate-200 dark:border-slate-800 mr-2" data-v-4caab520${_scopeId}>Tampilkan</span><select class="bg-transparent dark:bg-slate-900 border-none focus:ring-0 text-xs font-black text-slate-900 dark:text-white py-4 pr-8 cursor-pointer hover:text-rose-500 dark:hover:text-rose-500 transition-colors duration-300 outline-none" data-v-4caab520${_scopeId}><option${ssrRenderAttr("value", 10)} data-v-4caab520${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 10) : ssrLooseEqual(perPage.value, 10)) ? " selected" : ""}${_scopeId}>10</option><option${ssrRenderAttr("value", 25)} data-v-4caab520${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 25) : ssrLooseEqual(perPage.value, 25)) ? " selected" : ""}${_scopeId}>25</option><option${ssrRenderAttr("value", 50)} data-v-4caab520${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 50) : ssrLooseEqual(perPage.value, 50)) ? " selected" : ""}${_scopeId}>50</option><option${ssrRenderAttr("value", 100)} data-v-4caab520${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 100) : ssrLooseEqual(perPage.value, 100)) ? " selected" : ""}${_scopeId}>100</option></select></div></div><div class="px-6 py-3 bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800" data-v-4caab520${_scopeId}><span class="text-[10px] font-black text-slate-400 uppercase tracking-widest" data-v-4caab520${_scopeId}> Total Aktivitas: <span class="text-rose-500 ml-1" data-v-4caab520${_scopeId}>${ssrInterpolate(__props.histories.total)}</span></span></div></div><div class="bg-white/60 dark:bg-slate-900 backdrop-blur-3xl rounded-[2.5rem] border border-white/40 dark:border-white/5 shadow-sm overflow-hidden" data-v-4caab520${_scopeId}><div class="overflow-x-auto custom-scrollbar" data-v-4caab520${_scopeId}><table class="w-full text-left border-collapse min-w-[1000px] lg:min-w-full" data-v-4caab520${_scopeId}><thead data-v-4caab520${_scopeId}><tr class="bg-slate-50/80 dark:bg-slate-800/20 text-[10px] font-black uppercase text-slate-400 dark:text-slate-500 tracking-[0.2em] sticky top-0 z-20 border-b border-slate-100 dark:border-slate-800/50" data-v-4caab520${_scopeId}><th class="p-6 md:p-8 pl-8 text-center" data-v-4caab520${_scopeId}>No</th><th class="p-6 md:p-8 pl-8 cursor-pointer hover:text-rose-500 transition-colors group select-none" data-v-4caab520${_scopeId}><div class="flex items-center gap-2" data-v-4caab520${_scopeId}> Waktu <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-4caab520${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
            ...
            _push2(`</div></div></th><th class="p-6 md:p-8" data-v-4caab520${_scopeId}>Aktor (User)</th><th class="p-6 md:p-8 cursor-pointer hover:text-rose-500 transition-colors group select-none" data-v-4caab520${_scopeId}><div class="flex items-center gap-2" data-v-4caab520${_scopeId}> Aksi <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-4caab520${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-caret-up",
            ...
            _push2(`</div></div></th><th class="p-6 md:p-8" data-v-4caab520${_scopeId}>Entitas Terkait</th><th class="p-6 md:p-8 text-center" data-v-4caab520${_scopeId}>Detail</th></tr></thead>`);
            if (isSearching.value) {
              _push2(`<tbody class="divide-y divide-slate-50 dark:divide-slate-800/20" data-v-4caab520${_scopeId}><!--[-->`);
              ssrRenderList(5, (i) => {
                _push2(`<tr class="animate-pulse bg-white/30 dark:bg-slate-900/10" data-v-4caab520${_scopeId}><td class="p-6 md:p-8 pl-8 text-center" data-v-4caab520${_scopeId}><div class="h-6 w-8 mx-auto bg-slate-200 dark:bg-slate-700/50 rounded-md" data-v-4caab520${_scopeId}></div></td><td class="p-6 md:p-8 pl-8" data-v-4caab520${_scopeId}><div class="h-4 w-32 bg-slate-200 dark:bg-slate-700/50 rounded" data-v-4caab520${_scopeId}></div></td><td class="p-6 md:p-8" data-v-4caab520${_scopeId}><div class="flex items-center gap-3" data-v-4caab520${_scopeId}><div class="w-8 h-8 rounded-full bg-slate-200 dark:bg-slate-700/50" data-v-4caab520${_scopeId}></div><div class="flex flex-col gap-1" data-v-4caab520${_scopeId}><div class="h-4 w-24 bg-slate-200 dark:bg-slate-700/50 rounded" data-v-4caab520${_scopeId}></div><div class="h-3 w-16 bg-slate-200 dark:bg-slate-700/50 rounded" data-v-4caab520${_scopeId}></div></div></div></td><td class="p-6 md:p-8" data-v-4caab520${_scopeId}><div class="h-6 w-16 bg-slate-200 dark:bg-slate-700/50 rounded-md" data-v-4caab520${_scopeId}></div></td><td class="p-6 md:p-8" data-v-4caab520${_scopeId}><div class="flex flex-col gap-1" data-v-4caab520${_scopeId}><div class="h-4 w-32 bg-slate-200 dark:bg-slate-700/50 rounded" data-v-4caab520${_scopeId}></div><div class="h-3 w-20 bg-slate-200 dark:bg-slate-700/50 rounded" data-v-4caab520${_scopeId}></div></div></td><td class="p-6 md:p-8 text-center" data-v-4caab520${_scopeId}><div class="h-8 w-8 mx-auto bg-slate-200 dark:bg-slate-700/50 rounded-xl" data-v-4caab520${_scopeId}></div></td></tr>`);
              });
              _push2(`<!--]--></tbody>`);
            } else if (__props.histories.data.length === 0) {
              _push2(`<tbody class="divide-y divide-slate-50 dark:divide-slate-800/20" data-v-4caab520${_scopeId}><tr data-v-4caab520${_scopeId}><td colspan="6" class="p-16 text-center" data-v-4caab520${_scopeId}><div class="flex flex-col items-center justify-center text-slate-400 dark:text-slate-500" data-v-4caab520${_scopeId}><div class="w-24 h-24 mb-6 rounded-full bg-slate-50 dark:bg-slate-800/50 flex items-center justify-center border border-slate-100 dark:border-slate-800 shadow-inner" data-v-4caab520${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-clock-rotate-left",
                class: "text-4xl text-slate-300 dark:text-slate-600"
              }, null, _parent2, _scopeId));
              _push2(`</div><h3 class="text-lg font-black text-slate-700 dark:text-slate-300 mb-2 uppercase tracking-widest" data-v-4caab520${_scopeId}> Belum Ada Riwayat</h3><p class="text-xs max-w-sm text-center leading-relaxed font-bold" data-v-4caab520${_scopeId}> Log aktivitas sistem masih kosong atau pencarian Anda tidak memiliki kecocokan riwayat. </p>`);
              if (search.value) {
                _push2(`<button class="mt-8 px-6 py-3 bg-rose-50 text-rose-600 dark:bg-rose-500/10 dark:text-rose-400 text-xs font-black tracking-widest uppercase rounded-xl transition hover:bg-rose-100 dark:hover:bg-rose-500/20 active:scale-95 shadow-sm" data-v-4caab520${_scopeId}> Bersihkan Pencarian </button>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              ssrRenderList(__props.histories.data, (log) => {
                _push2(`<tr class="group hover:bg-white/50 dark:hover:bg-white/[0.02] transition-colors duration-300" data-v-4caab520${_scopeId}><td class="p-6 md:p-8 text-center" data-v-4caab520${_scopeId}><span class="font-mono text-sm font-black text-rose-500 bg-rose-50 dark:bg-rose-500/10 px-2 py-1 rounded-md border border-rose-100 dark:border-rose-500/20" data-v-4caab520${_scopeId}>${ssrInterpolate(__props.histories.from + __props.histories.data.indexOf(log))}</span></td><td class="p-6 md:p-8 pl-8 text-[10px] font-bold text-slate-400 font-mono whitespace-nowrap" data-v-4caab520${_scopeId}>${ssrInterpolate(formatDate(log.created_at))}</td><td class="p-6 md:p-8" data-v-4caab520${_scopeId}><div class="flex items-center gap-3" data-v-4caab520${_scopeId}><div class="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center font-black text-[10px] text-slate-400 border border-slate-200 dark:border-slate-700" data-v-4caab520${_scopeId}>${ssrInterpolate(log.user?.name?.substring(0, 2).toUpperCase() || "?")}</div><div class="flex flex-col" data-v-4caab520${_scopeId}><span class="font-bold text-slate-700 dark:text-slate-200 text-xs leading-tight" data-v-4caab520${_scopeId}>${ssrInterpolate(log.user?.name || "Unknown")}</span><span class="text-[9px] text-slate-400 uppercase tracking-tighter" data-v-4caab520${_scopeId}>${ssrInterpolate(log.user?.role || "-")}</span></div></div></td><td class="p-6 md:p-8" data-v-4caab520${_scopeId}><span class="${ssrRenderClass(["px-2.5 py-1 rounded-md text-[9px] font-black uppercase tracking-widest border shadow-sm", getActionBadge(log.action)])}" data-v-4caab520${_scopeId}>${ssrInterpolate(log.action.replace("_", " "))}</span></td><td class="p-6 md:p-8" data-v-4caab520${_scopeId}><div class="text-xs font-bold text-slate-600 dark:text-slate-400" data-v-4caab520${_scopeId}>${ssrInterpolate(formatEntityName(log.historable_type))}</div><div class="text-[9px] text-slate-400 tracking-tighter mt-0.5" data-v-4caab520${_scopeId}> ID: <span class="font-mono text-rose-500" data-v-4caab520${_scopeId}>#${ssrInterpolate(log.historable_id)}</span>`);
                if (log.stage) {
                  _push2(`<span class="mx-1" data-v-4caab520${_scopeId}>•</span>`);
                } else {
                  _push2(`<!---->`);
                }
                if (log.stage) {
                  _push2(`<span data-v-4caab520${_scopeId}>${ssrInterpolate(log.stage)}</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></td><td class="flex items-center justify-center p-6 md:p-8 text-center" data-v-4caab520${_scopeId}><button class="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 hover:text-rose-600 rounded-xl transition-all shadow-sm hover:shadow-md hover:border-rose-200 active:scale-95" data-v-4caab520${_scopeId}>`);
                _push2(ssrRenderComponent(_component_icon, {
            ...
            _push2(`</table></div><div class="flex flex-col md:flex-row items-center justify-between gap-4 px-6 md:px-8 py-6 border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-800/20 backdrop-blur-sm" data-v-4caab520${_scopeId}><div class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest italic text-center md:text-left" data-v-4caab520${_scopeId}> Data ${ssrInterpolate(__props.histories.from)} - ${ssrInterpolate(__props.histories.to)} dari total ${ssrInterpolate(__props.histories.total)}</div><div class="flex flex-wrap justify-center gap-1.5" data-v-4caab520${_scopeId}><!--[-->`);
            ssrRenderList(__props.histories.links, (link, k) => {
              ...
              if (link.url) {
                ...
                ])}" data-v-4caab520${_scopeId}>${link.label ?? ""}</span>`);
              }
              _push2(`<!--]-->`);
            });
            _push2(`<!--]--></div></div></div></div>`);
            if (showModal.value) {
              _push2(`<div class="fixed inset-0 z-50 flex items-center justify-center p-4" data-v-4caab520${_scopeId}><div class="fixed inset-0 bg-slate-900/80 backdrop-blur-md transition-opacity" data-v-4caab520${_scopeId}></div><div class="relative bg-white dark:bg-slate-900 w-full max-w-4xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 flex flex-col max-h-[85vh] border border-white/10" data-v-4caab520${_scopeId}><div class="p-8 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/30" data-v-4caab520${_scopeId}><div data-v-4caab520${_scopeId}><h3 class="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tighter italic" data-v-4caab520${_scopeId}> Detail Perubahan Data</h3><p class="text-[10px] font-bold text-rose-500 uppercase tracking-widest mt-1" data-v-4caab520${_scopeId}>${ssrInterpolate(selectedLog.value.action)} • ${ssrInterpolate(formatDate(selectedLog.value.created_at))}</p></div><button class="w-8 h-8 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 text-slate-400 hover:text-rose-600 transition-colors font-bold text-lg" data-v-4caab520${_scopeId}>×</button></div><div class="p-8 overflow-y-auto grid grid-cols-1 md:grid-cols-2 gap-8 bg-white dark:bg-slate-900 custom-scrollbar" data-v-4caab520${_scopeId}><div class="space-y-4" data-v-4caab520${_scopeId}><div class="flex items-center gap-2 text-rose-600 dark:text-rose-500" data-v-4caab520${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, { icon: "fa-solid fa-file-circle-minus" }, null, _parent2, _scopeId));
              _push2(`<h4 class="text-[10px] font-black uppercase tracking-widest" data-v-4caab520${_scopeId}>Data Sebelumnya (Old)</h4></div><div class="bg-slate-50 dark:bg-slate-800 rounded-2xl p-4 border border-slate-200 dark:border-slate-700 font-mono text-[11px] overflow-x-auto shadow-inner h-full max-h-[400px] custom-scrollbar" data-v-4caab520${_scopeId}>`);
              if (selectedLog.value.old_values) {
                _push2(`<pre class="text-slate-600 dark:text-slate-400" data-v-4caab520${_scopeId}>${ssrInterpolate(JSON.stringify(selectedLog.value.old_values, null, 2))}</pre>`);
              } else {
                _push2(`<div class="text-slate-400 italic text-[10px] font-bold uppercase tracking-wider py-10 text-center" data-v-4caab520${_scopeId}> Tidak ada data sebelumnya (Record Baru)</div>`);
              }
              _push2(`</div></div><div class="space-y-4" data-v-4caab520${_scopeId}><div class="flex items-center gap-2 text-emerald-600 dark:text-emerald-500" data-v-4caab520${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, { icon: "fa-solid fa-file-circle-plus" }, null, _parent2, _scopeId));
              _push2(`<h4 class="text-[10px] font-black uppercase tracking-widest" data-v-4caab520${_scopeId}>Data Sesudahnya (New)</h4></div><div class="bg-emerald-50/30 dark:bg-emerald-900/10 rounded-2xl p-4 border border-emerald-100 dark:border-emerald-500/20 font-mono text-[11px] overflow-x-auto shadow-inner h-full max-h-[400px] custom-scrollbar ring-2 ring-emerald-500/10" data-v-4caab520${_scopeId}>`);
              if (selectedLog.value.new_values) {
                _push2(`<pre class="text-slate-700 dark:text-slate-200 font-bold" data-v-4caab520${_scopeId}>${ssrInterpolate(JSON.stringify(selectedLog.value.new_values, null, 2))}</pre>`);
              } else {
                _push2(`<div class="text-rose-500 italic text-[10px] font-bold uppercase tracking-wider py-10 text-center" data-v-4caab520${_scopeId}> Data Telah Dihapus Permanen</div>`);
              }
              _push2(`</div></div></div><div class="p-6 bg-slate-50/50 dark:bg-slate-800/30 border-t border-slate-100 dark:border-slate-800 text-right" data-v-4caab520${_scopeId}><button class="px-8 py-3 bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-400 text-[10px] font-black uppercase tracking-widest rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all shadow-sm" data-v-4caab520${_scopeId}> Tutup Detail </button></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
                          ...
                          return createVNode("tr", {
                            ...
                            createVNode("td", { class: "p-6 md:p-8" }, [
                              createVNode("div", { class: "flex items-center gap-3" }, [
                                createVNode("div", { class: "w-8 h-8 rounded-full bg-slate-200 dark:bg-slate-700/50" }),
                                createVNode("div", { class: "flex flex-col gap-1" }, [
                                  createVNode("div", { class: "h-4 w-24 bg-slate-200 dark:bg-slate-700/50 rounded" }),
                            ...
                            createVNode("td", { class: "p-6 md:p-8" }, [
                              createVNode("div", { class: "flex flex-col gap-1" }, [
                                createVNode("div", { class: "h-4 w-32 bg-slate-200 dark:bg-slate-700/50 rounded" }),
                                createVNode("div", { class: "h-3 w-20 bg-slate-200 dark:bg-slate-700/50 rounded" })
                              ])
                            ]),
                            createVNode("td", { class: "p-6 md:p-8 text-center" }, [
                              createVNode("div", { class: "h-8 w-8 mx-auto bg-slate-200 dark:bg-slate-700/50 rounded-xl" })
                            ])
                          ]);
                        }), 64))
                      ])) : __props.histories.data.length === 0 ? (openBlock(), createBlock("tbody", {
                        key: 1,
                        class: "divide-y divide-slate-50 dark:divide-slate-800/20"
                      }, [
                        createVNode("tr", null, [
                          createVNode("td", {
                            ...
                            createVNode("div", { class: "flex flex-col items-center justify-center text-slate-400 dark:text-slate-500" }, [
                              ...
                              createVNode("h3", { class: "text-lg font-black text-slate-700 dark:text-slate-300 mb-2 uppercase tracking-widest" }, " Belum Ada Riwayat"),
                              createVNode("p", { class: "text-xs max-w-sm text-center leading-relaxed font-bold" }, " Log aktivitas sistem masih kosong atau pencarian Anda tidak memiliki kecocokan riwayat. "),
                              search.value ? (openBlock(), createBlock("button", {
                                key: 0,
                                onClick: ($event) => search.value = "",
                              ...
                              }, " Bersihkan Pencarian ", 8, ["onClick"])) : createCommentVNode("", true)
                            ])
                          ])
                        ])
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4caab520"]]);
export {
  Index as default
};
