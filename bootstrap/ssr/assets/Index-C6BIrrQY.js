import { ref, watch, computed, resolveComponent, mergeProps, withCtx, unref, createVNode, createBlock, createCommentVNode, withDirectives, vModelText, vModelSelect, createTextVNode, openBlock, Fragment, renderList, toDisplayString, withModifiers, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AppLayout, mergeProps({ title: "Kelola Library" }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-6" data-v-4c0ae40c${_scopeId}><div class="flex flex-col lg:flex-row justify-between items-center gap-6" data-v-4c0ae40c${_scopeId}><div class="flex items-stretch gap-3 w-full max-w-2xl" data-v-4c0ae40c${_scopeId}><div class="relative flex-1 group" data-v-4c0ae40c${_scopeId}><span class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none" data-v-4c0ae40c${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-magnifying-glass",
              class: "text-slate-400 text-xs group-focus-within:text-rose-500 transition-colors"
            }, null, _parent2, _scopeId));
            _push2(`</span><input${ssrRenderAttr("value", search.value)} type="text" placeholder="Cari nama dokumen..." class="w-full pl-11 pr-4 py-4 bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder:text-slate-400/50 font-bold text-xs rounded-2xl border-none outline-none focus:outline-none ring-1 ring-slate-200 dark:ring-slate-800 dark:focus:ring-rose-500/50 focus:ring-4 focus:ring-rose-500/50 shadow-sm focus:shadow-md transition-[ring,background-color,box-shadow] duration-300 ease-out focus:bg-slate-50 dark:focus:bg-slate-800/80" data-v-4c0ae40c${_scopeId}></div><div class="flex items-center bg-white dark:bg-slate-900 rounded-2xl px-4 ring-1 ring-slate-200 dark:ring-slate-800 shadow-sm hover:ring-rose-500/50 dark:hover:ring-rose-500/50 transition-all duration-300" data-v-4c0ae40c${_scopeId}><span class="hidden sm:inline text-[9px] font-black uppercase text-slate-400 px-2 border-r border-slate-200 dark:border-slate-800 mr-2" data-v-4c0ae40c${_scopeId}>Tampilkan</span><select class="bg-transparent dark:bg-slate-900 border-none focus:ring-0 text-xs font-black text-slate-900 dark:text-white py-4 pr-8 cursor-pointer hover:text-rose-500 dark:hover:text-rose-500 transition-colors duration-300 outline-none" data-v-4c0ae40c${_scopeId}><option${ssrRenderAttr("value", 10)} data-v-4c0ae40c${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 10) : ssrLooseEqual(perPage.value, 10)) ? " selected" : ""}${_scopeId}>10</option><option${ssrRenderAttr("value", 25)} data-v-4c0ae40c${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 25) : ssrLooseEqual(perPage.value, 25)) ? " selected" : ""}${_scopeId}>25</option><option${ssrRenderAttr("value", 50)} data-v-4c0ae40c${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 50) : ssrLooseEqual(perPage.value, 50)) ? " selected" : ""}${_scopeId}>50</option><option${ssrRenderAttr("value", 100)} data-v-4c0ae40c${ssrIncludeBooleanAttr(Array.isArray(perPage.value) ? ssrLooseContain(perPage.value, 100) : ssrLooseEqual(perPage.value, 100)) ? " selected" : ""}${_scopeId}>100</option></select></div></div><div class="flex items-center gap-3" data-v-4c0ae40c${_scopeId}></div></div><div class="bg-white/60 dark:bg-slate-900 backdrop-blur-3xl rounded-[2.5rem] border border-white/40 dark:border-white/5 shadow-sm overflow-hidden" data-v-4c0ae40c${_scopeId}><div class="overflow-x-auto custom-scrollbar" data-v-4c0ae40c${_scopeId}><table class="w-full text-left border-collapse min-w-[1000px] lg:min-w-full" data-v-4c0ae40c${_scopeId}><thead data-v-4c0ae40c${_scopeId}><tr class="bg-slate-50/80 dark:bg-slate-800/20 text-[10px] font-black uppercase text-slate-400 dark:text-slate-500 tracking-[0.2em] sticky top-0 z-20 border-b border-slate-100 dark:border-slate-800/50" data-v-4c0ae40c${_scopeId}><th class="p-6 md:p-8 pl-8 text-center" data-v-4c0ae40c${_scopeId}>No</th><th class="p-6 md:p-8 pl-8 cursor-pointer hover:text-rose-500 transition-colors group select-none" data-v-4c0ae40c${_scopeId}><div class="flex items-center gap-2" data-v-4c0ae40c${_scopeId}> Nama Dokumen <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-4c0ae40c${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
            ...
            _push2(`</div></div></th><th class="p-6 md:p-8 text-center cursor-pointer hover:text-rose-500 transition-colors group select-none" data-v-4c0ae40c${_scopeId}><div class="flex items-center justify-center gap-2" data-v-4c0ae40c${_scopeId}> Tipe Akses <div class="flex flex-col text-[8px] opacity-30 group-hover:opacity-100 transition-opacity" data-v-4c0ae40c${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
              icon: "fa-solid fa-caret-up",
            ...
            _push2(`</div></div></th><th class="p-6 md:p-8" data-v-4c0ae40c${_scopeId}>Diupload Oleh</th><th class="p-6 md:p-8 text-center" data-v-4c0ae40c${_scopeId}>Aksi</th></tr></thead><tbody class="divide-y divide-slate-50 dark:divide-slate-800/20" data-v-4c0ae40c${_scopeId}><!--[-->`);
            ssrRenderList(__props.documents.data, (doc) => {
              _push2(`<tr class="group hover:bg-white/50 dark:hover:bg-white/[0.02] transition-colors duration-300" data-v-4c0ae40c${_scopeId}><td class="p-6 md:p-8 pl-8 text-center" data-v-4c0ae40c${_scopeId}><span class="font-mono text-sm font-black text-rose-500 bg-rose-50 dark:bg-rose-500/10 px-2 py-1 rounded-md border border-rose-100 dark:border-rose-500/20" data-v-4c0ae40c${_scopeId}>${ssrInterpolate(__props.documents.from + __props.documents.data.indexOf(doc))}</span></td><td class="p-6 md:p-8 pl-8" data-v-4c0ae40c${_scopeId}><div class="flex flex-col" data-v-4c0ae40c${_scopeId}><div class="font-black text-slate-800 dark:text-slate-200 uppercase text-xs leading-none" data-v-4c0ae40c${_scopeId}>${ssrInterpolate(doc.name)}</div><div class="flex items-center gap-2 mt-2" data-v-4c0ae40c${_scopeId}><span class="px-1.5 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800 text-[8px] font-bold text-slate-500 uppercase tracking-tighter" data-v-4c0ae40c${_scopeId}>${ssrInterpolate(doc.extension)}</span><span class="text-[9px] text-slate-400 font-medium" data-v-4c0ae40c${_scopeId}>${ssrInterpolate(doc.size_kb || 0)} KB </span></div></div></td><td class="p-6 md:p-8 text-center" data-v-4c0ae40c${_scopeId}><span class="${ssrRenderClass([
              ...
              ])}" data-v-4c0ae40c${_scopeId}>${ssrInterpolate(doc.type === "public" ? "Publik" : "Terbatas")}</span></td><td class="p-6 md:p-8" data-v-4c0ae40c${_scopeId}><div class="flex items-center gap-2" data-v-4c0ae40c${_scopeId}><div class="w-6 h-6 rounded-full bg-indigo-50 dark:bg-indigo-500/10 flex items-center justify-center text-[9px] font-black text-indigo-500" data-v-4c0ae40c${_scopeId}>${ssrInterpolate(doc.uploader?.name?.[0] || "?")}</div><span class="text-xs font-bold text-slate-600 dark:text-slate-400" data-v-4c0ae40c${_scopeId}>${ssrInterpolate(doc.uploader?.name)}</span></div></td><td class="p-6 md:p-8" data-v-4c0ae40c${_scopeId}><div class="flex justify-center gap-2" data-v-4c0ae40c${_scopeId}><a${ssrRenderAttr("href", _ctx.route("library.download", doc.id))} class="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 hover:text-emerald-500 rounded-xl transition-all shadow-sm hover:shadow-md hover:border-emerald-200 active:scale-95" title="Download" data-v-4c0ae40c${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-download",
                class: "text-[10px]"
              }, null, _parent2, _scopeId));
              _push2(`</a><button class="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 hover:text-blue-600 rounded-xl transition-all shadow-sm hover:shadow-md hover:border-blue-200 active:scale-95" data-v-4c0ae40c${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-pencil",
                class: "text-[10px]"
              }, null, _parent2, _scopeId));
              _push2(`</button><button class="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 hover:text-rose-600 rounded-xl transition-all shadow-sm hover:shadow-md hover:border-rose-200 active:scale-95" data-v-4c0ae40c${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
            ...
            if (__props.documents.data.length === 0) {
              _push2(`<tr data-v-4c0ae40c${_scopeId}><td colspan="4" class="p-12 text-center" data-v-4c0ae40c${_scopeId}><div class="flex flex-col items-center justify-center opacity-50" data-v-4c0ae40c${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                icon: "fa-solid fa-box-open",
                class: "text-4xl text-slate-300 dark:text-slate-600 mb-4"
              }, null, _parent2, _scopeId));
              _push2(`<p class="text-xs font-black text-slate-400 uppercase tracking-widest italic" data-v-4c0ae40c${_scopeId}> Tidak ada dokumen tersedia</p></div></td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tbody></table></div><div class="flex flex-col md:flex-row items-center justify-between gap-4 px-6 md:px-8 py-6 border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-800/20 backdrop-blur-sm" data-v-4c0ae40c${_scopeId}><div class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest italic text-center md:text-left" data-v-4c0ae40c${_scopeId}> Data ${ssrInterpolate(__props.documents.from)} - ${ssrInterpolate(__props.documents.to)} dari total ${ssrInterpolate(__props.documents.total)}</div><div class="flex flex-wrap justify-center gap-1.5" data-v-4c0ae40c${_scopeId}><!--[-->`);
            ssrRenderList(__props.documents.links, (link, k) => {
              ...
              if (link.url) {
                ...
                ])}" data-v-4c0ae40c${_scopeId}>${link.label ?? ""}</span>`);
              }
              _push2(`<!--]-->`);
            });
            _push2(`<!--]--></div></div></div></div>`);
            if (showModal.value) {
              _push2(`<div class="fixed inset-0 z-50 flex items-center justify-center p-4" data-v-4c0ae40c${_scopeId}><div class="fixed inset-0 bg-slate-900/80 backdrop-blur-md transition-opacity" data-v-4c0ae40c${_scopeId}></div><div class="relative bg-white dark:bg-slate-900 w-full max-w-xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 border border-white/10" data-v-4c0ae40c${_scopeId}><div class="p-8 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 flex justify-between items-center" data-v-4c0ae40c${_scopeId}><div data-v-4c0ae40c${_scopeId}><h3 class="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tighter italic" data-v-4c0ae40c${_scopeId}>${ssrInterpolate(isEditing.value ? "Edit Dokumen" : "Upload Dokumen")}</h3><p class="text-[10px] font-bold text-rose-500 uppercase tracking-widest mt-1" data-v-4c0ae40c${_scopeId}> Manajemen File Library </p></div><button class="w-8 h-8 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 text-slate-400 hover:text-rose-600 transition-colors font-bold text-lg" data-v-4c0ae40c${_scopeId}>×</button></div><form class="p-8 space-y-6" data-v-4c0ae40c${_scopeId}><div class="space-y-2" data-v-4c0ae40c${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-4c0ae40c${_scopeId}>Nama Dokumen</label><input${ssrRenderAttr("value", unref(form).name)} type="text" placeholder="Misal: Standar SPMI 2024" class="w-full px-5 py-3.5 bg-white dark:bg-slate-900 border-none rounded-2xl text-xs font-bold text-slate-900 dark:text-white ring-1 ring-slate-200 dark:ring-slate-800 focus:ring-2 focus:ring-rose-500 transition-all shadow-sm" required data-v-4c0ae40c${_scopeId}>`);
              if (unref(form).errors.name) {
                _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-4c0ae40c${_scopeId}>${ssrInterpolate(unref(form).errors.name)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="space-y-2" data-v-4c0ae40c${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-4c0ae40c${_scopeId}>Tipe Akses</label><select class="w-full px-5 py-3.5 bg-white dark:bg-slate-900 border-none rounded-2xl text-xs font-bold text-slate-900 dark:text-white ring-1 ring-slate-200 dark:ring-slate-800 focus:ring-2 focus:ring-rose-500 transition-all shadow-sm" data-v-4c0ae40c${_scopeId}><option value="public" data-v-4c0ae40c${ssrIncludeBooleanAttr(Array.isArray(unref(form).type) ? ssrLooseContain(unref(form).type, "public") : ssrLooseEqual(unref(form).type, "public")) ? " selected" : ""}${_scopeId}>Semua User (Public)</option><option value="auditor" data-v-4c0ae40c${ssrIncludeBooleanAttr(Array.isArray(unref(form).type) ? ssrLooseContain(unref(form).type, "auditor") : ssrLooseEqual(unref(form).type, "auditor")) ? " selected" : ""}${_scopeId}>Khusus Auditor &amp; Admin</option></select>`);
              if (unref(form).errors.type) {
                _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-4c0ae40c${_scopeId}>${ssrInterpolate(unref(form).errors.type)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="space-y-2" data-v-4c0ae40c${_scopeId}><label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1" data-v-4c0ae40c${_scopeId}>File Dokumen ${ssrInterpolate(isEditing.value ? "(Opsional)" : "")}</label><input type="file"${ssrIncludeBooleanAttr(!isEditing.value) ? " required" : ""} class="block w-full text-[10px] text-slate-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-[10px] file:font-black file:uppercase file:tracking-wider file:bg-slate-100 dark:file:bg-slate-800 file:text-slate-700 dark:file:text-slate-300 hover:file:bg-rose-50 dark:hover:file:bg-rose-900/30 hover:file:text-rose-600 cursor-pointer border border-slate-200 dark:border-slate-800 rounded-2xl p-2 bg-white dark:bg-slate-900/50" data-v-4c0ae40c${_scopeId}>`);
              if (unref(form).errors.file) {
                _push2(`<p class="text-xs text-rose-500 font-bold ml-1" data-v-4c0ae40c${_scopeId}>${ssrInterpolate(unref(form).errors.file)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
              if (unref(form).progress) {
                _push2(`<div class="w-full bg-slate-100 dark:bg-slate-800 h-1.5 rounded-full overflow-hidden" data-v-4c0ae40c${_scopeId}><div class="bg-rose-500 h-full transition-all duration-300 ease-out" style="${ssrRenderStyle({ width: unref(form).progress.percentage + "%" })}" data-v-4c0ae40c${_scopeId}></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="pt-4 border-t border-slate-100 dark:border-slate-800" data-v-4c0ae40c${_scopeId}><button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="w-full py-4 bg-slate-900 dark:bg-rose-600 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl shadow-xl shadow-slate-900/10 dark:shadow-rose-600/20 transition-all hover:bg-rose-600 dark:hover:bg-rose-500 hover:-translate-y-0.5 active:scale-95 disabled:opacity-50" data-v-4c0ae40c${_scopeId}>${ssrInterpolate(buttonLabel.value)}</button></div></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4c0ae40c"]]);
export {
  Index as default
};
