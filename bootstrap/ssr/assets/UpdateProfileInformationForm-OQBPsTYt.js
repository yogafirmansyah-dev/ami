import { ref, mergeProps, withCtx, unref, createTextVNode, createVNode, createBlock, createCommentVNode, openBlock, withDirectives, vShow, withModifiers, useSSRContext } from "vue";
...
import { _ as _sfc_main$5 } from "./SecondaryButton-BWihrucI.js";
import { _ as _sfc_main$7 } from "./TextInput-wJl1wgt1.js";
        ...
        form: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (_ctx.$page.props.jetstream.hasEmailVerification && __props.user.email_verified_at === null) {
              ...
              _push2(`</p><div class="mt-2 font-medium text-sm text-green-600 dark:text-green-400" style="${ssrRenderStyle(verificationLinkSent.value ? null : { display: "none" })}"${_scopeId}> A new verification link has been sent to your email address. </div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
