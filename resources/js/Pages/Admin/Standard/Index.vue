            ...
            <div
                    ...
                    <table class="w-full text-left border-collapse min-w-[1000px] lg:min-w-full">
                        <thead>
                            <tr
                                ...
                                <th class="p-6 md:p-8 pl-8">Nama Standar Mutu</th>
                                <th class="p-6 md:p-8">Target Unit</th>
                                <th class="p-6 md:p-8 text-center">Jumlah Indikator</th>
                ...
                <div
                    ...
                    <div class="flex flex-wrap justify-center gap-1.5">
                        <Link v-for="(link, k) in standards.links" :key="k" :href="link.url || '#'" :class="[
