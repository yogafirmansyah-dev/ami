        ...
        <template #default>
            ...
            <grid-section :col-tablet="2">
                ...
                <t-tab :data="tab1content" v-model="tab1" :color="selectedData.color" :design="selectedData.design"
                    ...
                    <template #icon="{ props }">
                        <svg v-if="props.id === 2" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
                        </svg>
                        <svg v-if="props.id === 3" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <template #content="{ props }">
                        <span v-if="props.id === 1">
                            ...
                            <h4 class='mt-1 font-semibold'>Rich Html Content</h4>
                            <p>Laravel attempts to take the pain out of development by easing common tasks used in most
                                web projects. </p>
                        </span>
                    </template>
                </t-tab>
                ...
                <t-tab :data="tab2content" v-model="tab2" :color="selectedData.color" :design="selectedData.design"
                    :colored-text="selectedData.coloredText" dark-mode :radius="5" />
            </grid-section>
        </template>
    </app-layout>
</template>
