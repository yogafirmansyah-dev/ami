...
<template>
    <aside class="umay-main-menu" :class="{
        ...
        <div id="footer">
            <transition name="fade" mode="out-in">
                ...
                <div key="mainMenuFooterLinks" id="footer-links-wrapper"
                    v-if="mainMenuFooterLinks.length > 0 && menuStatus !== 'closed'" :class="[
                ...
                <!--Open Menu Arrow-->
                <div key="mainMenuOpenArrow" v-else id="footer-trigger" @click="updateMenuStatus">
