    ...
    >
        ...
        >
            ...
            <svg
                class="trigger-icon"
                :class="[
                    (breakpoints.smaller('md') && (menuStatus === 'opened'))  || menuStatus === undefined  ? 'trigger-icon-show' : 'trigger-icon-hide'
                ]"
            ...
            <svg
                class="trigger-icon"
                :class="[
                    (menuStatus === 'hidden' || menuStatus === 'closed') ? 'trigger-icon-show' : 'trigger-icon-hide'
                ]"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
